...
fn get_topo_coin_mint_transaction(
...
fn test_new_genesis() {
    ...
    let txn3 = get_topo_coin_mint_transaction(genesis_key, 2, &account1, 200_000_000);
    let txn4 = get_topo_coin_mint_transaction(genesis_key, 3, &account2, 200_000_000);
