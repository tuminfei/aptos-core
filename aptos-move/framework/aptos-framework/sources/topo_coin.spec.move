spec aptos_framework::topo_coin {
    ...
    /// Enforcement: Enforced through the coin module, which has been audited.
    ///
    /// No.: 3
    /// Requirement: The abilities to mint Topo tokens should be transferable, duplicatable, and destroyable.
    /// Criticality: High
    ...
    spec initialize(aptos_framework: &signer): (BurnCapability<TopoCoin>, MintCapability<TopoCoin>) {
        ...
        // property 3: The abilities to mint Topo tokens should be transferable, duplicatable, and destroyable.
        /// [high-level-req-3]
