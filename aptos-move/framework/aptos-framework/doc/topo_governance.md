...
<dl>
<dt>
<code>votes: <a href="../../aptos-stdlib/doc/table.md#0x1_table_Table">table::Table</a>&lt;<a href="topo_governance.md#0x1_topo_governance_RecordKey">topo_governance::RecordKey</a>, bool&gt;</code>
</dt>
<dd>
...
<dl>
<dt>
<code>votes: <a href="../../aptos-stdlib/doc/smart_table.md#0x1_smart_table_SmartTable">smart_table::SmartTable</a>&lt;<a href="topo_governance.md#0x1_topo_governance_RecordKey">topo_governance::RecordKey</a>, u64&gt;</code>
</dt>
<dd>
...
<pre><code><b>const</b> <a href="topo_governance.md#0x1_topo_governance_METADATA_HASH_KEY">METADATA_HASH_KEY</a>: <a href="../../aptos-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt; = [109, 101, 116, 97, 100, 97, 116, 97, 95, 104, 97, 115, 104];
</code></pre>
...
<pre><code><b>const</b> <a href="topo_governance.md#0x1_topo_governance_METADATA_LOCATION_KEY">METADATA_LOCATION_KEY</a>: <a href="../../aptos-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt; = [109, 101, 116, 97, 100, 97, 116, 97, 95, 108, 111, 99, 97, 116, 105, 111, 110];
</code></pre>
...
<pre><code><b>fun</b> <a href="topo_governance.md#0x1_topo_governance_check_governance_permission">check_governance_permission</a>(s: &<a href="../../aptos-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>)
</code></pre>
...
<pre><code>inline <b>fun</b> <a href="topo_governance.md#0x1_topo_governance_check_governance_permission">check_governance_permission</a>(s: &<a href="../../aptos-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>) {
    <b>assert</b>!(
        ...
        <a href="../../aptos-stdlib/../move-stdlib/doc/error.md#0x1_error_permission_denied">error::permission_denied</a>(<a href="topo_governance.md#0x1_topo_governance_ENO_GOVERNANCE_PERMISSION">ENO_GOVERNANCE_PERMISSION</a>),
    );
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="topo_governance.md#0x1_topo_governance_assert_proposal_expiration">assert_proposal_expiration</a>(voter: <b>address</b>, proposal_id: u64) {
    ...
    <b>assert</b>!(
        ...
        <a href="../../aptos-stdlib/../move-stdlib/doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="topo_governance.md#0x1_topo_governance_EPROPOSAL_EXPIRED">EPROPOSAL_EXPIRED</a>),
    );
}
</code></pre>
...
<pre><code><b>fun</b> <a href="topo_governance.md#0x1_topo_governance_vote_internal">vote_internal</a>(
    ...
    <b>assert</b>!(voting_power &gt; 0, <a href="../../aptos-stdlib/../move-stdlib/doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="topo_governance.md#0x1_topo_governance_ENO_VOTING_POWER">ENO_VOTING_POWER</a>));
...
<pre><code><b>public</b> <b>fun</b> <a href="topo_governance.md#0x1_topo_governance_resolve">resolve</a>(proposal_id: u64, signer_address: <b>address</b>): <a href="../../aptos-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="topo_governance.md#0x1_topo_governance_get_signer_testnet_only">get_signer_testnet_only</a>(core_resources: &<a href="../../aptos-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>, signer_address: <b>address</b>): <a href="../../aptos-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="topo_governance.md#0x1_topo_governance_get_signer_testnet_only">get_signer_testnet_only</a>(
    core_resources: &<a href="../../aptos-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>, signer_address: <b>address</b>): <a href="../../aptos-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a> <b>acquires</b> <a href="topo_governance.md#0x1_topo_governance_GovernanceResponsbility">GovernanceResponsbility</a> {
...
<pre><code><b>fun</b> <a href="topo_governance.md#0x1_topo_governance_get_signer">get_signer</a>(signer_address: <b>address</b>): <a href="../../aptos-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>
</code></pre>
...
<pre><code><b>fun</b> <a href="topo_governance.md#0x1_topo_governance_create_proposal_metadata">create_proposal_metadata</a>(metadata_location: <a href="../../aptos-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;, metadata_hash: <a href="../../aptos-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;): <a href="../../aptos-stdlib/doc/simple_map.md#0x1_simple_map_SimpleMap">simple_map::SimpleMap</a>&lt;<a href="../../aptos-stdlib/../move-stdlib/doc/string.md#0x1_string_String">string::String</a>, <a href="../../aptos-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;&gt;
</code></pre>
...
<pre><code><b>fun</b> <a href="topo_governance.md#0x1_topo_governance_create_proposal_metadata">create_proposal_metadata</a>(
    ...
    <b>assert</b>!(utf8(metadata_location).length() &lt;= 256, <a href="../../aptos-stdlib/../move-stdlib/doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="topo_governance.md#0x1_topo_governance_EMETADATA_LOCATION_TOO_LONG">EMETADATA_LOCATION_TOO_LONG</a>));
    <b>assert</b>!(utf8(metadata_hash).length() &lt;= 256, <a href="../../aptos-stdlib/../move-stdlib/doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="topo_governance.md#0x1_topo_governance_EMETADATA_HASH_TOO_LONG">EMETADATA_HASH_TOO_LONG</a>));
...
<pre><code><b>schema</b> <a href="topo_governance.md#0x1_topo_governance_VoteAbortIf">VoteAbortIf</a> {
    ...
    <b>let</b> can_be_resolved_early_1 = <a href="../../aptos-stdlib/../move-stdlib/doc/option.md#0x1_option_is_some">option::is_some</a>(proposal.early_resolution_vote_threshold) &&
    ...
    <b>let</b> can_be_resolved_early_2 = <a href="../../aptos-stdlib/../move-stdlib/doc/option.md#0x1_option_is_some">option::is_some</a>(proposal.early_resolution_vote_threshold) &&
    ...
    <b>let</b> can_be_resolved_early_3 = <a href="../../aptos-stdlib/../move-stdlib/doc/option.md#0x1_option_is_some">option::is_some</a>(proposal.early_resolution_vote_threshold) &&
                                (proposal.yes_votes &gt;= early_resolution_threshold ||
    ...
    <b>let</b> <b>post</b> can_be_resolved_early = <a href="../../aptos-stdlib/../move-stdlib/doc/option.md#0x1_option_is_some">option::is_some</a>(proposal.early_resolution_vote_threshold) &&
...
<pre><code><b>schema</b> <a href="topo_governance.md#0x1_topo_governance_AddApprovedScriptHash">AddApprovedScriptHash</a> {
    ...
    <b>aborts_if</b> <a href="timestamp.md#0x1_timestamp_now_seconds">timestamp::now_seconds</a>() &lt;= proposal.expiration_secs &&
        (<a href="../../aptos-stdlib/../move-stdlib/doc/option.md#0x1_option_is_none">option::is_none</a>(proposal.early_resolution_vote_threshold) ||
...
<pre><code><b>schema</b> <a href="topo_governance.md#0x1_topo_governance_VotingIsProposalResolvableAbortsif">VotingIsProposalResolvableAbortsif</a> {
    ...
    <b>let</b> be_resolved_early = <a href="../../aptos-stdlib/../move-stdlib/doc/option.md#0x1_option_is_some">option::is_some</a>(proposal.early_resolution_vote_threshold) &&
                                (proposal.yes_votes &gt;= early_resolution_threshold ||
                                 proposal.no_votes &gt;= early_resolution_threshold);
...
<b>aborts_if</b> !<b>exists</b>&lt;<a href="topo_coin.md#0x1_topo_coin_MintCapStore">topo_coin::MintCapStore</a>&gt;(<a href="../../aptos-stdlib/../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(core_resources));
<b>include</b> <a href="topo_governance.md#0x1_topo_governance_GetSignerAbortsIf">GetSignerAbortsIf</a>;
</code></pre>
...
<pre><code><b>schema</b> <a href="topo_governance.md#0x1_topo_governance_CreateProposalMetadataAbortsIf">CreateProposalMetadataAbortsIf</a> {
    ...
    <b>aborts_if</b> !<a href="../../aptos-stdlib/../move-stdlib/doc/string.md#0x1_string_spec_internal_check_utf8">string::spec_internal_check_utf8</a>(<a href="topo_governance.md#0x1_topo_governance_METADATA_LOCATION_KEY">METADATA_LOCATION_KEY</a>);
    <b>aborts_if</b> !<a href="../../aptos-stdlib/../move-stdlib/doc/string.md#0x1_string_spec_internal_check_utf8">string::spec_internal_check_utf8</a>(<a href="topo_governance.md#0x1_topo_governance_METADATA_HASH_KEY">METADATA_HASH_KEY</a>);
}
</code></pre>
