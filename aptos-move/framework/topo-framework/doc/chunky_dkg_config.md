...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="chunky_dkg_config.md#0x1_chunky_dkg_config_on_new_epoch">on_new_epoch</a>(framework: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>) <b>acquires</b> <a href="chunky_dkg_config.md#0x1_chunky_dkg_config_ChunkyDKGConfig">ChunkyDKGConfig</a> {
    ...
    <b>if</b> (<a href="config_buffer.md#0x1_config_buffer_does_exist">config_buffer::does_exist</a>&lt;<a href="chunky_dkg_config.md#0x1_chunky_dkg_config_ChunkyDKGConfig">ChunkyDKGConfig</a>&gt;()) {
        ...
        <b>if</b> (<b>exists</b>&lt;<a href="chunky_dkg_config.md#0x1_chunky_dkg_config_ChunkyDKGConfig">ChunkyDKGConfig</a>&gt;(@topo_framework)) {
            *<b>borrow_global_mut</b>&lt;<a href="chunky_dkg_config.md#0x1_chunky_dkg_config_ChunkyDKGConfig">ChunkyDKGConfig</a>&gt;(@topo_framework) = new_config;
        } <b>else</b> {
...
<pre><code><b>public</b> <b>fun</b> <a href="chunky_dkg_config.md#0x1_chunky_dkg_config_enabled">enabled</a>(): bool <b>acquires</b> <a href="chunky_dkg_config.md#0x1_chunky_dkg_config_ChunkyDKGConfig">ChunkyDKGConfig</a> {
    <b>if</b> (<b>exists</b>&lt;<a href="chunky_dkg_config.md#0x1_chunky_dkg_config_ChunkyDKGConfig">ChunkyDKGConfig</a>&gt;(@topo_framework)) {
        <b>let</b> config = <b>borrow_global</b>&lt;<a href="chunky_dkg_config.md#0x1_chunky_dkg_config_ChunkyDKGConfig">ChunkyDKGConfig</a>&gt;(@topo_framework);
...
<pre><code><b>public</b> <b>fun</b> <a href="chunky_dkg_config.md#0x1_chunky_dkg_config_current">current</a>(): <a href="chunky_dkg_config.md#0x1_chunky_dkg_config_ChunkyDKGConfig">ChunkyDKGConfig</a> <b>acquires</b> <a href="chunky_dkg_config.md#0x1_chunky_dkg_config_ChunkyDKGConfig">ChunkyDKGConfig</a> {
    <b>if</b> (<b>exists</b>&lt;<a href="chunky_dkg_config.md#0x1_chunky_dkg_config_ChunkyDKGConfig">ChunkyDKGConfig</a>&gt;(@topo_framework)) {
        *<b>borrow_global</b>&lt;<a href="chunky_dkg_config.md#0x1_chunky_dkg_config_ChunkyDKGConfig">ChunkyDKGConfig</a>&gt;(@topo_framework)
    } <b>else</b> {
