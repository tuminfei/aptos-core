...
<a id="0x1_topo_account"></a>

# Module `0x1::topo_account`



-  [Resource `DirectTransferConfig`](#0x1_topo_account_DirectTransferConfig)
-  [Struct `DirectCoinTransferConfigUpdatedEvent`](#0x1_topo_account_DirectCoinTransferConfigUpdatedEvent)
-  [Struct `DirectCoinTransferConfigUpdated`](#0x1_topo_account_DirectCoinTransferConfigUpdated)
-  [Constants](#@Constants_0)
-  [Function `create_account`](#0x1_topo_account_create_account)
-  [Function `batch_transfer`](#0x1_topo_account_batch_transfer)
-  [Function `transfer`](#0x1_topo_account_transfer)
-  [Function `batch_transfer_coins`](#0x1_topo_account_batch_transfer_coins)
-  [Function `transfer_coins`](#0x1_topo_account_transfer_coins)
-  [Function `deposit_coins`](#0x1_topo_account_deposit_coins)
-  [Function `batch_transfer_fungible_assets`](#0x1_topo_account_batch_transfer_fungible_assets)
-  [Function `transfer_fungible_assets`](#0x1_topo_account_transfer_fungible_assets)
-  [Function `deposit_fungible_assets`](#0x1_topo_account_deposit_fungible_assets)
-  [Function `assert_account_exists`](#0x1_topo_account_assert_account_exists)
-  [Function `assert_account_is_registered_for_topo`](#0x1_topo_account_assert_account_is_registered_for_topo)
-  [Function `set_allow_direct_coin_transfers`](#0x1_topo_account_set_allow_direct_coin_transfers)
-  [Function `can_receive_direct_coin_transfers`](#0x1_topo_account_can_receive_direct_coin_transfers)
-  [Function `register_topo`](#0x1_topo_account_register_topo)
-  [Function `fungible_transfer_only`](#0x1_topo_account_fungible_transfer_only)
-  [Function `is_fungible_balance_at_least`](#0x1_topo_account_is_fungible_balance_at_least)
-  [Function `burn_from_fungible_store_for_gas`](#0x1_topo_account_burn_from_fungible_store_for_gas)
-  [Function `ensure_primary_fungible_store_exists`](#0x1_topo_account_ensure_primary_fungible_store_exists)
-  [Function `primary_fungible_store_address`](#0x1_topo_account_primary_fungible_store_address)
...
<a id="0x1_topo_account_DirectTransferConfig"></a>
...
<pre><code><b>struct</b> <a href="topo_account.md#0x1_topo_account_DirectTransferConfig">DirectTransferConfig</a> <b>has</b> key
</code></pre>
...
<dt>
<code>update_coin_transfer_events: <a href="event.md#0x1_event_EventHandle">event::EventHandle</a>&lt;<a href="topo_account.md#0x1_topo_account_DirectCoinTransferConfigUpdatedEvent">topo_account::DirectCoinTransferConfigUpdatedEvent</a>&gt;</code>
</dt>
<dd>
...
<a id="0x1_topo_account_DirectCoinTransferConfigUpdatedEvent"></a>
...
<pre><code><b>struct</b> <a href="topo_account.md#0x1_topo_account_DirectCoinTransferConfigUpdatedEvent">DirectCoinTransferConfigUpdatedEvent</a> <b>has</b> drop, store
</code></pre>
...
<a id="0x1_topo_account_DirectCoinTransferConfigUpdated"></a>
...
<b>struct</b> <a href="topo_account.md#0x1_topo_account_DirectCoinTransferConfigUpdated">DirectCoinTransferConfigUpdated</a> <b>has</b> drop, store
</code></pre>
...
<a id="0x1_topo_account_EACCOUNT_DOES_NOT_ACCEPT_DIRECT_COIN_TRANSFERS"></a>

Account opted out of receiving coins that they did not register to receive.


<pre><code><b>const</b> <a href="topo_account.md#0x1_topo_account_EACCOUNT_DOES_NOT_ACCEPT_DIRECT_COIN_TRANSFERS">EACCOUNT_DOES_NOT_ACCEPT_DIRECT_COIN_TRANSFERS</a>: u64 = 3;
</code></pre>



<a id="0x1_topo_account_EACCOUNT_DOES_NOT_ACCEPT_DIRECT_TOKEN_TRANSFERS"></a>

Account opted out of directly receiving NFT tokens.


<pre><code><b>const</b> <a href="topo_account.md#0x1_topo_account_EACCOUNT_DOES_NOT_ACCEPT_DIRECT_TOKEN_TRANSFERS">EACCOUNT_DOES_NOT_ACCEPT_DIRECT_TOKEN_TRANSFERS</a>: u64 = 4;
</code></pre>



<a id="0x1_topo_account_EACCOUNT_NOT_FOUND"></a>

Account does not exist.


<pre><code><b>const</b> <a href="topo_account.md#0x1_topo_account_EACCOUNT_NOT_FOUND">EACCOUNT_NOT_FOUND</a>: u64 = 1;
</code></pre>



<a id="0x1_topo_account_EACCOUNT_NOT_REGISTERED_FOR_TOPO"></a>

Account is not registered to receive TOPO.


<pre><code><b>const</b> <a href="topo_account.md#0x1_topo_account_EACCOUNT_NOT_REGISTERED_FOR_TOPO">EACCOUNT_NOT_REGISTERED_FOR_TOPO</a>: u64 = 2;
</code></pre>



<a id="0x1_topo_account_EMISMATCHING_RECIPIENTS_AND_AMOUNTS_LENGTH"></a>

The lengths of the recipients and amounts lists don't match.


<pre><code><b>const</b> <a href="topo_account.md#0x1_topo_account_EMISMATCHING_RECIPIENTS_AND_AMOUNTS_LENGTH">EMISMATCHING_RECIPIENTS_AND_AMOUNTS_LENGTH</a>: u64 = 5;
</code></pre>



<a id="0x1_topo_account_create_account"></a>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="topo_account.md#0x1_topo_account_create_account">create_account</a>(auth_key: <b>address</b>)
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="topo_account.md#0x1_topo_account_create_account">create_account</a>(auth_key: <b>address</b>) {
    ...
    <a href="topo_account.md#0x1_topo_account_register_topo">register_topo</a>(&account_signer);
}
</code></pre>
...
<a id="0x1_topo_account_batch_transfer"></a>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="topo_account.md#0x1_topo_account_batch_transfer">batch_transfer</a>(
    ...
    recipients.enumerate_ref(|i, <b>to</b>| {
            ...
            <a href="topo_account.md#0x1_topo_account_transfer">transfer</a>(source, *<b>to</b>, amount);
        });
}
</code></pre>
...
<a id="0x1_topo_account_transfer"></a>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="topo_account.md#0x1_topo_account_transfer">transfer</a>(source: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, <b>to</b>: <b>address</b>, amount: u64) {
    ...
    <a href="topo_account.md#0x1_topo_account_fungible_transfer_only">fungible_transfer_only</a>(source, <b>to</b>, amount)
}
</code></pre>
...
<a id="0x1_topo_account_batch_transfer_coins"></a>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="topo_account.md#0x1_topo_account_batch_transfer_coins">batch_transfer_coins</a>&lt;CoinType&gt;(
    ...
    recipients.enumerate_ref(|i, <b>to</b>| {
            <b>let</b> amount = amounts[i];
            <a href="topo_account.md#0x1_topo_account_transfer_coins">transfer_coins</a>&lt;CoinType&gt;(from, *<b>to</b>, amount);
        });
}
</code></pre>
...
<a id="0x1_topo_account_transfer_coins"></a>
...
<a id="0x1_topo_account_deposit_coins"></a>
...
<pre><code><b>public</b> <b>fun</b> <a href="topo_account.md#0x1_topo_account_deposit_coins">deposit_coins</a>&lt;CoinType&gt;(<b>to</b>: <b>address</b>, coins: <a href="coin.md#0x1_coin_Coin">coin::Coin</a>&lt;CoinType&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="topo_account.md#0x1_topo_account_deposit_coins">deposit_coins</a>&lt;CoinType&gt;(
...
<a id="0x1_topo_account_batch_transfer_fungible_assets"></a>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="topo_account.md#0x1_topo_account_batch_transfer_fungible_assets">batch_transfer_fungible_assets</a>(
    ...
    recipients.enumerate_ref(|i, <b>to</b>| {
            <b>let</b> amount = amounts[i];
            <a href="topo_account.md#0x1_topo_account_transfer_fungible_assets">transfer_fungible_assets</a>(from, metadata, *<b>to</b>, amount);
        });
}
</code></pre>
...
<a id="0x1_topo_account_transfer_fungible_assets"></a>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="topo_account.md#0x1_topo_account_transfer_fungible_assets">transfer_fungible_assets</a>(
    ...
    <a href="topo_account.md#0x1_topo_account_deposit_fungible_assets">deposit_fungible_assets</a>(
        <b>to</b>,
...
<a id="0x1_topo_account_deposit_fungible_assets"></a>
...
<pre><code><b>public</b> <b>fun</b> <a href="topo_account.md#0x1_topo_account_deposit_fungible_assets">deposit_fungible_assets</a>(<b>to</b>: <b>address</b>, fa: <a href="fungible_asset.md#0x1_fungible_asset_FungibleAsset">fungible_asset::FungibleAsset</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="topo_account.md#0x1_topo_account_deposit_fungible_assets">deposit_fungible_assets</a>(<b>to</b>: <b>address</b>, fa: FungibleAsset) {
    <b>if</b> (!<a href="account.md#0x1_account_exists_at">account::exists_at</a>(<b>to</b>)) {
        <a href="topo_account.md#0x1_topo_account_create_account">create_account</a>(<b>to</b>);
    };
...
<a id="0x1_topo_account_assert_account_exists"></a>
...
<a id="0x1_topo_account_assert_account_is_registered_for_topo"></a>

## Function `assert_account_is_registered_for_topo`



<pre><code><b>public</b> <b>fun</b> <a href="topo_account.md#0x1_topo_account_assert_account_is_registered_for_topo">assert_account_is_registered_for_topo</a>(addr: <b>address</b>)
</code></pre>
...
<a id="0x1_topo_account_set_allow_direct_coin_transfers"></a>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="topo_account.md#0x1_topo_account_set_allow_direct_coin_transfers">set_allow_direct_coin_transfers</a>(
    ...
    <b>if</b> (<b>exists</b>&lt;<a href="topo_account.md#0x1_topo_account_DirectTransferConfig">DirectTransferConfig</a>&gt;(addr)) {
        ...
        emit(
            <a href="topo_account.md#0x1_topo_account_DirectCoinTransferConfigUpdated">DirectCoinTransferConfigUpdated</a> {
                <a href="account.md#0x1_account">account</a>: addr,
                new_allow_direct_transfers: allow
            }
        );
    } <b>else</b> {
        <b>let</b> direct_transfer_config = <a href="topo_account.md#0x1_topo_account_DirectTransferConfig">DirectTransferConfig</a> {
            allow_arbitrary_coin_transfers: allow,
            update_coin_transfer_events: new_event_handle&lt;
                <a href="topo_account.md#0x1_topo_account_DirectCoinTransferConfigUpdatedEvent">DirectCoinTransferConfigUpdatedEvent</a>&gt;(<a href="account.md#0x1_account">account</a>)
        };
        emit(
            <a href="topo_account.md#0x1_topo_account_DirectCoinTransferConfigUpdated">DirectCoinTransferConfigUpdated</a> {
                <a href="account.md#0x1_account">account</a>: addr,
...
<a id="0x1_topo_account_can_receive_direct_coin_transfers"></a>
...
<pre><code>#[view]
<b>public</b> <b>fun</b> <a href="topo_account.md#0x1_topo_account_can_receive_direct_coin_transfers">can_receive_direct_coin_transfers</a>(<a href="account.md#0x1_account">account</a>: <b>address</b>): bool
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="topo_account.md#0x1_topo_account_can_receive_direct_coin_transfers">can_receive_direct_coin_transfers</a>(
    <a href="account.md#0x1_account">account</a>: <b>address</b>
): bool <b>acquires</b> <a href="topo_account.md#0x1_topo_account_DirectTransferConfig">DirectTransferConfig</a> {
    !<b>exists</b>&lt;<a href="topo_account.md#0x1_topo_account_DirectTransferConfig">DirectTransferConfig</a>&gt;(<a href="account.md#0x1_account">account</a>)
        || <b>borrow_global</b>&lt;<a href="topo_account.md#0x1_topo_account_DirectTransferConfig">DirectTransferConfig</a>&gt;(<a href="account.md#0x1_account">account</a>).allow_arbitrary_coin_transfers
}
</code></pre>
...
<a id="0x1_topo_account_register_topo"></a>
...
<a id="0x1_topo_account_fungible_transfer_only"></a>
...
<a id="0x1_topo_account_is_fungible_balance_at_least"></a>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="topo_account.md#0x1_topo_account_is_fungible_balance_at_least">is_fungible_balance_at_least</a>(<a href="account.md#0x1_account">account</a>: <b>address</b>, amount: u64): bool
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="topo_account.md#0x1_topo_account_is_fungible_balance_at_least">is_fungible_balance_at_least</a>(
...
<a id="0x1_topo_account_burn_from_fungible_store_for_gas"></a>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="topo_account.md#0x1_topo_account_burn_from_fungible_store_for_gas">burn_from_fungible_store_for_gas</a>(ref: &<a href="fungible_asset.md#0x1_fungible_asset_BurnRef">fungible_asset::BurnRef</a>, <a href="account.md#0x1_account">account</a>: <b>address</b>, amount: u64)
</code></pre>
...
<a id="0x1_topo_account_ensure_primary_fungible_store_exists"></a>
...
<pre><code><b>fun</b> <a href="topo_account.md#0x1_topo_account_ensure_primary_fungible_store_exists">ensure_primary_fungible_store_exists</a>(owner: <b>address</b>): <b>address</b>
</code></pre>
...
<pre><code>inline <b>fun</b> <a href="topo_account.md#0x1_topo_account_ensure_primary_fungible_store_exists">ensure_primary_fungible_store_exists</a>(owner: <b>address</b>): <b>address</b> {
    <b>let</b> store_addr = <a href="topo_account.md#0x1_topo_account_primary_fungible_store_address">primary_fungible_store_address</a>(owner);
    <b>if</b> (<a href="fungible_asset.md#0x1_fungible_asset_store_exists">fungible_asset::store_exists</a>(store_addr)) {
        ...
        <a href="primary_fungible_store.md#0x1_primary_fungible_store_create_primary_store">primary_fungible_store::create_primary_store</a>(
                owner, <a href="object.md#0x1_object_address_to_object">object::address_to_object</a>&lt;Metadata&gt;(@aptos_fungible_asset)
            ).object_address()
    }
}
</code></pre>
...
<a id="0x1_topo_account_primary_fungible_store_address"></a>
...
<pre><code><b>fun</b> <a href="topo_account.md#0x1_topo_account_primary_fungible_store_address">primary_fungible_store_address</a>(<a href="account.md#0x1_account">account</a>: <b>address</b>): <b>address</b>
</code></pre>
...
<pre><code>inline <b>fun</b> <a href="topo_account.md#0x1_topo_account_primary_fungible_store_address">primary_fungible_store_address</a>(<a href="account.md#0x1_account">account</a>: <b>address</b>): <b>address</b> {
...
Limit the address of auth_key is not @vm_reserved / @topo_framework / @aptos_toke.


<pre><code>// This enforces <a id="high-level-req-1" href="#high-level-req">high-level requirement 1</a>:
<b>pragma</b> aborts_if_is_partial;
<b>include</b> <a href="topo_account.md#0x1_topo_account_CreateAccountAbortsIf">CreateAccountAbortsIf</a>;
</code></pre>




<a id="0x1_topo_account_CreateAccountAbortsIf"></a>


<pre><code><b>schema</b> <a href="topo_account.md#0x1_topo_account_CreateAccountAbortsIf">CreateAccountAbortsIf</a> {
    auth_key: <b>address</b>;
    <b>aborts_if</b> <b>exists</b>&lt;<a href="account.md#0x1_account_Account">account::Account</a>&gt;(auth_key);
    <b>aborts_if</b> auth_key == @vm_reserved || auth_key == @topo_framework || auth_key == @aptos_token;
}
</code></pre>
...
<a id="0x1_topo_account_length_judgment"></a>
...
<b>aborts_if</b> <b>exists</b> i in 0..len(recipients):
        !<a href="account.md#0x1_account_spec_exists_at">account::spec_exists_at</a>(recipients[i]) && <a href="topo_account.md#0x1_topo_account_length_judgment">length_judgment</a>(recipients[i]);
<b>aborts_if</b> <b>exists</b> i in 0..len(recipients):
        !<a href="account.md#0x1_account_spec_exists_at">account::spec_exists_at</a>(recipients[i]) && (recipients[i] == @vm_reserved || recipients[i] == @topo_framework || recipients[i] == @aptos_token);
...
<b>include</b> <a href="topo_account.md#0x1_topo_account_TransferEnsures">TransferEnsures</a>&lt;TopoCoin&gt;;
...
<b>ensures</b> <b>exists</b>&lt;topo_framework::account::Account&gt;(<b>to</b>);
...
<b>include</b> <a href="topo_account.md#0x1_topo_account_RegistCoinAbortsIf">RegistCoinAbortsIf</a>&lt;CoinType&gt;;
<b>include</b> <a href="topo_account.md#0x1_topo_account_TransferEnsures">TransferEnsures</a>&lt;CoinType&gt;;
...
<b>ensures</b> <b>exists</b>&lt;topo_framework::account::Account&gt;(<b>to</b>);
<b>ensures</b> <b>exists</b>&lt;topo_framework::coin::CoinStore&lt;CoinType&gt;&gt;(<b>to</b>);
</code></pre>
...
<b>ensures</b> result == (
    !<b>exists</b>&lt;<a href="topo_account.md#0x1_topo_account_DirectTransferConfig">DirectTransferConfig</a>&gt;(<a href="account.md#0x1_account">account</a>) ||
        <b>global</b>&lt;<a href="topo_account.md#0x1_topo_account_DirectTransferConfig">DirectTransferConfig</a>&gt;(<a href="account.md#0x1_account">account</a>).allow_arbitrary_coin_transfers
);
</code></pre>
...
<a id="0x1_topo_account_CreateAccountTransferAbortsIf"></a>


<pre><code><b>schema</b> <a href="topo_account.md#0x1_topo_account_CreateAccountTransferAbortsIf">CreateAccountTransferAbortsIf</a> {
    <b>to</b>: <b>address</b>;
    <b>aborts_if</b> !<a href="account.md#0x1_account_spec_exists_at">account::spec_exists_at</a>(<b>to</b>) && <a href="topo_account.md#0x1_topo_account_length_judgment">length_judgment</a>(<b>to</b>);
    <b>aborts_if</b> !<a href="account.md#0x1_account_spec_exists_at">account::spec_exists_at</a>(<b>to</b>) && (<b>to</b> == @vm_reserved || <b>to</b> == @topo_framework || <b>to</b> == @aptos_token);
}
</code></pre>
...
<a id="0x1_topo_account_WithdrawAbortsIf"></a>
...
<a id="0x1_topo_account_GuidAbortsIf"></a>


<pre><code><b>schema</b> <a href="topo_account.md#0x1_topo_account_GuidAbortsIf">GuidAbortsIf</a>&lt;CoinType&gt; {
    <b>to</b>: <b>address</b>;
...
<a id="0x1_topo_account_RegistCoinAbortsIf"></a>
...
<a id="0x1_topo_account_TransferEnsures"></a>


<pre><code><b>schema</b> <a href="topo_account.md#0x1_topo_account_TransferEnsures">TransferEnsures</a>&lt;CoinType&gt; {
    <b>to</b>: <b>address</b>;
