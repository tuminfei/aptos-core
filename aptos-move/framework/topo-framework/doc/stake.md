...
Validator lifecycle:
1. Prepare validator metadata by calling <code><a href="stake.md#0x1_stake_initialize_validator">stake::initialize_validator</a></code>.
2. Manage principal and delegation through <code><a href="staking_registry.md#0x1_staking_registry">staking_registry</a></code>.
3. Call <code><a href="stake.md#0x1_stake_join_validator_set">stake::join_validator_set</a></code> to enter the validator set. Changes are effective in the next epoch.
4. Rewards and transaction fees are accounted in <code><a href="staking_registry.md#0x1_staking_registry">staking_registry</a></code>; <code><a href="stake.md#0x1_stake">stake</a>.<b>move</b></code> only maintains validator-set state.
5. Operators may still rotate consensus keys and network/fullnode addresses through this module.
6. Owners may switch operators through <code><a href="stake.md#0x1_stake_set_operator">stake::set_operator</a></code>.
...
<code><a href="stake.md#0x1_stake">stake</a>.<b>move</b></code> is the validator-set manager for the Topo chain. It owns the canonical <code><a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a></code>
resource and orchestrates the epoch transition (<code>on_new_epoch</code>). Economic accounting (deposits,
rewards, fees, power) has been fully delegated to <code><a href="staking_registry.md#0x1_staking_registry">staking_registry</a></code> and <code><a href="poc_power_store.md#0x1_poc_power_store">poc_power_store</a></code>.


<a id="@Separation_of_Concerns_1"></a>
...
<a id="@Epoch_Transition_(<code>on_new_epoch</code>)_Flow_2"></a>

### Epoch Transition (<code>on_new_epoch</code>) Flow
...
= sum of min(poc_power_i, deposit_i * 1,000,000 / octas_per_million_power) for each delegator i
    ...
    -  [Separation of Concerns](#@Separation_of_Concerns_1)
    -  [Epoch Transition (<code>on_new_epoch</code>) Flow](#@Epoch_Transition_(<code>on_new_epoch</code>)_Flow_2)
    -  [Voting Power Model](#@Voting_Power_Model_3)
...
-  [Struct `ValidatorSetLivenessFallback`](#0x1_stake_ValidatorSetLivenessFallback)
...
-  [Function `initialize_stake_pool`](#0x1_stake_initialize_stake_pool)
-  [Function `initialize_validator`](#0x1_stake_initialize_validator)
-  [Function `initialize_owner`](#0x1_stake_initialize_owner)
-  [Function `initialize_stake_pool_with_empty_config`](#0x1_stake_initialize_stake_pool_with_empty_config)
-  [Function `empty_validator_config`](#0x1_stake_empty_validator_config)
-  [Function `register_self_owned_validator`](#0x1_stake_register_self_owned_validator)
...
-  [Function `get_current_epoch_governance_voting_power`](#0x1_stake_get_current_epoch_governance_voting_power)
-  [Function `next_validator_consensus_infos`](#0x1_stake_next_validator_consensus_infos)
-  [Function `simulate_next_epoch_validator_set`](#0x1_stake_simulate_next_epoch_validator_set)
-  [Function `compute_simulated_validator_info`](#0x1_stake_compute_simulated_validator_info)
-  [Function `previous_positive_active_validator_snapshot`](#0x1_stake_previous_positive_active_validator_snapshot)
-  [Function `sync_registry_statuses_to_active_set`](#0x1_stake_sync_registry_statuses_to_active_set)
-  [Function `simulate_epoch_accruals_for_validator`](#0x1_stake_simulate_epoch_accruals_for_validator)
-  [Function `simulate_reward_distribution_for_validator`](#0x1_stake_simulate_reward_distribution_for_validator)
-  [Function `simulate_fee_distribution_for_validator`](#0x1_stake_simulate_fee_distribution_for_validator)
-  [Function `simulate_registry_distribution_for_validator`](#0x1_stake_simulate_registry_distribution_for_validator)
-  [Function `get_validator_total_power_with_extra_deposit_for_next_epoch`](#0x1_stake_get_validator_total_power_with_extra_deposit_for_next_epoch)
-  [Function `add_simulated_deposit_delta`](#0x1_stake_add_simulated_deposit_delta)
-  [Function `get_pending_transaction_fee_for_validator`](#0x1_stake_get_pending_transaction_fee_for_validator)
...
-  [Function `collect_transaction_fee_for_validator`](#0x1_stake_collect_transaction_fee_for_validator)
...
-  [Function `cap_validator_info_voting_power_for_epoch`](#0x1_stake_cap_validator_info_voting_power_for_epoch)
-  [Function `cap_voting_power_for_epoch`](#0x1_stake_cap_voting_power_for_epoch)
-  [Function `calculate_max_voting_power_increase`](#0x1_stake_calculate_max_voting_power_increase)
-  [Function `voting_power_increase`](#0x1_stake_voting_power_increase)
-  [Function `min_u64`](#0x1_stake_min_u64)
...
-  [Specification](#@Specification_5)
    ...
    -  [Resource `ValidatorSet`](#@Specification_5_ValidatorSet)
    -  [Function `get_validator_state`](#@Specification_5_get_validator_state)
    -  [Function `get_pending_transaction_fee`](#@Specification_5_get_pending_transaction_fee)
    -  [Function `initialize`](#@Specification_5_initialize)
    -  [Function `remove_validators`](#@Specification_5_remove_validators)
    -  [Function `initialize_stake_owner`](#@Specification_5_initialize_stake_owner)
    -  [Function `initialize_validator`](#@Specification_5_initialize_validator)
    -  [Function `extract_owner_cap`](#@Specification_5_extract_owner_cap)
    -  [Function `deposit_owner_cap`](#@Specification_5_deposit_owner_cap)
    -  [Function `set_operator_with_cap`](#@Specification_5_set_operator_with_cap)
    -  [Function `rotate_consensus_key`](#@Specification_5_rotate_consensus_key)
    -  [Function `update_network_and_fullnode_addresses`](#@Specification_5_update_network_and_fullnode_addresses)
    -  [Function `increase_lockup_with_cap`](#@Specification_5_increase_lockup_with_cap)
    -  [Function `join_validator_set`](#@Specification_5_join_validator_set)
    -  [Function `leave_validator_set`](#@Specification_5_leave_validator_set)
    -  [Function `is_current_epoch_validator`](#@Specification_5_is_current_epoch_validator)
    -  [Function `update_performance_statistics`](#@Specification_5_update_performance_statistics)
    -  [Function `on_new_epoch`](#@Specification_5_on_new_epoch)
    -  [Function `next_validator_consensus_infos`](#@Specification_5_next_validator_consensus_infos)
    -  [Function `compute_simulated_validator_info`](#@Specification_5_compute_simulated_validator_info)
    -  [Function `validator_consensus_infos_from_validator_set`](#@Specification_5_validator_consensus_infos_from_validator_set)
    -  [Function `update_stake_pool`](#@Specification_5_update_stake_pool)
    -  [Function `get_reconfig_start_time_secs`](#@Specification_5_get_reconfig_start_time_secs)
    -  [Function `calculate_rewards_amount`](#@Specification_5_calculate_rewards_amount)
    -  [Function `append`](#@Specification_5_append)
    -  [Function `find_validator`](#@Specification_5_find_validator)
    -  [Function `update_voting_power_increase`](#@Specification_5_update_voting_power_increase)
    -  [Function `assert_stake_pool_exists`](#@Specification_5_assert_stake_pool_exists)
    -  [Function `configure_allowed_validators`](#@Specification_5_configure_allowed_validators)
    -  [Function `assert_owner_cap_exists`](#@Specification_5_assert_owner_cap_exists)
...
<b>use</b> <a href="../../topo-stdlib/doc/bls12381.md#0x1_bls12381">0x1::bls12381</a>;
...
by <code><a href="staking_registry.md#0x1_staking_registry">staking_registry</a></code>. The coin buckets here are retained for lockup tracking and
...
The VM calls <code>record_fee</code> during block execution to credit each validator's share
of transaction fees. At epoch end, <code>collect_transaction_fee_for_validator</code> drains
each entry and passes the amount to <code><a href="staking_registry.md#0x1_staking_registry_distribute_transaction_fees">staking_registry::distribute_transaction_fees</a></code>.

Uses <code>BigOrderedMap&lt;u64, Aggregator&lt;u64&gt;&gt;</code> so that concurrent transactions can
...
<a id="0x1_stake_ValidatorSetLivenessFallback"></a>
...
<pre><code>#[<a href="event.md#0x1_event">event</a>]
<b>struct</b> <a href="stake.md#0x1_stake_ValidatorSetLivenessFallback">ValidatorSetLivenessFallback</a> <b>has</b> drop, store
</code></pre>
...
<dt>
<code>emergency_validator_count: u64</code>
</dt>
<dd>

</dd>
<dt>
<code>total_emergency_voting_power: u128</code>
</dt>
<dd>
...
<a id="0x1_stake_EINITIAL_STAKE_NOT_SUPPORTED"></a>

<code>initialize_stake_owner</code> no longer accepts an inline principal deposit.


<pre><code><b>const</b> <a href="stake.md#0x1_stake_EINITIAL_STAKE_NOT_SUPPORTED">EINITIAL_STAKE_NOT_SUPPORTED</a>: u64 = 30;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="stake.md#0x1_stake_grant_permission">grant_permission</a>(
    master: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, <a href="permissioned_signer.md#0x1_permissioned_signer">permissioned_signer</a>: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>
) {
    <a href="permissioned_signer.md#0x1_permissioned_signer_authorize_unlimited">permissioned_signer::authorize_unlimited</a>(
        master, <a href="permissioned_signer.md#0x1_permissioned_signer">permissioned_signer</a>, <a href="stake.md#0x1_stake_StakeManagementPermission">StakeManagementPermission</a> {}
    )
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="stake.md#0x1_stake_get_remaining_lockup_secs">get_remaining_lockup_secs</a>(pool_address: <b>address</b>): u64 <b>acquires</b> <a href="stake.md#0x1_stake_StakePool">StakePool</a> {
    ...
    <b>if</b> (lockup_time &lt;= <a href="timestamp.md#0x1_timestamp_now_seconds">timestamp::now_seconds</a>()) { 0 }
    <b>else</b> {
...
<pre><code><b>public</b> <b>fun</b> <a href="stake.md#0x1_stake_get_validator_state">get_validator_state</a>(pool_address: <b>address</b>): u64 <b>acquires</b> <a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a> {
    <b>let</b> validator_set = <b>borrow_global</b>&lt;<a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a>&gt;(@topo_framework);
...
<pre><code><b>public</b> <b>fun</b> <a href="stake.md#0x1_stake_get_current_epoch_voting_power">get_current_epoch_voting_power</a>(
    pool_address: <b>address</b>
): u64 <b>acquires</b> <a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a> {
    <a href="stake.md#0x1_stake_assert_stake_pool_exists">assert_stake_pool_exists</a>(pool_address);
    ...
    <b>if</b> (validator_state == <a href="stake.md#0x1_stake_VALIDATOR_STATUS_ACTIVE">VALIDATOR_STATUS_ACTIVE</a>
        || validator_state == <a href="stake.md#0x1_stake_VALIDATOR_STATUS_PENDING_INACTIVE">VALIDATOR_STATUS_PENDING_INACTIVE</a>) {
        ...
        <a href="stake.md#0x1_stake_min_u64">min_u64</a>(<a href="staking_registry.md#0x1_staking_registry_get_validator_total_power">staking_registry::get_validator_total_power</a>(pool_address), maximum_stake)
    } <b>else</b> { 0 }
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="stake.md#0x1_stake_get_current_epoch_proposal_counts">get_current_epoch_proposal_counts</a>(
    validator_index: u64
): (u64, u64) <b>acquires</b> <a href="stake.md#0x1_stake_ValidatorPerformance">ValidatorPerformance</a> {
    <b>let</b> validator_performances =
        &<b>borrow_global</b>&lt;<a href="stake.md#0x1_stake_ValidatorPerformance">ValidatorPerformance</a>&gt;(@topo_framework).validators;
...
<pre><code>#[view]
<b>public</b> <b>fun</b> <a href="stake.md#0x1_stake_get_pending_transaction_fee">get_pending_transaction_fee</a>(): <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u64&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="stake.md#0x1_stake_get_pending_transaction_fee">get_pending_transaction_fee</a>(): <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u64&gt; <b>acquires</b> <a href="stake.md#0x1_stake_PendingTransactionFee">PendingTransactionFee</a> {
    <b>let</b> result = <a href="../../move-stdlib/doc/vector.md#0x1_vector_empty">vector::empty</a>();
    <b>let</b> fee_table =
        &<b>borrow_global</b>&lt;<a href="stake.md#0x1_stake_PendingTransactionFee">PendingTransactionFee</a>&gt;(@topo_framework).pending_fee_by_validator;
...
<pre><code><b>public</b> <b>fun</b> <a href="stake.md#0x1_stake_get_active_validator_count">get_active_validator_count</a>(): u64 <b>acquires</b> <a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a> {
    <b>borrow_global</b>&lt;<a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a>&gt;(@topo_framework).active_validators.length()
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="stake.md#0x1_stake_get_pending_active_validator_count">get_pending_active_validator_count</a>(): u64 <b>acquires</b> <a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a> {
    <b>borrow_global</b>&lt;<a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a>&gt;(@topo_framework).pending_active.length()
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="stake.md#0x1_stake_get_pending_inactive_validator_count">get_pending_inactive_validator_count</a>(): u64 <b>acquires</b> <a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a> {
    <b>borrow_global</b>&lt;<a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a>&gt;(@topo_framework).pending_inactive.length()
}
</code></pre>
...
<pre><code>#[view]
<b>public</b> <b>fun</b> <a href="stake.md#0x1_stake_get_active_validators">get_active_validators</a>(offset: u64, limit: u64): <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<b>address</b>&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="stake.md#0x1_stake_get_active_validators">get_active_validators</a>(
    offset: u64,
    limit: u64
): <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<b>address</b>&gt; <b>acquires</b> <a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a> {
    <b>let</b> validator_set = <b>borrow_global</b>&lt;<a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a>&gt;(@topo_framework);
...
<pre><code>#[view]
<b>public</b> <b>fun</b> <a href="stake.md#0x1_stake_get_pending_active_validators">get_pending_active_validators</a>(offset: u64, limit: u64): <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<b>address</b>&gt;
</code></pre>
...
<pre><code>#[view]
<b>public</b> <b>fun</b> <a href="stake.md#0x1_stake_get_pending_inactive_validators">get_pending_inactive_validators</a>(offset: u64, limit: u64): <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<b>address</b>&gt;
</code></pre>
...
<pre><code>#[view]
<b>public</b> <b>fun</b> <a href="stake.md#0x1_stake_get_current_epoch_validators">get_current_epoch_validators</a>(offset: u64, limit: u64): <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<b>address</b>&gt;
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="stake.md#0x1_stake_initialize">initialize</a>(topo_framework: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="stake.md#0x1_stake_initialize">initialize</a>(topo_framework: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>) {
    ...
    <b>move_to</b>(topo_framework, <a href="stake.md#0x1_stake_ValidatorPerformance">ValidatorPerformance</a> { validators: <a href="../../move-stdlib/doc/vector.md#0x1_vector_empty">vector::empty</a>() });
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="stake.md#0x1_stake_store_topo_coin_mint_cap">store_topo_coin_mint_cap</a>(
    topo_framework: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, mint_cap: MintCapability&lt;TopoCoin&gt;
) {
    <a href="system_addresses.md#0x1_system_addresses_assert_aptos_framework">system_addresses::assert_aptos_framework</a>(topo_framework);
    <b>move_to</b>(topo_framework, <a href="stake.md#0x1_stake_TopoCoinCapabilities">TopoCoinCapabilities</a> { mint_cap })
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="stake.md#0x1_stake_remove_validators">remove_validators</a>(topo_framework: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, validators: &<a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<b>address</b>&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="stake.md#0x1_stake_remove_validators">remove_validators</a>(
    topo_framework: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, validators: &<a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<b>address</b>&gt;
    ...
    <a href="system_addresses.md#0x1_system_addresses_assert_aptos_framework">system_addresses::assert_aptos_framework</a>(topo_framework);
    <b>let</b> validator_set = <b>borrow_global_mut</b>&lt;<a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a>&gt;(@topo_framework);
    ...
    <b>while</b> ({
        <b>spec</b> {
            ...
            <b>invariant</b> <a href="stake.md#0x1_stake_ghost_active_num">ghost_active_num</a> + <a href="stake.md#0x1_stake_ghost_pending_inactive_num">ghost_pending_inactive_num</a>
        ...
        <b>if</b> (validator_index.is_some()) {
            <b>let</b> validator_info =
                active_validators.swap_remove(*validator_index.borrow());
            pending_inactive.push_back(validator_info);
            <a href="staking_registry.md#0x1_staking_registry_set_validator_pending_inactive">staking_registry::set_validator_pending_inactive</a>(validator);
            <b>spec</b> {
...
<pre><code><b>public</b> <b>fun</b> <a href="stake.md#0x1_stake_initialize_pending_transaction_fee">initialize_pending_transaction_fee</a>(framework: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="stake.md#0x1_stake_initialize_pending_transaction_fee">initialize_pending_transaction_fee</a>(framework: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>) {
    ...
    <b>if</b> (!<b>exists</b>&lt;<a href="stake.md#0x1_stake_PendingTransactionFee">PendingTransactionFee</a>&gt;(@topo_framework)) {
        <b>move_to</b>(
            framework,
            <a href="stake.md#0x1_stake_PendingTransactionFee">PendingTransactionFee</a> {
                ...
                pending_fee_by_validator: <a href="big_ordered_map.md#0x1_big_ordered_map_new_with_config">big_ordered_map::new_with_config</a>(
                    5, 10, <b>true</b>
                )
            }
        );
...
<a id="0x1_stake_set_transaction_fee_limit_per_epoch_per_pool"></a>

## Function `set_transaction_fee_limit_per_epoch_per_pool`



<pre><code><b>public</b> <b>fun</b> <a href="stake.md#0x1_stake_set_transaction_fee_limit_per_epoch_per_pool">set_transaction_fee_limit_per_epoch_per_pool</a>(framework: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, limit_octa: u64)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="stake.md#0x1_stake_set_transaction_fee_limit_per_epoch_per_pool">set_transaction_fee_limit_per_epoch_per_pool</a>(
    framework: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, limit_octa: u64
) <b>acquires</b> <a href="stake.md#0x1_stake_TransactionFeeConfig">TransactionFeeConfig</a> {
    <a href="system_addresses.md#0x1_system_addresses_assert_aptos_framework">system_addresses::assert_aptos_framework</a>(framework);

    <b>let</b> config = TransactionFeeConfig::V0 {
        max_fee_octa_allowed_per_epoch_per_pool: limit_octa
    };

    <a href="stake.md#0x1_stake_set_transaction_fee_config">set_transaction_fee_config</a>(framework, config);
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="stake.md#0x1_stake_set_transaction_fee_config">set_transaction_fee_config</a>(framework: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, config: <a href="stake.md#0x1_stake_TransactionFeeConfig">stake::TransactionFeeConfig</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="stake.md#0x1_stake_set_transaction_fee_config">set_transaction_fee_config</a>(
    framework: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, config: <a href="stake.md#0x1_stake_TransactionFeeConfig">TransactionFeeConfig</a>
) <b>acquires</b> <a href="stake.md#0x1_stake_TransactionFeeConfig">TransactionFeeConfig</a> {
    <a href="system_addresses.md#0x1_system_addresses_assert_aptos_framework">system_addresses::assert_aptos_framework</a>(framework);

    <b>if</b> (<b>exists</b>&lt;<a href="stake.md#0x1_stake_TransactionFeeConfig">TransactionFeeConfig</a>&gt;(@topo_framework)) {
        *<b>borrow_global_mut</b>&lt;<a href="stake.md#0x1_stake_TransactionFeeConfig">TransactionFeeConfig</a>&gt;(@topo_framework) = config;
    } <b>else</b> {
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="stake.md#0x1_stake_record_fee">record_fee</a>(vm: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, fee_distribution_validator_indices: <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u64&gt;, fee_amounts_octa: <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u64&gt;)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="stake.md#0x1_stake_record_fee">record_fee</a>(
    ...
    fee_distribution_validator_indices: <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u64&gt;,
    fee_amounts_octa: <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u64&gt;
    ...
    <b>let</b> pending_fee = <b>borrow_global_mut</b>&lt;<a href="stake.md#0x1_stake_PendingTransactionFee">PendingTransactionFee</a>&gt;(@topo_framework);
    <b>let</b> i = 0;
...
<pre><code><b>public</b> entry <b>fun</b> <a href="stake.md#0x1_stake_initialize_stake_owner">initialize_stake_owner</a>(owner: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, initial_stake_amount: u64, operator: <b>address</b>)
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="stake.md#0x1_stake_initialize_stake_owner">initialize_stake_owner</a>(
    ...
    <a href="stake.md#0x1_stake_initialize_stake_pool_with_empty_config">initialize_stake_pool_with_empty_config</a>(owner, operator);
    <b>assert</b>!(
        initial_stake_amount == 0,
        <a href="../../move-stdlib/doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="stake.md#0x1_stake_EINITIAL_STAKE_NOT_SUPPORTED">EINITIAL_STAKE_NOT_SUPPORTED</a>)
    );
    <a href="stake.md#0x1_stake_register_self_owned_validator">register_self_owned_validator</a>(<a href="../../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(owner));
}
</code></pre>
...
<a id="0x1_stake_initialize_stake_pool"></a>

## Function `initialize_stake_pool`

Initializes a stake pool plus empty validator config for a resource-account backed pool.
The caller is responsible for registering the correct owner in <code><a href="staking_registry.md#0x1_staking_registry">staking_registry</a></code>.


<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="stake.md#0x1_stake_initialize_stake_pool">initialize_stake_pool</a>(owner: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, operator: <b>address</b>)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="stake.md#0x1_stake_initialize_stake_pool">initialize_stake_pool</a>(
    owner: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>,
    operator: <b>address</b>
) <b>acquires</b> <a href="stake.md#0x1_stake_AllowedValidators">AllowedValidators</a>, <a href="stake.md#0x1_stake_OwnerCapability">OwnerCapability</a>, <a href="stake.md#0x1_stake_StakePool">StakePool</a> {
    <a href="stake.md#0x1_stake_initialize_stake_pool_with_empty_config">initialize_stake_pool_with_empty_config</a>(owner, operator);
...
<pre><code><b>public</b> entry <b>fun</b> <a href="stake.md#0x1_stake_initialize_validator">initialize_validator</a>(
    ...
    <b>let</b> pubkey_from_pop =
        &<a href="../../topo-stdlib/doc/bls12381.md#0x1_bls12381_public_key_from_bytes_with_pop">bls12381::public_key_from_bytes_with_pop</a>(
            consensus_pubkey,
            &proof_of_possession_from_bytes(proof_of_possession)
        );
    <b>assert</b>!(
        pubkey_from_pop.is_some(), <a href="../../move-stdlib/doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="stake.md#0x1_stake_EINVALID_PUBLIC_KEY">EINVALID_PUBLIC_KEY</a>)
    );

    <a href="stake.md#0x1_stake_initialize_owner">initialize_owner</a>(<a href="account.md#0x1_account">account</a>);
    <b>move_to</b>(
        <a href="account.md#0x1_account">account</a>,
        <a href="stake.md#0x1_stake_ValidatorConfig">ValidatorConfig</a> {
            consensus_pubkey,
            network_addresses,
            fullnode_addresses,
            validator_index: 0
    ...
    <a href="stake.md#0x1_stake_register_self_owned_validator">register_self_owned_validator</a>(<a href="../../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(<a href="account.md#0x1_account">account</a>));
}
</code></pre>
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_initialize_owner">initialize_owner</a>(owner: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>) <b>acquires</b> <a href="stake.md#0x1_stake_AllowedValidators">AllowedValidators</a> {
    ...
    <b>assert</b>!(
        !<a href="stake.md#0x1_stake_stake_pool_exists">stake_pool_exists</a>(owner_address),
        <a href="../../move-stdlib/doc/error.md#0x1_error_already_exists">error::already_exists</a>(<a href="stake.md#0x1_stake_EALREADY_REGISTERED">EALREADY_REGISTERED</a>)
    );
...
<a id="0x1_stake_initialize_stake_pool_with_empty_config"></a>

## Function `initialize_stake_pool_with_empty_config`



<pre><code><b>fun</b> <a href="stake.md#0x1_stake_initialize_stake_pool_with_empty_config">initialize_stake_pool_with_empty_config</a>(owner: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, operator: <b>address</b>)
</code></pre>
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_initialize_stake_pool_with_empty_config">initialize_stake_pool_with_empty_config</a>(
    owner: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>,
    operator: <b>address</b>,
) <b>acquires</b> <a href="stake.md#0x1_stake_AllowedValidators">AllowedValidators</a>, <a href="stake.md#0x1_stake_OwnerCapability">OwnerCapability</a>, <a href="stake.md#0x1_stake_StakePool">StakePool</a> {
    <a href="stake.md#0x1_stake_check_stake_permission">check_stake_permission</a>(owner);
    <a href="stake.md#0x1_stake_initialize_owner">initialize_owner</a>(owner);
    <b>move_to</b>(owner, <a href="stake.md#0x1_stake_empty_validator_config">empty_validator_config</a>());

    <b>let</b> owner_address = <a href="../../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(owner);
    <b>if</b> (owner_address != operator) {
...
<a id="0x1_stake_empty_validator_config"></a>

## Function `empty_validator_config`



<pre><code><b>fun</b> <a href="stake.md#0x1_stake_empty_validator_config">empty_validator_config</a>(): <a href="stake.md#0x1_stake_ValidatorConfig">stake::ValidatorConfig</a>
</code></pre>
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_empty_validator_config">empty_validator_config</a>(): <a href="stake.md#0x1_stake_ValidatorConfig">ValidatorConfig</a> {
    <a href="stake.md#0x1_stake_ValidatorConfig">ValidatorConfig</a> {
...
<a id="0x1_stake_register_self_owned_validator"></a>

## Function `register_self_owned_validator`



<pre><code><b>fun</b> <a href="stake.md#0x1_stake_register_self_owned_validator">register_self_owned_validator</a>(owner_address: <b>address</b>)
</code></pre>
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_register_self_owned_validator">register_self_owned_validator</a>(owner_address: <b>address</b>) {
    <b>if</b> (<a href="staking_registry.md#0x1_staking_registry_registry_exists">staking_registry::registry_exists</a>() && !<a href="staking_registry.md#0x1_staking_registry_validator_exists">staking_registry::validator_exists</a>(owner_address)) {
        <a href="staking_registry.md#0x1_staking_registry_register_validator_for_owner">staking_registry::register_validator_for_owner</a>(
            owner_address,
            owner_address,
            0,
        );
...
<pre><code><b>public</b> <b>fun</b> <a href="stake.md#0x1_stake_deposit_owner_cap">deposit_owner_cap</a>(
    owner: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, owner_cap: <a href="stake.md#0x1_stake_OwnerCapability">OwnerCapability</a>
) {
    <a href="stake.md#0x1_stake_check_stake_permission">check_stake_permission</a>(owner);
    <b>assert</b>!(
        !<b>exists</b>&lt;<a href="stake.md#0x1_stake_OwnerCapability">OwnerCapability</a>&gt;(<a href="../../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(owner)),
        <a href="../../move-stdlib/doc/error.md#0x1_error_not_found">error::not_found</a>(<a href="stake.md#0x1_stake_EOWNER_CAP_ALREADY_EXISTS">EOWNER_CAP_ALREADY_EXISTS</a>)
    );
...
<pre><code><b>public</b> entry <b>fun</b> <a href="stake.md#0x1_stake_set_operator">set_operator</a>(
    owner: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, new_operator: <b>address</b>
...
<pre><code><b>public</b> <b>fun</b> <a href="stake.md#0x1_stake_set_operator_with_cap">set_operator_with_cap</a>(
    owner_cap: &<a href="stake.md#0x1_stake_OwnerCapability">OwnerCapability</a>, new_operator: <b>address</b>
    ...
    <a href="event.md#0x1_event_emit">event::emit</a>(<a href="stake.md#0x1_stake_SetOperator">SetOperator</a> { pool_address, old_operator, new_operator });
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="stake.md#0x1_stake_rotate_consensus_key">rotate_consensus_key</a>(
    ...
    <b>let</b> stake_pool = <b>borrow_global_mut</b>&lt;<a href="stake.md#0x1_stake_StakePool">StakePool</a>&gt;(pool_address);
    <b>assert</b>!(
        <a href="../../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(operator) == stake_pool.operator_address,
        <a href="../../move-stdlib/doc/error.md#0x1_error_unauthenticated">error::unauthenticated</a>(<a href="stake.md#0x1_stake_ENOT_OPERATOR">ENOT_OPERATOR</a>)
    );

    <b>assert</b>!(
        <b>exists</b>&lt;<a href="stake.md#0x1_stake_ValidatorConfig">ValidatorConfig</a>&gt;(pool_address),
        <a href="../../move-stdlib/doc/error.md#0x1_error_not_found">error::not_found</a>(<a href="stake.md#0x1_stake_EVALIDATOR_CONFIG">EVALIDATOR_CONFIG</a>)
    );
...
<pre><code><b>public</b> <b>fun</b> <a href="stake.md#0x1_stake_increase_lockup_with_cap">increase_lockup_with_cap</a>(owner_cap: &<a href="stake.md#0x1_stake_OwnerCapability">OwnerCapability</a>) <b>acquires</b> <a href="stake.md#0x1_stake_StakePool">StakePool</a> {
    ...
    <b>assert</b>!(
        ...
        <a href="../../move-stdlib/doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="stake.md#0x1_stake_EINVALID_LOCKUP">EINVALID_LOCKUP</a>)
    );
...
<pre><code><b>public</b> entry <b>fun</b> <a href="stake.md#0x1_stake_join_validator_set">join_validator_set</a>(
    operator: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, pool_address: <b>address</b>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="stake.md#0x1_stake_join_validator_set_internal">join_validator_set_internal</a>(
    ...
    <b>let</b> self_power = <a href="staking_registry.md#0x1_staking_registry_get_validator_joining_power">staking_registry::get_validator_joining_power</a>(pool_address);
    <b>assert</b>!(self_power &gt; 0, <a href="../../move-stdlib/doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="stake.md#0x1_stake_ESTAKE_TOO_LOW">ESTAKE_TOO_LOW</a>));
    <b>let</b> voting_power = <a href="staking_registry.md#0x1_staking_registry_get_validator_total_power">staking_registry::get_validator_total_power</a>(pool_address);
    ...
    <b>assert</b>!(
        ...
        <a href="../../move-stdlib/doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="stake.md#0x1_stake_EINVALID_PUBLIC_KEY">EINVALID_PUBLIC_KEY</a>)
    );

    // Validate the current validator set size <b>has</b> not exceeded the limit.
    <b>let</b> validator_set = <b>borrow_global_mut</b>&lt;<a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a>&gt;(@topo_framework);
    validator_set.pending_active.push_back(
        <a href="stake.md#0x1_stake_generate_validator_info">generate_validator_info</a>(pool_address, *validator_config)
    );
    <b>let</b> validator_set_size =
        validator_set.active_validators.length()
            + validator_set.pending_active.length();
    <b>assert</b>!(
        validator_set_size &lt;= <a href="stake.md#0x1_stake_MAX_VALIDATOR_SET_SIZE">MAX_VALIDATOR_SET_SIZE</a>,
        <a href="../../move-stdlib/doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="stake.md#0x1_stake_EVALIDATOR_SET_TOO_LARGE">EVALIDATOR_SET_TOO_LARGE</a>)
    );
    <a href="staking_registry.md#0x1_staking_registry_set_validator_pending_active">staking_registry::set_validator_pending_active</a>(pool_address);
...
<pre><code><b>public</b> entry <b>fun</b> <a href="stake.md#0x1_stake_leave_validator_set">leave_validator_set</a>(
    ...
    <b>let</b> maybe_pending_active_index =
        <a href="stake.md#0x1_stake_find_validator">find_validator</a>(&validator_set.pending_active, pool_address);
    <b>if</b> (maybe_pending_active_index.is_some()) {
        ...
        // epoch.
        <b>let</b> validator_stake =
            <a href="staking_registry.md#0x1_staking_registry_get_validator_total_power">staking_registry::get_validator_total_power</a>(pool_address) <b>as</b> u128;
        ...
        <a href="staking_registry.md#0x1_staking_registry_set_validator_inactive">staking_registry::set_validator_inactive</a>(pool_address);
    } <b>else</b> {
        // Validate that the validator is already part of the validator set.
        <b>let</b> maybe_active_index =
            <a href="stake.md#0x1_stake_find_validator">find_validator</a>(&validator_set.active_validators, pool_address);
        <b>assert</b>!(maybe_active_index.is_some(), <a href="../../move-stdlib/doc/error.md#0x1_error_invalid_state">error::invalid_state</a>(<a href="stake.md#0x1_stake_ENOT_VALIDATOR">ENOT_VALIDATOR</a>));
        <b>let</b> validator_info =
            validator_set.active_validators.swap_remove(maybe_active_index.extract());
        <b>assert</b>!(
            validator_set.active_validators.length() &gt; 0,
            <a href="../../move-stdlib/doc/error.md#0x1_error_invalid_state">error::invalid_state</a>(<a href="stake.md#0x1_stake_ELAST_VALIDATOR">ELAST_VALIDATOR</a>)
        );
        validator_set.pending_inactive.push_back(validator_info);
        <a href="staking_registry.md#0x1_staking_registry_set_validator_pending_inactive">staking_registry::set_validator_pending_inactive</a>(pool_address);
...
<pre><code><b>public</b> <b>fun</b> <a href="stake.md#0x1_stake_is_current_epoch_validator">is_current_epoch_validator</a>(pool_address: <b>address</b>): bool <b>acquires</b> <a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a> {
    <a href="stake.md#0x1_stake_assert_stake_pool_exists">assert_stake_pool_exists</a>(pool_address);
    <b>let</b> validator_state = <a href="stake.md#0x1_stake_get_validator_state">get_validator_state</a>(pool_address);
    validator_state == <a href="stake.md#0x1_stake_VALIDATOR_STATUS_ACTIVE">VALIDATOR_STATUS_ACTIVE</a>
        || validator_state == <a href="stake.md#0x1_stake_VALIDATOR_STATUS_PENDING_INACTIVE">VALIDATOR_STATUS_PENDING_INACTIVE</a>
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="stake.md#0x1_stake_update_performance_statistics">update_performance_statistics</a>(
    proposer_index: Option&lt;u64&gt;, failed_proposer_indices: <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u64&gt;
    ...
    <b>let</b> validator_perf = <b>borrow_global_mut</b>&lt;<a href="stake.md#0x1_stake_ValidatorPerformance">ValidatorPerformance</a>&gt;(@topo_framework);
    ...
    <b>if</b> (proposer_index.is_some()) {
        ...
        // Here, and in all other <a href="../../move-stdlib/doc/vector.md#0x1_vector_borrow">vector::borrow</a>, skip <a href="../../topo-stdlib/doc/any.md#0x1_any">any</a> validator indices that are out of bounds,
    ...
    <b>while</b> ({
        <b>spec</b> {
            ...
            <b>invariant</b> (
                <a href="stake.md#0x1_stake_ghost_proposer_idx">ghost_proposer_idx</a>.is_some()
                    && <a href="stake.md#0x1_stake_ghost_proposer_idx">ghost_proposer_idx</a>.borrow() &lt; validator_len
            ) ==&gt;
                (
                    validator_perf.validators[<a href="stake.md#0x1_stake_ghost_proposer_idx">ghost_proposer_idx</a>.borrow()].successful_proposals ==
                    <a href="stake.md#0x1_stake_ghost_valid_perf">ghost_valid_perf</a>.validators[<a href="stake.md#0x1_stake_ghost_proposer_idx">ghost_proposer_idx</a>.borrow()].successful_proposals
                    + 1
                );
        };
        f &lt; f_len
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="stake.md#0x1_stake_on_new_epoch">on_new_epoch</a>() <b>acquires</b> <a href="stake.md#0x1_stake_PendingTransactionFee">PendingTransactionFee</a>, <a href="stake.md#0x1_stake_StakePool">StakePool</a>, <a href="stake.md#0x1_stake_TransactionFeeConfig">TransactionFeeConfig</a>, <a href="stake.md#0x1_stake_ValidatorConfig">ValidatorConfig</a>, <a href="stake.md#0x1_stake_ValidatorPerformance">ValidatorPerformance</a>, <a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a> {
    ...
    validator_set.active_validators.for_each_ref(|validator| {
        ...
        <b>let</b> validator_config = <b>borrow_global</b>&lt;<a href="stake.md#0x1_stake_ValidatorConfig">ValidatorConfig</a>&gt;(validator.addr);
        <b>let</b> current_perf =
            validator_perf.validators.borrow(validator_config.validator_index);
        <b>let</b> num_successful_proposals = current_perf.successful_proposals;
        <b>let</b> num_total_proposals =
            current_perf.successful_proposals + current_perf.failed_proposals;
        <b>let</b> fee_amount =
            <a href="stake.md#0x1_stake_collect_transaction_fee_for_validator">collect_transaction_fee_for_validator</a>(validator_config.validator_index);
        <b>if</b> (std::features::is_distribute_transaction_fee_enabled() && fee_amount &gt; 0) {
            <a href="staking_registry.md#0x1_staking_registry_distribute_transaction_fees">staking_registry::distribute_transaction_fees</a>(
                validator.addr,
                fee_amount,
            );
            <a href="event.md#0x1_event_emit">event::emit</a>(<a href="stake.md#0x1_stake_DistributeTransactionFee">DistributeTransactionFee</a> { pool_address: validator.addr, fee_amount });
        };
        <a href="staking_registry.md#0x1_staking_registry_distribute_epoch_rewards">staking_registry::distribute_epoch_rewards</a>(
            validator.addr,
    ...
    <a href="poc_power_store.md#0x1_poc_power_store_commit_next_period_if_boundary">poc_power_store::commit_next_period_if_boundary</a>();
    validator_set.active_validators.for_each_ref(|validator| {
        <b>let</b> validator: &<a href="stake.md#0x1_stake_ValidatorInfo">ValidatorInfo</a> = validator;
        <a href="staking_registry.md#0x1_staking_registry_force_undelegate_below_threshold">staking_registry::force_undelegate_below_threshold</a>(validator.addr);
    });
    validator_set.pending_inactive.for_each_ref(|validator| {
        <b>let</b> validator: &<a href="stake.md#0x1_stake_ValidatorInfo">ValidatorInfo</a> = validator;
        <a href="staking_registry.md#0x1_staking_registry_force_undelegate_below_threshold">staking_registry::force_undelegate_below_threshold</a>(validator.addr);
    ...
    validator_set.pending_active.for_each_ref(|validator| {
        <b>let</b> validator: &<a href="stake.md#0x1_stake_ValidatorInfo">ValidatorInfo</a> = validator;
        <a href="staking_registry.md#0x1_staking_registry_set_validator_active">staking_registry::set_validator_active</a>(validator.addr);
    });
    validator_set.pending_inactive.for_each_ref(|validator| {
        <b>let</b> validator: &<a href="stake.md#0x1_stake_ValidatorInfo">ValidatorInfo</a> = validator;
        <a href="staking_registry.md#0x1_staking_registry_set_validator_inactive">staking_registry::set_validator_inactive</a>(validator.addr);
    });

    <b>let</b> previous_active_count = validator_set.active_validators.length();
    ...
    <b>let</b> voting_power_increase_limit =
        <a href="staking_config.md#0x1_staking_config_get_voting_power_increase_limit">staking_config::get_voting_power_increase_limit</a>(&config);
    <b>let</b> max_voting_power_increase =
        <a href="stake.md#0x1_stake_calculate_max_voting_power_increase">calculate_max_voting_power_increase</a>(
            validator_set.total_voting_power,
            voting_power_increase_limit,
        );
    <b>let</b> used_voting_power_increase = 0u128;
    <b>let</b> vlen = validator_set.active_validators.length();
    <b>let</b> total_voting_power = 0;
    <b>let</b> dropped_validators = <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>[];
    <b>let</b> i = 0;
    <b>while</b> ({
        <b>spec</b> {
        ...
        <b>let</b> validator_config = <b>borrow_global</b>&lt;<a href="stake.md#0x1_stake_ValidatorConfig">ValidatorConfig</a>&gt;(pool_address);
        <b>let</b> raw_validator_info =
            <a href="stake.md#0x1_stake_generate_validator_info">generate_validator_info</a>(pool_address, *validator_config);
        <b>let</b> baseline_voting_power =
            <b>if</b> (i &lt; previous_active_count) {
                old_validator_info.voting_power
            } <b>else</b> {
                0
            };
        <b>let</b> new_validator_info =
            <a href="stake.md#0x1_stake_cap_validator_info_voting_power_for_epoch">cap_validator_info_voting_power_for_epoch</a>(
                raw_validator_info,
                maximum_stake,
        ...
        <b>if</b> (new_validator_info.voting_power &gt;= minimum_stake) {
            used_voting_power_increase += <a href="stake.md#0x1_stake_voting_power_increase">voting_power_increase</a>(
                baseline_voting_power,
    ...
    // In the extreme case <b>where</b> the next epoch validator election produces an empty set
    // (i.e. no staker satisfies the minimum <a href="stake.md#0x1_stake">stake</a> or participation requirements), retain a
    // last-known positive-<a href="voting.md#0x1_voting">voting</a>-power active set instead of publishing an empty or zero-power
    // validator set. A <a href="stake.md#0x1_stake_ValidatorSetLivenessFallback">ValidatorSetLivenessFallback</a> <a href="event.md#0x1_event">event</a> signals this critical governance and
    // economic security failure.
    <b>if</b> (!next_epoch_validators.is_empty()) {
        dropped_validators.for_each_ref(|addr| {
            <a href="staking_registry.md#0x1_staking_registry_set_validator_inactive">staking_registry::set_validator_inactive</a>(*addr);
        });
        validator_set.active_validators = next_epoch_validators;
        validator_set.total_voting_power = total_voting_power;
    } <b>else</b> {
        <b>let</b> refreshed_validators = <a href="../../move-stdlib/doc/vector.md#0x1_vector_empty">vector::empty</a>();
        ...
        <b>while</b> (fallback_i &lt; fallback_vlen) {
            ...
            <b>let</b> raw_validator_info =
                <a href="stake.md#0x1_stake_generate_validator_info">generate_validator_info</a>(pool_address, *validator_config);
            <b>let</b> baseline_voting_power =
                <b>if</b> (fallback_i &lt; previous_active_count) {
                    old_validator_info.voting_power
                } <b>else</b> {
                    0
                };
            ...
            <b>if</b> (new_validator_info.voting_power &gt; 0) {
                used_voting_power_increase += <a href="stake.md#0x1_stake_voting_power_increase">voting_power_increase</a>(
                    baseline_voting_power,
                    new_validator_info.voting_power,
                );
        ...
        <b>if</b> (emergency_total_voting_power &gt; 0) {
            <a href="stake.md#0x1_stake_sync_registry_statuses_to_active_set">sync_registry_statuses_to_active_set</a>(
            ...
            <b>let</b> (snapshot_validators, snapshot_total_voting_power) =
                <a href="stake.md#0x1_stake_previous_positive_active_validator_snapshot">previous_positive_active_validator_snapshot</a>(
                    &validator_set.active_validators,
    ...
    validator_set.total_joining_power = 0;
    <b>let</b> total_staked_power =
        <b>if</b> (validator_set.total_voting_power &gt; <a href="stake.md#0x1_stake_MAX_U64">MAX_U64</a>) {
            <a href="stake.md#0x1_stake_MAX_U64">MAX_U64</a> <b>as</b> u64
        } <b>else</b> {
            validator_set.total_voting_power <b>as</b> u64
        };
    <a href="staking_registry.md#0x1_staking_registry_set_total_staked_power">staking_registry::set_total_staked_power</a>(total_staked_power);
    ...
    <b>let</b> recurring_lockup_duration_secs =
        <a href="staking_config.md#0x1_staking_config_get_recurring_lockup_duration">staking_config::get_recurring_lockup_duration</a>(&config);
    <b>let</b> vlen = validator_set.active_validators.length();
    ...
    <b>while</b> ({
        <b>spec</b> {
            ...
            <b>invariant</b> <b>forall</b> i in 0..validator_index:
                <b>global</b>&lt;<a href="stake.md#0x1_stake_ValidatorConfig">ValidatorConfig</a>&gt;(validator_set.active_validators[i].addr).validator_index
                    &lt; validator_index;
            <b>invariant</b> <b>forall</b> i in 0..validator_index:
        ...
        <b>let</b> validator_config =
            <b>borrow_global_mut</b>&lt;<a href="stake.md#0x1_stake_ValidatorConfig">ValidatorConfig</a>&gt;(validator_info.addr);
        validator_config.validator_index = validator_index;

        validator_perf.validators.push_back(
            <a href="stake.md#0x1_stake_IndividualValidatorPerformance">IndividualValidatorPerformance</a> {
        ...
        <b>let</b> reconfig_start_secs =
            <b>if</b> (<a href="chain_status.md#0x1_chain_status_is_operating">chain_status::is_operating</a>()) {
    ...
    <b>if</b> (<b>exists</b>&lt;<a href="stake.md#0x1_stake_PendingTransactionFee">PendingTransactionFee</a>&gt;(@topo_framework)) {
        <b>let</b> pending_fee_by_validator =
            &<b>mut</b> <b>borrow_global_mut</b>&lt;<a href="stake.md#0x1_stake_PendingTransactionFee">PendingTransactionFee</a>&gt;(@topo_framework).pending_fee_by_validator;
        <b>assert</b>!(
            pending_fee_by_validator.is_empty(),
            <a href="../../move-stdlib/doc/error.md#0x1_error_internal">error::internal</a>(<a href="stake.md#0x1_stake_ETRANSACTION_FEE_NOT_FULLY_DISTRIBUTED">ETRANSACTION_FEE_NOT_FULLY_DISTRIBUTED</a>)
        );
        validator_set.active_validators.for_each_ref(|v| pending_fee_by_validator.add(
            v.config.validator_index, <a href="aggregator_v2.md#0x1_aggregator_v2_create_unbounded_aggregator">aggregator_v2::create_unbounded_aggregator</a>&lt;u64&gt;()
        ));
    };
...
<a id="0x1_stake_get_current_epoch_governance_voting_power"></a>

## Function `get_current_epoch_governance_voting_power`



<pre><code><b>public</b> <b>fun</b> <a href="stake.md#0x1_stake_get_current_epoch_governance_voting_power">get_current_epoch_governance_voting_power</a>(): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="stake.md#0x1_stake_get_current_epoch_governance_voting_power">get_current_epoch_governance_voting_power</a>(): u64 <b>acquires</b> <a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a> {
    <b>if</b> (!<b>exists</b>&lt;<a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a>&gt;(@topo_framework)) {
        <b>return</b> 0
    };

    <b>let</b> cur_validator_set = <b>borrow_global</b>&lt;<a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a>&gt;(@topo_framework);
    ...
    cur_validator_set.active_validators.for_each_ref(|validator| {
        <b>let</b> validator: &<a href="stake.md#0x1_stake_ValidatorInfo">ValidatorInfo</a> = validator;
        total_power += (
            <a href="stake.md#0x1_stake_min_u64">min_u64</a>(<a href="staking_registry.md#0x1_staking_registry_get_validator_total_power">staking_registry::get_validator_total_power</a>(validator.addr), maximum_stake)
                <b>as</b> u128
        );
    });
    ...
    <b>if</b> (total_power &gt; <a href="stake.md#0x1_stake_MAX_U64">MAX_U64</a>) {
        <a href="stake.md#0x1_stake_MAX_U64">MAX_U64</a> <b>as</b> u64
    } <b>else</b> {
...
<pre><code><b>public</b> <b>fun</b> <a href="stake.md#0x1_stake_next_validator_consensus_infos">next_validator_consensus_infos</a>(): <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;ValidatorConsensusInfo&gt; <b>acquires</b> <a href="stake.md#0x1_stake_PendingTransactionFee">PendingTransactionFee</a>, <a href="stake.md#0x1_stake_TransactionFeeConfig">TransactionFeeConfig</a>, <a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a>, <a href="stake.md#0x1_stake_ValidatorPerformance">ValidatorPerformance</a>, <a href="stake.md#0x1_stake_ValidatorConfig">ValidatorConfig</a> {
    <b>let</b> simulated_validator_set = <a href="stake.md#0x1_stake_simulate_next_epoch_validator_set">simulate_next_epoch_validator_set</a>();
    <a href="stake.md#0x1_stake_validator_consensus_infos_from_validator_set">validator_consensus_infos_from_validator_set</a>(&simulated_validator_set)
}
</code></pre>
...
<a id="0x1_stake_simulate_next_epoch_validator_set"></a>

## Function `simulate_next_epoch_validator_set`



<pre><code><b>fun</b> <a href="stake.md#0x1_stake_simulate_next_epoch_validator_set">simulate_next_epoch_validator_set</a>(): <a href="stake.md#0x1_stake_ValidatorSet">stake::ValidatorSet</a>
</code></pre>
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_simulate_next_epoch_validator_set">simulate_next_epoch_validator_set</a>(): <a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a> <b>acquires</b> <a href="stake.md#0x1_stake_PendingTransactionFee">PendingTransactionFee</a>, <a href="stake.md#0x1_stake_TransactionFeeConfig">TransactionFeeConfig</a>, <a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a>, <a href="stake.md#0x1_stake_ValidatorPerformance">ValidatorPerformance</a>, <a href="stake.md#0x1_stake_ValidatorConfig">ValidatorConfig</a> {
    <b>let</b> cur_validator_set = <b>borrow_global</b>&lt;<a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a>&gt;(@topo_framework);
    <b>let</b> config = <a href="staking_config.md#0x1_staking_config_get">staking_config::get</a>();
    <b>let</b> validator_perf = <b>borrow_global</b>&lt;<a href="stake.md#0x1_stake_ValidatorPerformance">ValidatorPerformance</a>&gt;(@topo_framework);
    <b>let</b> simulated_deposit_deltas = <a href="../../topo-stdlib/doc/simple_map.md#0x1_simple_map_create">simple_map::create</a>&lt;<b>address</b>, u64&gt;();
    <b>let</b> (minimum_stake, maximum_stake) = <a href="staking_config.md#0x1_staking_config_get_required_stake">staking_config::get_required_stake</a>(&config);
    <b>let</b> voting_power_increase_limit =
        <a href="staking_config.md#0x1_staking_config_get_voting_power_increase_limit">staking_config::get_voting_power_increase_limit</a>(&config);
    <b>let</b> max_voting_power_increase =
    ...
    cur_validator_set.active_validators.for_each_ref(|validator| {
        <b>let</b> validator: &<a href="stake.md#0x1_stake_ValidatorInfo">ValidatorInfo</a> = validator;
        <a href="stake.md#0x1_stake_simulate_epoch_accruals_for_validator">simulate_epoch_accruals_for_validator</a>(
            validator.addr,
            validator_perf,
            rewards_rate,
            rewards_rate_denominator,
            &<b>mut</b> simulated_deposit_deltas,
        );
    });
    cur_validator_set.pending_inactive.for_each_ref(|validator| {
        <b>let</b> validator: &<a href="stake.md#0x1_stake_ValidatorInfo">ValidatorInfo</a> = validator;
    ...
    <b>while</b> ({
        ...
        <b>let</b> candidate_in_current = candidate_idx &lt; num_cur_actives;
        // Order matches on_new_epoch's <a href="stake.md#0x1_stake_append">append</a>(): active then pending_active (append uses pop_back → reverse).
        <b>let</b> candidate =
            <b>if</b> (candidate_in_current) {
        ...
        <b>let</b> (new_voting_power, new_validator_info) = <a href="stake.md#0x1_stake_compute_simulated_validator_info">compute_simulated_validator_info</a>(
            candidate,
            num_new_actives,
    ...
    // <a href="stake.md#0x1_stake_append">append</a>() uses pop_back so pending_active ends up in reverse order; match that here.
    <b>if</b> (new_active_validators.is_empty()
        && (num_cur_actives &gt; 0 || num_cur_pending_actives &gt; 0)) {
        <b>let</b> num_fallback = num_cur_actives + num_cur_pending_actives;
        for (fallback_idx in 0..num_fallback) {
            <b>let</b> in_active = fallback_idx &lt; num_cur_actives;
            <b>let</b> candidate =
                <b>if</b> (in_active) {
            ...
            <b>let</b> (new_voting_power, new_validator_info) = <a href="stake.md#0x1_stake_compute_simulated_validator_info">compute_simulated_validator_info</a>(
                ...
                &simulated_deposit_deltas,
                maximum_stake,
                <b>if</b> (in_active) { candidate.voting_power } <b>else</b> { 0 },
                max_voting_power_increase,
                used_voting_power_increase,
            );
            used_voting_power_increase += <a href="stake.md#0x1_stake_voting_power_increase">voting_power_increase</a>(
            ...
            <b>if</b> (new_voting_power &gt; 0) {
                new_active_validators.push_back(new_validator_info);
                new_total_power += (new_voting_power <b>as</b> u128);
            };
        };
        <b>if</b> (new_total_power == 0) {
            <b>let</b> (snapshot_validators, snapshot_total_voting_power) =
                <a href="stake.md#0x1_stake_previous_positive_active_validator_snapshot">previous_positive_active_validator_snapshot</a>(
...
<a id="0x1_stake_compute_simulated_validator_info"></a>

## Function `compute_simulated_validator_info`



<pre><code><b>fun</b> <a href="stake.md#0x1_stake_compute_simulated_validator_info">compute_simulated_validator_info</a>(candidate: &<a href="stake.md#0x1_stake_ValidatorInfo">stake::ValidatorInfo</a>, validator_index: u64, simulated_deposit_deltas: &<a href="../../topo-stdlib/doc/simple_map.md#0x1_simple_map_SimpleMap">simple_map::SimpleMap</a>&lt;<b>address</b>, u64&gt;, maximum_stake: u64, baseline_voting_power: u64, max_voting_power_increase: u128, used_voting_power_increase: u128): (u64, <a href="stake.md#0x1_stake_ValidatorInfo">stake::ValidatorInfo</a>)
</code></pre>
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_compute_simulated_validator_info">compute_simulated_validator_info</a>(
    candidate: &<a href="stake.md#0x1_stake_ValidatorInfo">ValidatorInfo</a>,
    validator_index: u64,
    simulated_deposit_deltas: &SimpleMap&lt;<b>address</b>, u64&gt;,
    maximum_stake: u64,
    baseline_voting_power: u64,
    max_voting_power_increase: u128,
    used_voting_power_increase: u128,
): (u64, <a href="stake.md#0x1_stake_ValidatorInfo">ValidatorInfo</a>) <b>acquires</b> <a href="stake.md#0x1_stake_ValidatorConfig">ValidatorConfig</a> {
    <b>let</b> raw_voting_power = <a href="stake.md#0x1_stake_get_validator_total_power_with_extra_deposit_for_next_epoch">get_validator_total_power_with_extra_deposit_for_next_epoch</a>(
        candidate.addr,
        simulated_deposit_deltas,
    );
    <b>let</b> new_voting_power = <a href="stake.md#0x1_stake_cap_voting_power_for_epoch">cap_voting_power_for_epoch</a>(
        raw_voting_power,
        maximum_stake,
        baseline_voting_power,
        max_voting_power_increase,
    ...
    (
        new_voting_power,
        <a href="stake.md#0x1_stake_ValidatorInfo">ValidatorInfo</a> { addr: candidate.addr, voting_power: new_voting_power, config }
    )
}
</code></pre>
...
<a id="0x1_stake_previous_positive_active_validator_snapshot"></a>

## Function `previous_positive_active_validator_snapshot`



<pre><code><b>fun</b> <a href="stake.md#0x1_stake_previous_positive_active_validator_snapshot">previous_positive_active_validator_snapshot</a>(candidates: &<a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<a href="stake.md#0x1_stake_ValidatorInfo">stake::ValidatorInfo</a>&gt;, previous_active_count: u64): (<a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<a href="stake.md#0x1_stake_ValidatorInfo">stake::ValidatorInfo</a>&gt;, u128)
</code></pre>
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_previous_positive_active_validator_snapshot">previous_positive_active_validator_snapshot</a>(
    candidates: &<a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<a href="stake.md#0x1_stake_ValidatorInfo">ValidatorInfo</a>&gt;,
    previous_active_count: u64,
): (<a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<a href="stake.md#0x1_stake_ValidatorInfo">ValidatorInfo</a>&gt;, u128) <b>acquires</b> <a href="stake.md#0x1_stake_ValidatorConfig">ValidatorConfig</a> {
    <b>let</b> snapshot_validators = <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>[];
    <b>let</b> snapshot_total_voting_power = 0u128;
    <b>let</b> len = candidates.length();
    <b>let</b> i = 0;
    <b>while</b> ({
        <b>spec</b> {
            <b>invariant</b> i &lt;= len;
            <b>invariant</b> <a href="stake.md#0x1_stake_spec_validators_are_initialized">spec_validators_are_initialized</a>(snapshot_validators);
        };
        i &lt; len
    }) {
        <b>if</b> (i &lt; previous_active_count) {
            <b>let</b> candidate = candidates.borrow(i);
            <b>if</b> (candidate.voting_power &gt; 0) {
                <b>let</b> config = *<b>borrow_global</b>&lt;<a href="stake.md#0x1_stake_ValidatorConfig">ValidatorConfig</a>&gt;(candidate.addr);
                config.validator_index = snapshot_validators.length();
                snapshot_validators.push_back(<a href="stake.md#0x1_stake_ValidatorInfo">ValidatorInfo</a> {
                    addr: candidate.addr,
                    voting_power: candidate.voting_power,
                    config,
                });
                snapshot_total_voting_power += (candidate.voting_power <b>as</b> u128);
            };
        };
        i += 1;
    };
...
<a id="0x1_stake_sync_registry_statuses_to_active_set"></a>

## Function `sync_registry_statuses_to_active_set`



<pre><code><b>fun</b> <a href="stake.md#0x1_stake_sync_registry_statuses_to_active_set">sync_registry_statuses_to_active_set</a>(candidates: &<a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<a href="stake.md#0x1_stake_ValidatorInfo">stake::ValidatorInfo</a>&gt;, active_set: &<a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<a href="stake.md#0x1_stake_ValidatorInfo">stake::ValidatorInfo</a>&gt;)
</code></pre>
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_sync_registry_statuses_to_active_set">sync_registry_statuses_to_active_set</a>(
    candidates: &<a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<a href="stake.md#0x1_stake_ValidatorInfo">ValidatorInfo</a>&gt;,
    active_set: &<a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<a href="stake.md#0x1_stake_ValidatorInfo">ValidatorInfo</a>&gt;,
) {
    <b>let</b> len = candidates.length();
    <b>let</b> i = 0;
    <b>while</b> (i &lt; len) {
        <b>let</b> candidate = candidates.borrow(i);
        <b>if</b> (<a href="stake.md#0x1_stake_find_validator">find_validator</a>(active_set, candidate.addr).is_some()) {
            <a href="staking_registry.md#0x1_staking_registry_set_validator_active">staking_registry::set_validator_active</a>(candidate.addr);
        } <b>else</b> {
            <a href="staking_registry.md#0x1_staking_registry_set_validator_inactive">staking_registry::set_validator_inactive</a>(candidate.addr);
        };
        i += 1;
    }
}
...
<a id="0x1_stake_simulate_epoch_accruals_for_validator"></a>

## Function `simulate_epoch_accruals_for_validator`



<pre><code><b>fun</b> <a href="stake.md#0x1_stake_simulate_epoch_accruals_for_validator">simulate_epoch_accruals_for_validator</a>(validator_address: <b>address</b>, validator_perf: &<a href="stake.md#0x1_stake_ValidatorPerformance">stake::ValidatorPerformance</a>, rewards_rate: u64, rewards_rate_denominator: u64, simulated_deposit_deltas: &<b>mut</b> <a href="../../topo-stdlib/doc/simple_map.md#0x1_simple_map_SimpleMap">simple_map::SimpleMap</a>&lt;<b>address</b>, u64&gt;)
</code></pre>
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_simulate_epoch_accruals_for_validator">simulate_epoch_accruals_for_validator</a>(
    validator_address: <b>address</b>,
    validator_perf: &<a href="stake.md#0x1_stake_ValidatorPerformance">ValidatorPerformance</a>,
    rewards_rate: u64,
    rewards_rate_denominator: u64,
    simulated_deposit_deltas: &<b>mut</b> SimpleMap&lt;<b>address</b>, u64&gt;,
) <b>acquires</b> <a href="stake.md#0x1_stake_PendingTransactionFee">PendingTransactionFee</a>, <a href="stake.md#0x1_stake_TransactionFeeConfig">TransactionFeeConfig</a>, <a href="stake.md#0x1_stake_ValidatorConfig">ValidatorConfig</a> {
    <b>let</b> validator_config = <b>borrow_global</b>&lt;<a href="stake.md#0x1_stake_ValidatorConfig">ValidatorConfig</a>&gt;(validator_address);
    <b>let</b> current_perf =
        validator_perf.validators.borrow(validator_config.validator_index);
    <b>let</b> num_successful_proposals = current_perf.successful_proposals;
    <b>let</b> num_total_proposals =
        current_perf.successful_proposals + current_perf.failed_proposals;
    <b>let</b> fee_amount =
        <a href="stake.md#0x1_stake_get_pending_transaction_fee_for_validator">get_pending_transaction_fee_for_validator</a>(validator_config.validator_index);
    <b>if</b> (fee_amount &gt; 0) {
        <a href="stake.md#0x1_stake_simulate_fee_distribution_for_validator">simulate_fee_distribution_for_validator</a>(
            validator_address,
            fee_amount,
            simulated_deposit_deltas,
        );
    };
    <a href="stake.md#0x1_stake_simulate_reward_distribution_for_validator">simulate_reward_distribution_for_validator</a>(
        validator_address,
        num_successful_proposals,
        num_total_proposals,
        rewards_rate,
...
<a id="0x1_stake_simulate_reward_distribution_for_validator"></a>

## Function `simulate_reward_distribution_for_validator`



<pre><code><b>fun</b> <a href="stake.md#0x1_stake_simulate_reward_distribution_for_validator">simulate_reward_distribution_for_validator</a>(validator_address: <b>address</b>, num_successful_proposals: u64, num_total_proposals: u64, rewards_rate: u64, rewards_rate_denominator: u64, simulated_deposit_deltas: &<b>mut</b> <a href="../../topo-stdlib/doc/simple_map.md#0x1_simple_map_SimpleMap">simple_map::SimpleMap</a>&lt;<b>address</b>, u64&gt;)
</code></pre>
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_simulate_reward_distribution_for_validator">simulate_reward_distribution_for_validator</a>(
    validator_address: <b>address</b>,
    ...
    <b>let</b> current_pool_power = <a href="staking_registry.md#0x1_staking_registry_get_validator_total_power">staking_registry::get_validator_total_power</a>(validator_address);
    <b>if</b> (current_pool_power == 0) {
        <b>return</b>
    };

    <b>let</b> (_, maximum_stake) = <a href="staking_config.md#0x1_staking_config_get_required_stake">staking_config::get_required_stake</a>(&<a href="staking_config.md#0x1_staking_config_get">staking_config::get</a>());
    <b>let</b> epoch_reward = <a href="stake.md#0x1_stake_calculate_rewards_amount">calculate_rewards_amount</a>(
        <a href="stake.md#0x1_stake_min_u64">min_u64</a>(current_pool_power, maximum_stake),
        num_successful_proposals,
        num_total_proposals,
        rewards_rate,
        rewards_rate_denominator,
    ...
    <a href="stake.md#0x1_stake_simulate_registry_distribution_for_validator">simulate_registry_distribution_for_validator</a>(
        validator_address,
        epoch_reward,
        <b>false</b>,
        simulated_deposit_deltas,
...
<a id="0x1_stake_simulate_fee_distribution_for_validator"></a>

## Function `simulate_fee_distribution_for_validator`



<pre><code><b>fun</b> <a href="stake.md#0x1_stake_simulate_fee_distribution_for_validator">simulate_fee_distribution_for_validator</a>(validator_address: <b>address</b>, fee_amount_octa: u64, simulated_deposit_deltas: &<b>mut</b> <a href="../../topo-stdlib/doc/simple_map.md#0x1_simple_map_SimpleMap">simple_map::SimpleMap</a>&lt;<b>address</b>, u64&gt;)
</code></pre>
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_simulate_fee_distribution_for_validator">simulate_fee_distribution_for_validator</a>(
    validator_address: <b>address</b>,
    fee_amount_octa: u64,
    simulated_deposit_deltas: &<b>mut</b> SimpleMap&lt;<b>address</b>, u64&gt;,
) {
    <b>if</b> (fee_amount_octa == 0) {
        <b>return</b>
    };
    <a href="stake.md#0x1_stake_simulate_registry_distribution_for_validator">simulate_registry_distribution_for_validator</a>(
        validator_address,
...
<a id="0x1_stake_simulate_registry_distribution_for_validator"></a>

## Function `simulate_registry_distribution_for_validator`



<pre><code><b>fun</b> <a href="stake.md#0x1_stake_simulate_registry_distribution_for_validator">simulate_registry_distribution_for_validator</a>(validator_address: <b>address</b>, total_amount_octa: u64, use_next_epoch_power: bool, simulated_deposit_deltas: &<b>mut</b> <a href="../../topo-stdlib/doc/simple_map.md#0x1_simple_map_SimpleMap">simple_map::SimpleMap</a>&lt;<b>address</b>, u64&gt;)
</code></pre>
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_simulate_registry_distribution_for_validator">simulate_registry_distribution_for_validator</a>(
    validator_address: <b>address</b>,
    total_amount_octa: u64,
    use_next_epoch_power: bool,
    simulated_deposit_deltas: &<b>mut</b> SimpleMap&lt;<b>address</b>, u64&gt;,
) {
    <b>if</b> (total_amount_octa == 0) {
        <b>return</b>
    };

    <b>let</b> owner_address = <a href="staking_registry.md#0x1_staking_registry_get_validator_owner">staking_registry::get_validator_owner</a>(validator_address);
    <b>let</b> commission_bps = <a href="staking_registry.md#0x1_staking_registry_get_validator_commission_bps">staking_registry::get_validator_commission_bps</a>(validator_address);
    <b>let</b> (member_addresses, member_effective_powers, pool_power) =
        <b>if</b> (use_next_epoch_power) {
            <a href="staking_registry.md#0x1_staking_registry_get_validator_member_powers_for_next_epoch">staking_registry::get_validator_member_powers_for_next_epoch</a>(
                validator_address,
                simulated_deposit_deltas,
            )
        } <b>else</b> {
            <a href="staking_registry.md#0x1_staking_registry_get_validator_member_powers_with_current_power">staking_registry::get_validator_member_powers_with_current_power</a>(
                validator_address,
                simulated_deposit_deltas,
            )
        };
    ...
    <b>let</b> commission = (((total_amount_octa <b>as</b> u128) * (commission_bps <b>as</b> u128)) / 10000) <b>as</b> u64;
    <b>let</b> distributable = total_amount_octa - commission;
    <b>let</b> distributed = 0u64;
    <b>let</b> len = member_addresses.length();
    <b>let</b> i = 0;
    <b>while</b> (i &lt; len) {
        <b>let</b> member = *member_addresses.borrow(i);
        <b>let</b> member_power = *member_effective_powers.borrow(i);
        <b>if</b> (member_power &gt; 0) {
            <b>let</b> reward =
                (((distributable <b>as</b> u128) * (member_power <b>as</b> u128)) / (pool_power <b>as</b> u128))
                    <b>as</b> u64;
            <b>if</b> (reward &gt; 0) {
                <a href="stake.md#0x1_stake_add_simulated_deposit_delta">add_simulated_deposit_delta</a>(simulated_deposit_deltas, member, reward);
            };
            distributed += reward;
        };
        i += 1;
    ...
    <b>let</b> owner_reward = commission + (distributable - distributed);
    <b>if</b> (owner_reward &gt; 0) {
        <a href="stake.md#0x1_stake_add_simulated_deposit_delta">add_simulated_deposit_delta</a>(simulated_deposit_deltas, owner_address, owner_reward);
    };
}
</code></pre>
...
<a id="0x1_stake_get_validator_total_power_with_extra_deposit_for_next_epoch"></a>

## Function `get_validator_total_power_with_extra_deposit_for_next_epoch`



<pre><code><b>fun</b> <a href="stake.md#0x1_stake_get_validator_total_power_with_extra_deposit_for_next_epoch">get_validator_total_power_with_extra_deposit_for_next_epoch</a>(validator_address: <b>address</b>, simulated_deposit_deltas: &<a href="../../topo-stdlib/doc/simple_map.md#0x1_simple_map_SimpleMap">simple_map::SimpleMap</a>&lt;<b>address</b>, u64&gt;): u64
</code></pre>
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_get_validator_total_power_with_extra_deposit_for_next_epoch">get_validator_total_power_with_extra_deposit_for_next_epoch</a>(
    validator_address: <b>address</b>,
    simulated_deposit_deltas: &SimpleMap&lt;<b>address</b>, u64&gt;,
): u64 {
    <b>let</b> (_, _, total_power) = <a href="staking_registry.md#0x1_staking_registry_get_validator_member_powers_for_next_epoch">staking_registry::get_validator_member_powers_for_next_epoch</a>(
        validator_address,
        simulated_deposit_deltas,
    );
    total_power
...
<a id="0x1_stake_add_simulated_deposit_delta"></a>

## Function `add_simulated_deposit_delta`



<pre><code><b>fun</b> <a href="stake.md#0x1_stake_add_simulated_deposit_delta">add_simulated_deposit_delta</a>(simulated_deposit_deltas: &<b>mut</b> <a href="../../topo-stdlib/doc/simple_map.md#0x1_simple_map_SimpleMap">simple_map::SimpleMap</a>&lt;<b>address</b>, u64&gt;, user: <b>address</b>, amount: u64)
</code></pre>
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_add_simulated_deposit_delta">add_simulated_deposit_delta</a>(
    simulated_deposit_deltas: &<b>mut</b> SimpleMap&lt;<b>address</b>, u64&gt;,
    user: <b>address</b>,
    amount: u64,
) {
    ...
    <b>if</b> (simulated_deposit_deltas.contains_key(&user)) {
        <b>let</b> current = simulated_deposit_deltas.borrow_mut(&user);
...
<a id="0x1_stake_get_pending_transaction_fee_for_validator"></a>

## Function `get_pending_transaction_fee_for_validator`



<pre><code><b>fun</b> <a href="stake.md#0x1_stake_get_pending_transaction_fee_for_validator">get_pending_transaction_fee_for_validator</a>(validator_index: u64): u64
</code></pre>
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_get_pending_transaction_fee_for_validator">get_pending_transaction_fee_for_validator</a>(
    validator_index: u64
): u64 <b>acquires</b> <a href="stake.md#0x1_stake_PendingTransactionFee">PendingTransactionFee</a>, <a href="stake.md#0x1_stake_TransactionFeeConfig">TransactionFeeConfig</a> {
    <b>if</b> (!<b>exists</b>&lt;<a href="stake.md#0x1_stake_PendingTransactionFee">PendingTransactionFee</a>&gt;(@topo_framework)) {
        <b>return</b> 0
    };
    ...
    <b>let</b> fee_limit =
        <b>if</b> (<b>exists</b>&lt;<a href="stake.md#0x1_stake_TransactionFeeConfig">TransactionFeeConfig</a>&gt;(@topo_framework)) {
            <b>let</b> TransactionFeeConfig::V0 { max_fee_octa_allowed_per_epoch_per_pool } =
                <b>borrow_global</b>&lt;<a href="stake.md#0x1_stake_TransactionFeeConfig">TransactionFeeConfig</a>&gt;(@topo_framework);
    ...
    <b>let</b> fee_octa = pending_fee_by_validator.borrow(&validator_index).read();
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_validator_consensus_infos_from_validator_set">validator_consensus_infos_from_validator_set</a>(
    validator_set: &<a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a>
): <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;ValidatorConsensusInfo&gt; {
    ...
    <b>while</b> ({
        <b>spec</b> {
            ...
            <b>invariant</b> len(validator_consensus_infos)
                &lt;= len(validator_set.active_validators)
                    + len(validator_set.pending_inactive);
        };
        idx &lt; total
    ...
    <b>spec</b> {
        <b>assert</b> len(validator_consensus_infos)
            == len(validator_set.active_validators)
                + len(validator_set.pending_inactive);
        <b>assert</b> <a href="stake.md#0x1_stake_spec_validator_indices_are_valid_config">spec_validator_indices_are_valid_config</a>(
            validator_set.active_validators,
            len(validator_set.active_validators)
                + len(validator_set.pending_inactive)
        );
    ...
    validator_set.active_validators.for_each_ref(
        |obj| {
            ...
            <b>spec</b> {
                <b>assume</b> len(validator_consensus_infos)
                    == len(validator_set.active_validators)
                        + len(validator_set.pending_inactive);
                <b>assert</b> vi.config.validator_index &lt; len(validator_consensus_infos);
            };
            <b>let</b> vci = validator_consensus_infos.borrow_mut(vi.config.validator_index);
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_update_stake_pool">update_stake_pool</a>(
    ...
    <b>let</b> _unused_validator_perf = validator_perf;
    <b>let</b> _unused_staking_config = <a href="staking_config.md#0x1_staking_config">staking_config</a>;
    <b>let</b> stake_pool = <b>borrow_global_mut</b>&lt;<a href="stake.md#0x1_stake_StakePool">StakePool</a>&gt;(pool_address);
    // Pending active <a href="stake.md#0x1_stake">stake</a> can now be active.
    <a href="coin.md#0x1_coin_merge">coin::merge</a>(
        &<b>mut</b> stake_pool.active, <a href="coin.md#0x1_coin_extract_all">coin::extract_all</a>(&<b>mut</b> stake_pool.pending_active)
    );
...
<a id="0x1_stake_collect_transaction_fee_for_validator"></a>

## Function `collect_transaction_fee_for_validator`



<pre><code><b>fun</b> <a href="stake.md#0x1_stake_collect_transaction_fee_for_validator">collect_transaction_fee_for_validator</a>(validator_index: u64): u64
</code></pre>
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_collect_transaction_fee_for_validator">collect_transaction_fee_for_validator</a>(
    validator_index: u64
): u64 <b>acquires</b> <a href="stake.md#0x1_stake_PendingTransactionFee">PendingTransactionFee</a>, <a href="stake.md#0x1_stake_TransactionFeeConfig">TransactionFeeConfig</a> {
    <b>if</b> (!<b>exists</b>&lt;<a href="stake.md#0x1_stake_PendingTransactionFee">PendingTransactionFee</a>&gt;(@topo_framework)) {
        <b>return</b> 0
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_calculate_rewards_amount">calculate_rewards_amount</a>(
    ...
    <b>let</b> rewards_numerator =
        (stake_amount <b>as</b> u128) * (rewards_rate <b>as</b> u128)
            * (num_successful_proposals <b>as</b> u128);
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_get_validator_addresses">get_validator_addresses</a>(validators: &<a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<a href="stake.md#0x1_stake_ValidatorInfo">stake::ValidatorInfo</a>&gt;, offset: u64, limit: u64): <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<b>address</b>&gt;
</code></pre>
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_get_validator_addresses">get_validator_addresses</a>(
    validators: &<a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<a href="stake.md#0x1_stake_ValidatorInfo">ValidatorInfo</a>&gt;,
    offset: u64,
    limit: u64
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_generate_validator_info">generate_validator_info</a>(addr: <b>address</b>, config: <a href="stake.md#0x1_stake_ValidatorConfig">stake::ValidatorConfig</a>): <a href="stake.md#0x1_stake_ValidatorInfo">stake::ValidatorInfo</a>
</code></pre>
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_generate_validator_info">generate_validator_info</a>(
    addr: <b>address</b>, config: <a href="stake.md#0x1_stake_ValidatorConfig">ValidatorConfig</a>
): <a href="stake.md#0x1_stake_ValidatorInfo">ValidatorInfo</a> {
    <b>let</b> voting_power = <a href="staking_registry.md#0x1_staking_registry_get_validator_total_power">staking_registry::get_validator_total_power</a>(addr);
...
<a id="0x1_stake_cap_validator_info_voting_power_for_epoch"></a>

## Function `cap_validator_info_voting_power_for_epoch`



<pre><code><b>fun</b> <a href="stake.md#0x1_stake_cap_validator_info_voting_power_for_epoch">cap_validator_info_voting_power_for_epoch</a>(info: <a href="stake.md#0x1_stake_ValidatorInfo">stake::ValidatorInfo</a>, maximum_stake: u64, baseline_voting_power: u64, max_voting_power_increase: u128, used_voting_power_increase: u128): <a href="stake.md#0x1_stake_ValidatorInfo">stake::ValidatorInfo</a>
</code></pre>
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_cap_validator_info_voting_power_for_epoch">cap_validator_info_voting_power_for_epoch</a>(
    info: <a href="stake.md#0x1_stake_ValidatorInfo">ValidatorInfo</a>,
    maximum_stake: u64,
    baseline_voting_power: u64,
    max_voting_power_increase: u128,
    used_voting_power_increase: u128,
    ...
    <a href="stake.md#0x1_stake_ValidatorInfo">ValidatorInfo</a> {
        addr: info.addr,
        voting_power: <a href="stake.md#0x1_stake_cap_voting_power_for_epoch">cap_voting_power_for_epoch</a>(
            info.voting_power,
            maximum_stake,
            baseline_voting_power,
            max_voting_power_increase,
...
<a id="0x1_stake_cap_voting_power_for_epoch"></a>

## Function `cap_voting_power_for_epoch`



<pre><code><b>fun</b> <a href="stake.md#0x1_stake_cap_voting_power_for_epoch">cap_voting_power_for_epoch</a>(raw_voting_power: u64, maximum_stake: u64, baseline_voting_power: u64, max_voting_power_increase: u128, used_voting_power_increase: u128): u64
</code></pre>
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_cap_voting_power_for_epoch">cap_voting_power_for_epoch</a>(
    ...
    <b>let</b> capped_by_maximum = <a href="stake.md#0x1_stake_min_u64">min_u64</a>(raw_voting_power, maximum_stake);
    <b>if</b> (capped_by_maximum &lt;= baseline_voting_power) {
        <b>return</b> capped_by_maximum
    };

    <b>let</b> remaining_increase =
        <b>if</b> (used_voting_power_increase &gt;= max_voting_power_increase) {
            0
        } <b>else</b> {
            max_voting_power_increase - used_voting_power_increase
        };
    <b>let</b> allowed_voting_power =
        (baseline_voting_power <b>as</b> u128) + remaining_increase;
    <b>if</b> ((capped_by_maximum <b>as</b> u128) &gt; allowed_voting_power) {
        allowed_voting_power <b>as</b> u64
    } <b>else</b> {
        capped_by_maximum
    }
}
...
<a id="0x1_stake_calculate_max_voting_power_increase"></a>

## Function `calculate_max_voting_power_increase`



<pre><code><b>fun</b> <a href="stake.md#0x1_stake_calculate_max_voting_power_increase">calculate_max_voting_power_increase</a>(total_voting_power: u128, voting_power_increase_limit: u64): u128
</code></pre>
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_calculate_max_voting_power_increase">calculate_max_voting_power_increase</a>(
    ...
    <b>if</b> (total_voting_power == 0) {
        ...
        (total_voting_power * (voting_power_increase_limit <b>as</b> u128)) / 100
    }
}
</code></pre>
...
<a id="0x1_stake_voting_power_increase"></a>

## Function `voting_power_increase`



<pre><code><b>fun</b> <a href="stake.md#0x1_stake_voting_power_increase">voting_power_increase</a>(baseline_voting_power: u64, new_voting_power: u64): u128
</code></pre>
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_voting_power_increase">voting_power_increase</a>(
    baseline_voting_power: u64,
    new_voting_power: u64,
): u128 {
    <b>if</b> (new_voting_power &gt; baseline_voting_power) {
        ((new_voting_power - baseline_voting_power) <b>as</b> u128)
    } <b>else</b> {
        0
    }
}
...
<a id="0x1_stake_min_u64"></a>

## Function `min_u64`



<pre><code><b>fun</b> <a href="stake.md#0x1_stake_min_u64">min_u64</a>(a: u64, b: u64): u64
</code></pre>
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_assert_stake_pool_exists">assert_stake_pool_exists</a>(pool_address: <b>address</b>) {
    <b>assert</b>!(
        <a href="stake.md#0x1_stake_stake_pool_exists">stake_pool_exists</a>(pool_address),
        <a href="../../move-stdlib/doc/error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="stake.md#0x1_stake_ESTAKE_POOL_DOES_NOT_EXIST">ESTAKE_POOL_DOES_NOT_EXIST</a>)
    );
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="stake.md#0x1_stake_configure_allowed_validators">configure_allowed_validators</a>(topo_framework: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, accounts: <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<b>address</b>&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="stake.md#0x1_stake_configure_allowed_validators">configure_allowed_validators</a>(
    topo_framework: &<a href="../../move-stdlib/doc/signer.md#0x1_signer">signer</a>, accounts: <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<b>address</b>&gt;
) <b>acquires</b> <a href="stake.md#0x1_stake_AllowedValidators">AllowedValidators</a> {
    <b>let</b> aptos_framework_address = <a href="../../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(topo_framework);
    <a href="system_addresses.md#0x1_system_addresses_assert_aptos_framework">system_addresses::assert_aptos_framework</a>(topo_framework);
    <b>if</b> (!<b>exists</b>&lt;<a href="stake.md#0x1_stake_AllowedValidators">AllowedValidators</a>&gt;(aptos_framework_address)) {
        <b>move_to</b>(topo_framework, <a href="stake.md#0x1_stake_AllowedValidators">AllowedValidators</a> { accounts });
    } <b>else</b> {
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_is_allowed">is_allowed</a>(<a href="account.md#0x1_account">account</a>: <b>address</b>): bool <b>acquires</b> <a href="stake.md#0x1_stake_AllowedValidators">AllowedValidators</a> {
    <b>if</b> (!<b>exists</b>&lt;<a href="stake.md#0x1_stake_AllowedValidators">AllowedValidators</a>&gt;(@topo_framework)) { <b>true</b> }
    <b>else</b> {
        <b>let</b> allowed = <b>borrow_global</b>&lt;<a href="stake.md#0x1_stake_AllowedValidators">AllowedValidators</a>&gt;(@topo_framework);
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_assert_owner_cap_exists">assert_owner_cap_exists</a>(owner: <b>address</b>) {
    <b>assert</b>!(
        <b>exists</b>&lt;<a href="stake.md#0x1_stake_OwnerCapability">OwnerCapability</a>&gt;(owner),
        <a href="../../move-stdlib/doc/error.md#0x1_error_not_found">error::not_found</a>(<a href="stake.md#0x1_stake_EOWNER_CAP_NOT_FOUND">EOWNER_CAP_NOT_FOUND</a>)
    );
}
</code></pre>
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_assert_reconfig_not_in_progress">assert_reconfig_not_in_progress</a>() {
    <b>assert</b>!(
        !<a href="reconfiguration_state.md#0x1_reconfiguration_state_is_in_progress">reconfiguration_state::is_in_progress</a>(),
        <a href="../../move-stdlib/doc/error.md#0x1_error_invalid_state">error::invalid_state</a>(<a href="stake.md#0x1_stake_ERECONFIGURATION_IN_PROGRESS">ERECONFIGURATION_IN_PROGRESS</a>)
    );
}
</code></pre>
...
<tr>
<td>3</td>
<td>The residual local stake buckets in StakePool should conserve value across state transitions other than reward distribution.</td>
<td>Low</td>
<td>The total staked value (TopoCoin) of a stake pool is grouped by: active, inactive, pending_active, and pending_inactive. The value remains constant except during <code>on_new_epoch</code>, which can mint rewards into these buckets for legacy test scaffolding.</td>
...
<b>invariant</b> [suspendable] <b>exists</b>&lt;<a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a>&gt;(@topo_framework) ==&gt;
...
<b>invariant</b> [suspendable] <a href="chain_status.md#0x1_chain_status_is_operating">chain_status::is_operating</a>() ==&gt;
    <b>exists</b>&lt;<a href="stake.md#0x1_stake_TopoCoinCapabilities">TopoCoinCapabilities</a>&gt;(@topo_framework);
<b>invariant</b> [suspendable] <a href="chain_status.md#0x1_chain_status_is_operating">chain_status::is_operating</a>() ==&gt;
    <b>exists</b>&lt;<a href="stake.md#0x1_stake_ValidatorPerformance">ValidatorPerformance</a>&gt;(@topo_framework);
<b>invariant</b> [suspendable] <a href="chain_status.md#0x1_chain_status_is_operating">chain_status::is_operating</a>() ==&gt;
    <b>exists</b>&lt;<a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a>&gt;(@topo_framework);
...
<a id="@Specification_5_ValidatorSet"></a>
...
<pre><code><b>schema</b> <a href="stake.md#0x1_stake_ValidatorNotChangeDuringReconfig">ValidatorNotChangeDuringReconfig</a> {
    <b>ensures</b> (
        <a href="reconfiguration_state.md#0x1_reconfiguration_state_spec_is_in_progress">reconfiguration_state::spec_is_in_progress</a>()
            && <b>old</b>(<b>exists</b>&lt;<a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a>&gt;(@topo_framework))
    ) ==&gt;
        <b>old</b>(<b>global</b>&lt;<a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a>&gt;(@topo_framework))
            == <b>global</b>&lt;<a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a>&gt;(@topo_framework);
}
</code></pre>
...
<pre><code><b>schema</b> <a href="stake.md#0x1_stake_StakePoolNotChangeDuringReconfig">StakePoolNotChangeDuringReconfig</a> {
    <b>ensures</b> <b>forall</b> a: <b>address</b> <b>where</b> <b>old</b>(<b>exists</b>&lt;<a href="stake.md#0x1_stake_StakePool">StakePool</a>&gt;(a)):
        <a href="reconfiguration_state.md#0x1_reconfiguration_state_spec_is_in_progress">reconfiguration_state::spec_is_in_progress</a>() ==&gt;
            (
                <b>old</b>(<b>global</b>&lt;<a href="stake.md#0x1_stake_StakePool">StakePool</a>&gt;(a).pending_inactive)
                    == <b>global</b>&lt;<a href="stake.md#0x1_stake_StakePool">StakePool</a>&gt;(a).pending_inactive
                    && <b>old</b>(<b>global</b>&lt;<a href="stake.md#0x1_stake_StakePool">StakePool</a>&gt;(a).pending_active)
                        == <b>global</b>&lt;<a href="stake.md#0x1_stake_StakePool">StakePool</a>&gt;(a).pending_active
                    && <b>old</b>(<b>global</b>&lt;<a href="stake.md#0x1_stake_StakePool">StakePool</a>&gt;(a).inactive)
                        == <b>global</b>&lt;<a href="stake.md#0x1_stake_StakePool">StakePool</a>&gt;(a).inactive
                    && <b>old</b>(<b>global</b>&lt;<a href="stake.md#0x1_stake_StakePool">StakePool</a>&gt;(a).active)
                        == <b>global</b>&lt;<a href="stake.md#0x1_stake_StakePool">StakePool</a>&gt;(a).active
            );
}
</code></pre>
...
<pre><code><b>schema</b> <a href="stake.md#0x1_stake_ValidatorOwnerNoChange">ValidatorOwnerNoChange</a> {
    ...
    <b>ensures</b> <b>forall</b> addr: <b>address</b> <b>where</b> <b>old</b>(<b>exists</b>&lt;<a href="stake.md#0x1_stake_OwnerCapability">OwnerCapability</a>&gt;(addr)):
        <b>old</b>(<b>global</b>&lt;<a href="stake.md#0x1_stake_OwnerCapability">OwnerCapability</a>&gt;(addr)).pool_address
            == <b>global</b>&lt;<a href="stake.md#0x1_stake_OwnerCapability">OwnerCapability</a>&gt;(addr).pool_address;
}
</code></pre>
...
<pre><code><b>schema</b> <a href="stake.md#0x1_stake_StakedValueNochange">StakedValueNochange</a> {
    ...
    <b>ensures</b> stake_pool.active.value + stake_pool.inactive.value
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_validator_set_is_valid">validator_set_is_valid</a>(): bool {
   <b>let</b> validator_set = <b>global</b>&lt;<a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a>&gt;(@topo_framework);
...
<a id="@Specification_5_get_validator_state"></a>
...
<pre><code><b>aborts_if</b> !<b>exists</b>&lt;<a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a>&gt;(@topo_framework);
<b>let</b> validator_set = <b>global</b>&lt;<a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a>&gt;(@topo_framework);
<b>ensures</b> result == <a href="stake.md#0x1_stake_VALIDATOR_STATUS_PENDING_ACTIVE">VALIDATOR_STATUS_PENDING_ACTIVE</a> ==&gt;
    <a href="stake.md#0x1_stake_spec_contains">spec_contains</a>(validator_set.pending_active, pool_address);
<b>ensures</b> result == <a href="stake.md#0x1_stake_VALIDATOR_STATUS_ACTIVE">VALIDATOR_STATUS_ACTIVE</a> ==&gt;
    <a href="stake.md#0x1_stake_spec_contains">spec_contains</a>(validator_set.active_validators, pool_address);
<b>ensures</b> result == <a href="stake.md#0x1_stake_VALIDATOR_STATUS_PENDING_INACTIVE">VALIDATOR_STATUS_PENDING_INACTIVE</a> ==&gt;
...
<a id="@Specification_5_get_pending_transaction_fee"></a>
...
<a id="@Specification_5_initialize"></a>
...
<b>let</b> aptos_addr = <a href="../../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(topo_framework);
...
<a id="@Specification_5_remove_validators"></a>
...
<b>let</b> validator_set = <b>global</b>&lt;<a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a>&gt;(@topo_framework);
<b>let</b> <b>post</b> post_validator_set = <b>global</b>&lt;<a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a>&gt;(@topo_framework);
...
<b>ensures</b> len(active_validators) + len(pending_inactive_validators)
    == len(post_active_validators) + len(post_pending_inactive_validators);
</code></pre>



<a id="@Specification_5_initialize_stake_owner"></a>
...
<b>pragma</b> aborts_if_is_partial;
<b>include</b> <a href="stake.md#0x1_stake_AbortsIfSignerPermissionStake">AbortsIfSignerPermissionStake</a> { s: owner };
<b>include</b> <a href="stake.md#0x1_stake_ResourceRequirement">ResourceRequirement</a>;
<b>aborts_if</b> initial_stake_amount != 0;
<b>let</b> addr = <a href="../../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(owner);
<b>ensures</b> <b>global</b>&lt;<a href="stake.md#0x1_stake_ValidatorConfig">ValidatorConfig</a>&gt;(addr)
    == <a href="stake.md#0x1_stake_ValidatorConfig">ValidatorConfig</a> {
        consensus_pubkey: <a href="../../move-stdlib/doc/vector.md#0x1_vector_empty">vector::empty</a>(),
        network_addresses: <a href="../../move-stdlib/doc/vector.md#0x1_vector_empty">vector::empty</a>(),
        fullnode_addresses: <a href="../../move-stdlib/doc/vector.md#0x1_vector_empty">vector::empty</a>(),
...
<b>ensures</b> stakepool.active.value == 0;
<b>ensures</b> stakepool.pending_active.value == 0;
<b>ensures</b> stakepool.operator_address == operator;
</code></pre>



<a id="@Specification_5_initialize_validator"></a>
...
<pre><code><b>pragma</b> verify = <b>false</b>;
<b>include</b> <a href="stake.md#0x1_stake_AbortsIfSignerPermissionStake">AbortsIfSignerPermissionStake</a> { s: <a href="account.md#0x1_account">account</a> };
<b>let</b> pubkey_from_pop = <a href="../../topo-stdlib/doc/bls12381.md#0x1_bls12381_spec_public_key_from_bytes_with_pop">bls12381::spec_public_key_from_bytes_with_pop</a>(
    consensus_pubkey,
    proof_of_possession_from_bytes(proof_of_possession)
);
<b>aborts_if</b> !<a href="../../move-stdlib/doc/option.md#0x1_option_is_some">option::is_some</a>(pubkey_from_pop);
...
<b>let</b> allowed = <b>global</b>&lt;<a href="stake.md#0x1_stake_AllowedValidators">AllowedValidators</a>&gt;(@topo_framework);
<b>aborts_if</b> <b>exists</b>&lt;<a href="stake.md#0x1_stake_ValidatorConfig">ValidatorConfig</a>&gt;(addr);
<b>aborts_if</b> <b>exists</b>&lt;<a href="stake.md#0x1_stake_AllowedValidators">AllowedValidators</a>&gt;(@topo_framework)
    && !<a href="../../move-stdlib/doc/vector.md#0x1_vector_spec_contains">vector::spec_contains</a>(allowed.accounts, addr);
...
<b>aborts_if</b> <b>global</b>&lt;<a href="account.md#0x1_account_Account">account::Account</a>&gt;(addr).guid_creation_num + 12
    &gt;= <a href="account.md#0x1_account_MAX_GUID_CREATION_NUM">account::MAX_GUID_CREATION_NUM</a>;
<b>ensures</b> <b>exists</b>&lt;<a href="stake.md#0x1_stake_StakePool">StakePool</a>&gt;(post_addr);
<b>ensures</b> <b>global</b>&lt;<a href="stake.md#0x1_stake_OwnerCapability">OwnerCapability</a>&gt;(post_addr)
    == <a href="stake.md#0x1_stake_OwnerCapability">OwnerCapability</a> { pool_address: post_addr };
<b>ensures</b> <b>global</b>&lt;<a href="stake.md#0x1_stake_ValidatorConfig">ValidatorConfig</a>&gt;(post_addr)
    == <a href="stake.md#0x1_stake_ValidatorConfig">ValidatorConfig</a> {
        consensus_pubkey,
        network_addresses,
        fullnode_addresses,
...
<a id="@Specification_5_extract_owner_cap"></a>
...
<a id="@Specification_5_deposit_owner_cap"></a>
...
<pre><code><b>include</b> <a href="stake.md#0x1_stake_AbortsIfSignerPermissionStake">AbortsIfSignerPermissionStake</a> { s: owner };
<b>let</b> owner_address = <a href="../../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(owner);
<b>aborts_if</b> <b>exists</b>&lt;<a href="stake.md#0x1_stake_OwnerCapability">OwnerCapability</a>&gt;(owner_address);
<b>ensures</b> <b>exists</b>&lt;<a href="stake.md#0x1_stake_OwnerCapability">OwnerCapability</a>&gt;(owner_address);
...
<a id="@Specification_5_set_operator_with_cap"></a>
...
<a id="@Specification_5_rotate_consensus_key"></a>
...
<pre><code><b>include</b> <a href="stake.md#0x1_stake_AbortsIfSignerPermissionStake">AbortsIfSignerPermissionStake</a> { s: operator };
...
<a id="@Specification_5_update_network_and_fullnode_addresses"></a>
...
<a id="@Specification_5_increase_lockup_with_cap"></a>
...
<pre><code><b>let</b> config = <b>global</b>&lt;<a href="staking_config.md#0x1_staking_config_StakingConfig">staking_config::StakingConfig</a>&gt;(@topo_framework);
<b>let</b> pool_address = owner_cap.pool_address;
<b>let</b> pre_stake_pool = <b>global</b>&lt;<a href="stake.md#0x1_stake_StakePool">StakePool</a>&gt;(pool_address);
...
<b>aborts_if</b> !<b>exists</b>&lt;<a href="staking_config.md#0x1_staking_config_StakingConfig">staking_config::StakingConfig</a>&gt;(@topo_framework);
<b>ensures</b> stake_pool.locked_until_secs == lockup + now_seconds;
</code></pre>



<a id="@Specification_5_join_validator_set"></a>
...
<b>include</b> <a href="stake.md#0x1_stake_AbortsIfSignerPermissionStake">AbortsIfSignerPermissionStake</a> { s: operator };
...
<b>aborts_if</b> !<b>exists</b>&lt;<a href="stake.md#0x1_stake_StakePool">StakePool</a>&gt;(pool_address);
<b>aborts_if</b> !<b>exists</b>&lt;<a href="stake.md#0x1_stake_ValidatorConfig">ValidatorConfig</a>&gt;(pool_address);
<b>aborts_if</b> !<b>exists</b>&lt;StakingConfig&gt;(@topo_framework);
<b>aborts_if</b> !<b>exists</b>&lt;<a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a>&gt;(@topo_framework);
<b>aborts_if</b> <a href="reconfiguration_state.md#0x1_reconfiguration_state_spec_is_in_progress">reconfiguration_state::spec_is_in_progress</a>();
<b>let</b> stake_pool = <b>global</b>&lt;<a href="stake.md#0x1_stake_StakePool">StakePool</a>&gt;(pool_address);
<b>let</b> validator_set = <b>global</b>&lt;<a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a>&gt;(@topo_framework);
<b>let</b> <b>post</b> p_validator_set = <b>global</b>&lt;<a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a>&gt;(@topo_framework);
...
<b>aborts_if</b> <a href="../../move-stdlib/doc/option.md#0x1_option_is_some">option::is_some</a>(
    <a href="stake.md#0x1_stake_spec_find_validator">spec_find_validator</a>(validator_set.active_validators, pool_address)
)
    || <a href="../../move-stdlib/doc/option.md#0x1_option_is_some">option::is_some</a>(
        <a href="stake.md#0x1_stake_spec_find_validator">spec_find_validator</a>(validator_set.pending_inactive, pool_address)
    )
    || <a href="../../move-stdlib/doc/option.md#0x1_option_is_some">option::is_some</a>(
...
<b>let</b> voting_power = <a href="staking_registry.md#0x1_staking_registry_spec_get_validator_total_power">staking_registry::spec_get_validator_total_power</a>(pool_address);
...
<b>let</b> validator_set_size = <a href="../../move-stdlib/doc/vector.md#0x1_vector_length">vector::length</a>(validator_set.active_validators)
    + <a href="../../move-stdlib/doc/vector.md#0x1_vector_length">vector::length</a>(validator_set.pending_active) + 1;
<b>aborts_if</b> validator_set_size &gt; <a href="stake.md#0x1_stake_MAX_VALIDATOR_SET_SIZE">MAX_VALIDATOR_SET_SIZE</a>;
<b>let</b> voting_power_increase_limit = (
    <a href="staking_config.md#0x1_staking_config_get_voting_power_increase_limit">staking_config::get_voting_power_increase_limit</a>(config) <b>as</b> u128
);
<b>aborts_if</b> (validator_set.total_joining_power + (voting_power <b>as</b> u128)) &gt; MAX_U128;
<b>aborts_if</b> validator_set.total_voting_power * voting_power_increase_limit
    &gt; MAX_U128;
<b>aborts_if</b> validator_set.total_voting_power &gt; 0
    && (validator_set.total_joining_power + (voting_power <b>as</b> u128)) * 100
        &gt; validator_set.total_voting_power * voting_power_increase_limit;
...
<b>ensures</b> validator_set.total_joining_power + voting_power
...
<a id="@Specification_5_leave_validator_set"></a>
...
<b>aborts_if</b> <a href="../../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(operator) != stake_pool.operator_address;
<b>let</b> validator_set = <b>global</b>&lt;<a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a>&gt;(@topo_framework);
<b>let</b> validator_find_bool = <a href="../../move-stdlib/doc/option.md#0x1_option_is_some">option::is_some</a>(
    <a href="stake.md#0x1_stake_spec_find_validator">spec_find_validator</a>(validator_set.pending_active, pool_address)
);
<b>let</b> active_validators = validator_set.active_validators;
...
<b>ensures</b> len(active_validators) + len(pending_inactive_validators)
    == len(post_active_validators) + len(post_pending_inactive_validators);
<b>aborts_if</b> !validator_find_bool
    && !<a href="../../move-stdlib/doc/option.md#0x1_option_is_some">option::is_some</a>(<a href="stake.md#0x1_stake_spec_find_validator">spec_find_validator</a>(active_validators, pool_address));
<b>aborts_if</b> !validator_find_bool
    && <a href="../../move-stdlib/doc/vector.md#0x1_vector_length">vector::length</a>(validator_set.active_validators)
        &lt;= <a href="../../move-stdlib/doc/option.md#0x1_option_borrow">option::borrow</a>(<a href="stake.md#0x1_stake_spec_find_validator">spec_find_validator</a>(active_validators, pool_address));
<b>aborts_if</b> !validator_find_bool
    && <a href="../../move-stdlib/doc/vector.md#0x1_vector_length">vector::length</a>(validator_set.active_validators) &lt; 2;
<b>aborts_if</b> validator_find_bool
    && <a href="../../move-stdlib/doc/vector.md#0x1_vector_length">vector::length</a>(validator_set.pending_active)
        &lt;= <a href="../../move-stdlib/doc/option.md#0x1_option_borrow">option::borrow</a>(<a href="stake.md#0x1_stake_spec_find_validator">spec_find_validator</a>(pending_active, pool_address));
<b>let</b> <b>post</b> p_validator_set = <b>global</b>&lt;<a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a>&gt;(@topo_framework);
<b>ensures</b> !validator_find_bool ==&gt;
    !<a href="../../move-stdlib/doc/option.md#0x1_option_is_some">option::is_some</a>(
        <a href="stake.md#0x1_stake_spec_find_validator">spec_find_validator</a>(p_validator_set.pending_active, pool_address)
    );
</code></pre>



<a id="@Specification_5_is_current_epoch_validator"></a>
...
<a id="@Specification_5_update_performance_statistics"></a>
...
<b>let</b> validator_perf = <b>global</b>&lt;<a href="stake.md#0x1_stake_ValidatorPerformance">ValidatorPerformance</a>&gt;(@topo_framework);
<b>let</b> <b>post</b> post_validator_perf = <b>global</b>&lt;<a href="stake.md#0x1_stake_ValidatorPerformance">ValidatorPerformance</a>&gt;(@topo_framework);
<b>let</b> validator_len = len(validator_perf.validators);
<b>ensures</b> (
    <a href="../../move-stdlib/doc/option.md#0x1_option_is_some">option::is_some</a>(<a href="stake.md#0x1_stake_ghost_proposer_idx">ghost_proposer_idx</a>)
        && <a href="../../move-stdlib/doc/option.md#0x1_option_borrow">option::borrow</a>(<a href="stake.md#0x1_stake_ghost_proposer_idx">ghost_proposer_idx</a>) &lt; validator_len
) ==&gt;
    (
        post_validator_perf.validators[<a href="../../move-stdlib/doc/option.md#0x1_option_borrow">option::borrow</a>(<a href="stake.md#0x1_stake_ghost_proposer_idx">ghost_proposer_idx</a>)].successful_proposals ==
        validator_perf.validators[<a href="../../move-stdlib/doc/option.md#0x1_option_borrow">option::borrow</a>(<a href="stake.md#0x1_stake_ghost_proposer_idx">ghost_proposer_idx</a>)].successful_proposals
        + 1
    );
</code></pre>
...
<a id="@Specification_5_on_new_epoch"></a>
...
<b>include</b> topo_framework::topo_coin::ExistsTopoCoin;
...
<a id="@Specification_5_next_validator_consensus_infos"></a>
...
<a id="@Specification_5_compute_simulated_validator_info"></a>
...
<pre><code><b>let</b> _unused_simulated_deposit_deltas = simulated_deposit_deltas;
<b>let</b> _unused_maximum_stake = maximum_stake;
<b>let</b> _unused_baseline_voting_power = baseline_voting_power;
<b>let</b> _unused_max_voting_power_increase = max_voting_power_increase;
<b>let</b> _unused_used_voting_power_increase = used_voting_power_increase;
<b>aborts_if</b> <b>false</b>;
<b>ensures</b> result_2.addr == candidate.addr;
<b>ensures</b> result_2.config.validator_index == validator_index;
<b>ensures</b> result_2.voting_power == result_1;
</code></pre>



<a id="@Specification_5_validator_consensus_infos_from_validator_set"></a>
...
<b>invariant</b> <a href="stake.md#0x1_stake_spec_validator_indices_are_valid_config">spec_validator_indices_are_valid_config</a>(
    validator_set.active_validators,
    len(validator_set.active_validators) + len(validator_set.pending_inactive)
);
<b>invariant</b> len(validator_set.pending_inactive) == 0
    || <a href="stake.md#0x1_stake_spec_validator_indices_are_valid_config">spec_validator_indices_are_valid_config</a>(
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_spec_validators_are_initialized_addrs">spec_validators_are_initialized_addrs</a>(addrs: <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<b>address</b>&gt;): bool {
   <b>forall</b> i in 0..len(addrs):
       <a href="stake.md#0x1_stake_spec_has_stake_pool">spec_has_stake_pool</a>(addrs[i]) && <a href="stake.md#0x1_stake_spec_has_validator_config">spec_has_validator_config</a>(addrs[i])
}
</code></pre>
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_spec_validator_indices_are_valid">spec_validator_indices_are_valid</a>(validators: <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<a href="stake.md#0x1_stake_ValidatorInfo">ValidatorInfo</a>&gt;): bool {
   <a href="stake.md#0x1_stake_spec_validator_indices_are_valid_addr">spec_validator_indices_are_valid_addr</a>(
       validators, <a href="stake.md#0x1_stake_spec_validator_index_upper_bound">spec_validator_index_upper_bound</a>()
   ) && <a href="stake.md#0x1_stake_spec_validator_indices_are_valid_config">spec_validator_indices_are_valid_config</a>(
       validators, <a href="stake.md#0x1_stake_spec_validator_index_upper_bound">spec_validator_index_upper_bound</a>()
   )
}
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_spec_validator_indices_are_valid_addr">spec_validator_indices_are_valid_addr</a>(
   validators: <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<a href="stake.md#0x1_stake_ValidatorInfo">ValidatorInfo</a>&gt;, upper_bound: u64
): bool {
   <b>forall</b> i in 0..len(validators):
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_spec_validator_indices_are_valid_config">spec_validator_indices_are_valid_config</a>(
   validators: <a href="../../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<a href="stake.md#0x1_stake_ValidatorInfo">ValidatorInfo</a>&gt;, upper_bound: u64
): bool {
   <b>forall</b> i in 0..len(validators):
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_spec_validator_indices_active_pending_inactive">spec_validator_indices_active_pending_inactive</a>(validator_set: <a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a>): bool {
   len(validator_set.pending_inactive) + len(validator_set.active_validators)
       == <a href="stake.md#0x1_stake_spec_validator_index_upper_bound">spec_validator_index_upper_bound</a>()
}
</code></pre>
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_spec_validator_index_upper_bound">spec_validator_index_upper_bound</a>(): u64 {
   len(<b>global</b>&lt;<a href="stake.md#0x1_stake_ValidatorPerformance">ValidatorPerformance</a>&gt;(@topo_framework).validators)
}
</code></pre>
...
<pre><code><b>schema</b> <a href="stake.md#0x1_stake_ResourceRequirement">ResourceRequirement</a> {
    <b>requires</b> <b>exists</b>&lt;<a href="stake.md#0x1_stake_TopoCoinCapabilities">TopoCoinCapabilities</a>&gt;(@topo_framework);
    <b>requires</b> <b>exists</b>&lt;<a href="stake.md#0x1_stake_ValidatorPerformance">ValidatorPerformance</a>&gt;(@topo_framework);
    <b>requires</b> <b>exists</b>&lt;<a href="stake.md#0x1_stake_ValidatorSet">ValidatorSet</a>&gt;(@topo_framework);
    <b>requires</b> <b>exists</b>&lt;StakingConfig&gt;(@topo_framework);
    <b>requires</b> <b>exists</b>&lt;StakingRewardsConfig&gt;(@topo_framework)
        || !<a href="../../move-stdlib/doc/features.md#0x1_features_spec_periodical_reward_rate_decrease_enabled">features::spec_periodical_reward_rate_decrease_enabled</a>();
    <b>requires</b> <b>exists</b>&lt;<a href="timestamp.md#0x1_timestamp_CurrentTimeMicroseconds">timestamp::CurrentTimeMicroseconds</a>&gt;(@topo_framework);
}
</code></pre>
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_spec_get_reward_rate_1">spec_get_reward_rate_1</a>(config: StakingConfig): num {
   <b>if</b> (<a href="../../move-stdlib/doc/features.md#0x1_features_spec_periodical_reward_rate_decrease_enabled">features::spec_periodical_reward_rate_decrease_enabled</a>()) {
       <b>let</b> epoch_rewards_rate =
           <b>global</b>&lt;<a href="staking_config.md#0x1_staking_config_StakingRewardsConfig">staking_config::StakingRewardsConfig</a>&gt;(@topo_framework).rewards_rate;
...
<a id="@Specification_5_update_stake_pool"></a>
...
<a id="@Specification_5_get_reconfig_start_time_secs"></a>
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_spec_get_reconfig_start_time_secs">spec_get_reconfig_start_time_secs</a>(): u64 {
   <b>if</b> (<b>exists</b>&lt;<a href="reconfiguration_state.md#0x1_reconfiguration_state_State">reconfiguration_state::State</a>&gt;(@topo_framework)) {
...
<a id="@Specification_5_calculate_rewards_amount"></a>
...
<b>ensures</b> [concrete](rewards_rate_denominator * num_total_proposals == 0) ==&gt; result ==
    0;
...
<b>ensures</b> [abstract] result
    == <a href="stake.md#0x1_stake_spec_rewards_amount">spec_rewards_amount</a>(
        stake_amount,
        num_successful_proposals,
        num_total_proposals,
        rewards_rate,
...
<b>ensures</b> (
    <b>forall</b> i in <b>old</b>(len(v1))..len(v1):
        v1[i] == <b>old</b>(v2[len(v2) - (i - len(v1)) - 1])
);
</code></pre>



<a id="@Specification_5_find_validator"></a>
...
<pre><code><b>pragma</b> opaque;
<b>aborts_if</b> <b>false</b>;
<b>ensures</b> <a href="../../move-stdlib/doc/option.md#0x1_option_is_none">option::is_none</a>(result) ==&gt;
    (<b>forall</b> i in 0..len(v): v[i].addr != addr);
<b>ensures</b> <a href="../../move-stdlib/doc/option.md#0x1_option_is_some">option::is_some</a>(result) ==&gt;
    v[<a href="../../move-stdlib/doc/option.md#0x1_option_borrow">option::borrow</a>(result)].addr == addr;
<b>ensures</b> <a href="../../move-stdlib/doc/option.md#0x1_option_is_some">option::is_some</a>(result) ==&gt;
    <a href="stake.md#0x1_stake_spec_contains">spec_contains</a>(v, addr);
<b>ensures</b> [abstract] result == <a href="stake.md#0x1_stake_spec_find_validator">spec_find_validator</a>(v, addr);
</code></pre>



<a id="@Specification_5_update_voting_power_increase"></a>
...
<b>ensures</b> validator_set.total_joining_power
    == pre_validator_set.total_joining_power + increase_amount;
</code></pre>



<a id="@Specification_5_assert_stake_pool_exists"></a>
...
<a id="@Specification_5_configure_allowed_validators"></a>
...
<pre><code><b>let</b> aptos_framework_address = <a href="../../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(topo_framework);
...
<a id="@Specification_5_assert_owner_cap_exists"></a>
