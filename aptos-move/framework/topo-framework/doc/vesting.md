...
<pre><code><b>public</b> entry <b>fun</b> <a href="vesting.md#0x1_vesting_distribute">distribute</a>(contract_address: <b>address</b>) <b>acquires</b> <a href="vesting.md#0x1_vesting_VestingContract">VestingContract</a> {
    ...
    shareholders.for_each_ref(|shareholder| {
        ...
        <a href="topo_account.md#0x1_topo_account_deposit_coins">topo_account::deposit_coins</a>(recipient_address, share_of_coins);
    });
    ...
    <b>if</b> (<a href="coin.md#0x1_coin_value">coin::value</a>(&coins) &gt; 0) {
        <a href="topo_account.md#0x1_topo_account_deposit_coins">topo_account::deposit_coins</a>(vesting_contract.withdrawal_address, coins);
    } <b>else</b> {
        <a href="coin.md#0x1_coin_destroy_zero">coin::destroy_zero</a>(coins);
    };
...
<b>aborts_if</b> withdrawal_address == @topo_framework || withdrawal_address == @vm_reserved;
...
<b>aborts_if</b> !<b>exists</b>&lt;<a href="coin.md#0x1_coin_CoinStore">coin::CoinStore</a>&lt;TopoCoin&gt;&gt;(resource_addr) && !topo_std::type_info::spec_is_struct&lt;TopoCoin&gt;();
...
<pre><code><b>schema</b> <a href="vesting.md#0x1_vesting_DistributeInternalAbortsIf">DistributeInternalAbortsIf</a> {
    ...
    <b>aborts_if</b> !<b>exists</b>&lt;<a href="stake.md#0x1_stake_ValidatorSet">stake::ValidatorSet</a>&gt;(@topo_framework);
    <b>let</b> validator_set = <b>global</b>&lt;<a href="stake.md#0x1_stake_ValidatorSet">stake::ValidatorSet</a>&gt;(@topo_framework);
