...
<a id="0x1_topo_coin"></a>

# Module `0x1::topo_coin`

This module defines a minimal and generic Coin and Balance.
modified from https://github.com/move-language/move/tree/main/language/documentation/tutorial


-  [Resource `TopoCoin`](#0x1_topo_coin_TopoCoin)
-  [Resource `MintCapStore`](#0x1_topo_coin_MintCapStore)
-  [Struct `DelegatedMintCapability`](#0x1_topo_coin_DelegatedMintCapability)
-  [Resource `Delegations`](#0x1_topo_coin_Delegations)
-  [Constants](#@Constants_0)
-  [Function `initialize`](#0x1_topo_coin_initialize)
-  [Function `has_mint_capability`](#0x1_topo_coin_has_mint_capability)
-  [Function `destroy_mint_cap`](#0x1_topo_coin_destroy_mint_cap)
-  [Function `configure_accounts_for_test`](#0x1_topo_coin_configure_accounts_for_test)
-  [Function `mint`](#0x1_topo_coin_mint)
-  [Function `delegate_mint_capability`](#0x1_topo_coin_delegate_mint_capability)
-  [Function `claim_mint_capability`](#0x1_topo_coin_claim_mint_capability)
-  [Function `find_delegation`](#0x1_topo_coin_find_delegation)
...
<a id="0x1_topo_coin_TopoCoin"></a>

## Resource `TopoCoin`



<pre><code><b>struct</b> <a href="topo_coin.md#0x1_topo_coin_TopoCoin">TopoCoin</a> <b>has</b> key
</code></pre>
...
<a id="0x1_topo_coin_MintCapStore"></a>

## Resource `MintCapStore`



<pre><code><b>struct</b> <a href="topo_coin.md#0x1_topo_coin_MintCapStore">MintCapStore</a> <b>has</b> key
</code></pre>
...
<a id="0x1_topo_coin_DelegatedMintCapability"></a>
...
<pre><code><b>struct</b> <a href="topo_coin.md#0x1_topo_coin_DelegatedMintCapability">DelegatedMintCapability</a> <b>has</b> store
</code></pre>
...
<a id="0x1_topo_coin_Delegations"></a>
...
<pre><code><b>struct</b> <a href="topo_coin.md#0x1_topo_coin_Delegations">Delegations</a> <b>has</b> key
</code></pre>
...
<a id="0x1_topo_coin_EALREADY_DELEGATED"></a>

Mint capability has already been delegated to this specified address


<pre><code><b>const</b> <a href="topo_coin.md#0x1_topo_coin_EALREADY_DELEGATED">EALREADY_DELEGATED</a>: u64 = 2;
</code></pre>



<a id="0x1_topo_coin_EDELEGATION_NOT_FOUND"></a>

Cannot find delegation of mint capability to this account


<pre><code><b>const</b> <a href="topo_coin.md#0x1_topo_coin_EDELEGATION_NOT_FOUND">EDELEGATION_NOT_FOUND</a>: u64 = 3;
</code></pre>



<a id="0x1_topo_coin_ENO_CAPABILITIES"></a>

Account does not have mint capability


<pre><code><b>const</b> <a href="topo_coin.md#0x1_topo_coin_ENO_CAPABILITIES">ENO_CAPABILITIES</a>: u64 = 1;
</code></pre>



<a id="0x1_topo_coin_initialize"></a>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="topo_coin.md#0x1_topo_coin_initialize">initialize</a>(aptos_framework: &<a href="../../aptos-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>): (<a href="coin.md#0x1_coin_BurnCapability">coin::BurnCapability</a>&lt;<a href="topo_coin.md#0x1_topo_coin_TopoCoin">topo_coin::TopoCoin</a>&gt;, <a href="coin.md#0x1_coin_MintCapability">coin::MintCapability</a>&lt;<a href="topo_coin.md#0x1_topo_coin_TopoCoin">topo_coin::TopoCoin</a>&gt;)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="topo_coin.md#0x1_topo_coin_initialize">initialize</a>(aptos_framework: &<a href="../../aptos-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>): (BurnCapability&lt;<a href="topo_coin.md#0x1_topo_coin_TopoCoin">TopoCoin</a>&gt;, MintCapability&lt;<a href="topo_coin.md#0x1_topo_coin_TopoCoin">TopoCoin</a>&gt;) {
    ...
    <b>move_to</b>(aptos_framework, <a href="topo_coin.md#0x1_topo_coin_MintCapStore">MintCapStore</a> { mint_cap });
...
<a id="0x1_topo_coin_has_mint_capability"></a>
...
<a id="0x1_topo_coin_destroy_mint_cap"></a>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="topo_coin.md#0x1_topo_coin_destroy_mint_cap">destroy_mint_cap</a>(aptos_framework: &<a href="../../aptos-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="topo_coin.md#0x1_topo_coin_destroy_mint_cap">destroy_mint_cap</a>(aptos_framework: &<a href="../../aptos-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>) <b>acquires</b> <a href="topo_coin.md#0x1_topo_coin_MintCapStore">MintCapStore</a> {
    <a href="system_addresses.md#0x1_system_addresses_assert_aptos_framework">system_addresses::assert_aptos_framework</a>(aptos_framework);
    <b>let</b> <a href="topo_coin.md#0x1_topo_coin_MintCapStore">MintCapStore</a> { mint_cap } = <b>move_from</b>&lt;<a href="topo_coin.md#0x1_topo_coin_MintCapStore">MintCapStore</a>&gt;(@aptos_framework);
...
<a id="0x1_topo_coin_configure_accounts_for_test"></a>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="topo_coin.md#0x1_topo_coin_configure_accounts_for_test">configure_accounts_for_test</a>(aptos_framework: &<a href="../../aptos-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>, core_resources: &<a href="../../aptos-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>, mint_cap: <a href="coin.md#0x1_coin_MintCapability">coin::MintCapability</a>&lt;<a href="topo_coin.md#0x1_topo_coin_TopoCoin">topo_coin::TopoCoin</a>&gt;)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="topo_coin.md#0x1_topo_coin_configure_accounts_for_test">configure_accounts_for_test</a>(
    ...
    // Mint the core resource <a href="account.md#0x1_account">account</a> <a href="topo_coin.md#0x1_topo_coin_TopoCoin">TopoCoin</a> for gas so it can execute system transactions.
    <b>let</b> coins = <a href="coin.md#0x1_coin_mint">coin::mint</a>&lt;<a href="topo_coin.md#0x1_topo_coin_TopoCoin">TopoCoin</a>&gt;(
...
<pre><code><b>public</b> entry <b>fun</b> <a href="topo_coin.md#0x1_topo_coin_mint">mint</a>(
    ...
    <b>let</b> coins_minted = <a href="coin.md#0x1_coin_mint">coin::mint</a>&lt;<a href="topo_coin.md#0x1_topo_coin_TopoCoin">TopoCoin</a>&gt;(amount, mint_cap);
    <a href="coin.md#0x1_coin_deposit">coin::deposit</a>&lt;<a href="topo_coin.md#0x1_topo_coin_TopoCoin">TopoCoin</a>&gt;(dst_addr, coins_minted);
}
</code></pre>
...
<a id="0x1_topo_coin_delegate_mint_capability"></a>
...
<a id="0x1_topo_coin_claim_mint_capability"></a>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="topo_coin.md#0x1_topo_coin_claim_mint_capability">claim_mint_capability</a>(<a href="account.md#0x1_account">account</a>: &<a href="../../aptos-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>) <b>acquires</b> <a href="topo_coin.md#0x1_topo_coin_Delegations">Delegations</a>, <a href="topo_coin.md#0x1_topo_coin_MintCapStore">MintCapStore</a> {
    ...
    <b>let</b> delegations = &<b>mut</b> <b>borrow_global_mut</b>&lt;<a href="topo_coin.md#0x1_topo_coin_Delegations">Delegations</a>&gt;(@core_resources).inner;
    <b>let</b> <a href="topo_coin.md#0x1_topo_coin_DelegatedMintCapability">DelegatedMintCapability</a> { <b>to</b>: _ } = delegations.swap_remove(idx);

    // Make a <b>copy</b> of mint cap and give it <b>to</b> the specified <a href="account.md#0x1_account">account</a>.
    <b>let</b> mint_cap = <b>borrow_global</b>&lt;<a href="topo_coin.md#0x1_topo_coin_MintCapStore">MintCapStore</a>&gt;(@core_resources).mint_cap;
    <b>move_to</b>(<a href="account.md#0x1_account">account</a>, <a href="topo_coin.md#0x1_topo_coin_MintCapStore">MintCapStore</a> { mint_cap });
}
</code></pre>
...
<a id="0x1_topo_coin_find_delegation"></a>
...
<pre><code><b>fun</b> <a href="topo_coin.md#0x1_topo_coin_find_delegation">find_delegation</a>(addr: <b>address</b>): Option&lt;u64&gt; <b>acquires</b> <a href="topo_coin.md#0x1_topo_coin_Delegations">Delegations</a> {
...
<tr>
<td>3</td>
<td>The abilities to mint Topo tokens should be transferable, duplicatable, and destroyable.</td>
<td>High</td>
<td>The MintCapability struct has the copy and store abilities. This means that it can be duplicated and stored in different object wrappers (such as MintCapStore). This capability is tested against the destroy_mint_cap and claim_mint_capability functions.</td>
<td>Verified via <a href="#high-level-req-3">initialize</a>.</td>
</tr>
...
<b>ensures</b> <b>exists</b>&lt;<a href="topo_coin.md#0x1_topo_coin_MintCapStore">MintCapStore</a>&gt;(addr);
// This enforces <a id="high-level-req-3" href="#high-level-req">high-level requirement 3</a>:
<b>ensures</b> <b>global</b>&lt;<a href="topo_coin.md#0x1_topo_coin_MintCapStore">MintCapStore</a>&gt;(addr).mint_cap ==  MintCapability&lt;<a href="topo_coin.md#0x1_topo_coin_TopoCoin">TopoCoin</a>&gt; {};
<b>ensures</b> <b>exists</b>&lt;<a href="coin.md#0x1_coin_CoinInfo">coin::CoinInfo</a>&lt;<a href="topo_coin.md#0x1_topo_coin_TopoCoin">TopoCoin</a>&gt;&gt;(addr);
<b>ensures</b> result_1 == BurnCapability&lt;<a href="topo_coin.md#0x1_topo_coin_TopoCoin">TopoCoin</a>&gt; {};
<b>ensures</b> result_2 == MintCapability&lt;<a href="topo_coin.md#0x1_topo_coin_TopoCoin">TopoCoin</a>&gt; {};
</code></pre>
...
<b>aborts_if</b> addr != @aptos_framework;
<b>aborts_if</b> !<b>exists</b>&lt;<a href="topo_coin.md#0x1_topo_coin_MintCapStore">MintCapStore</a>&gt;(@aptos_framework);
</code></pre>
...
<pre><code><b>aborts_if</b> !<b>exists</b>&lt;<a href="topo_coin.md#0x1_topo_coin_Delegations">Delegations</a>&gt;(@core_resources);
</code></pre>




<a id="0x1_topo_coin_ExistsTopoCoin"></a>


<pre><code><b>schema</b> <a href="topo_coin.md#0x1_topo_coin_ExistsTopoCoin">ExistsTopoCoin</a> {
    <b>requires</b> <b>exists</b>&lt;<a href="coin.md#0x1_coin_CoinInfo">coin::CoinInfo</a>&lt;<a href="topo_coin.md#0x1_topo_coin_TopoCoin">TopoCoin</a>&gt;&gt;(@aptos_framework);
}
</code></pre>
