spec topo_framework::chain_status {
    /// <high-level-req>
    /// No.: 1
    ...
    spec set_genesis_end(topo_framework: &signer) {
        use std::signer;
        pragma verify = true;
        ...
        /// [high-level-req-3]
        aborts_if exists<GenesisEndMarker>(@topo_framework);
        /// [high-level-req-1]
        ensures global<GenesisEndMarker>(@topo_framework) == GenesisEndMarker {};
    }
