...
module topo_framework::multisig_account {
    use topo_framework::account::{Self, SignerCapability, new_event_handle, create_resource_address};
    ...
    /// account.
    const DOMAIN_SEPARATOR: vector<u8> = b"topo_framework::multisig_account";
    ...
    #[test_only]
    use topo_framework::topo_account::create_account;
    #[test_only]
    ...
    #[test_only]
    use topo_framework::coin::{destroy_mint_cap, destroy_burn_cap};
