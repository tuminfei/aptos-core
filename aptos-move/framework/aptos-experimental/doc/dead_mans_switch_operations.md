...
<pre><code><b>public</b> <b>fun</b> <a href="dead_mans_switch_operations.md#0x7_dead_mans_switch_operations_cleanup_expired_orders">cleanup_expired_orders</a>&lt;M: store + <b>copy</b> + drop, R: store + <b>copy</b> + drop&gt;(
    ...
    order_ids: <a href="../../topo-framework/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;OrderId&gt;,
    ...
    <b>while</b> (i &lt; order_ids.length()) {
        ...
        <b>if</b> (order_opt.is_some()) {
            ...
            <b>let</b> is_valid =
                is_order_valid(tracker, <a href="../../topo-framework/doc/account.md#0x1_account">account</a>, <a href="../../topo-framework/../move-stdlib/doc/option.md#0x1_option_some">option::some</a>(creation_time_secs));
            ...
            <b>if</b> (!is_valid) {
                ...
                <a href="order_operations.md#0x7_order_operations_cancel_order">order_operations::cancel_order</a>(
                    ...
                    <a href="../../topo-framework/../move-stdlib/doc/string.md#0x1_string_utf8">string::utf8</a>(b"Dead man's switch: Order expired"),
                    callbacks
                );
            }
        };
...
<pre><code><b>public</b> <b>fun</b> <a href="dead_mans_switch_operations.md#0x7_dead_mans_switch_operations_cleanup_expired_bulk_order">cleanup_expired_bulk_order</a>&lt;M: store + <b>copy</b> + drop, R: store + <b>copy</b> + drop&gt;(
    ...
    <b>let</b> is_valid = is_order_valid(
        tracker, <a href="../../topo-framework/doc/account.md#0x1_account">account</a>, <a href="../../topo-framework/../move-stdlib/doc/option.md#0x1_option_some">option::some</a>(creation_time_secs)
    );
