...
module topo_token_objects::collection {
    use std::error;
    use std::features;
    use std::option::{Self, Option};
    use std::signer;
    use std::string::{Self, String};
    use topo_framework::aggregator_v2::{Self, Aggregator, AggregatorSnapshot};
    ...
    friend topo_token_objects::token;
    ...
    #[expected_failure(abort_code = 0x50003, location = topo_framework::object)]
    ...
    entry fun test_create_and_transfer_as_owner(creator: &signer, trader: &signer, topo_framework: &signer) {
    ...
    #[test(creator = @0x123)]
    #[expected_failure(abort_code = 0x1000A, location = topo_token_objects::collection)]
    ...
    #[test(creator = @0x123)]
    #[expected_failure(abort_code = 0x20009, location = topo_token_objects::collection)]
