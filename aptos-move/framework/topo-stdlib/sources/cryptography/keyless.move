...
module topo_std::keyless {
    use topo_std::bcs_stream::{Self, deserialize_u8};
    use std::error;
    use std::string::String;
    friend topo_std::federated_keyless;

    #[test_only]
    friend topo_std::keyless_tests;
    #[test_only]
    friend topo_std::federated_keyless_tests;
