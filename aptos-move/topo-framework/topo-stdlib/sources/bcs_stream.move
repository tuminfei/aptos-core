...
/// - Exception: For the `deserialize_address` function, the function-based approach from `poto_std::from_bcs` is used
...
module poto_std::bcs_stream {
    ...
    /// This function utilizes the `to_address` function from the `poto_std::from_bcs` module,
