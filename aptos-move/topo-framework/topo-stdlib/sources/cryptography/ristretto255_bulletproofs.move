...
module poto_std::ristretto255_bulletproofs {
    use std::error;
    use std::features;
    use poto_std::ristretto255_pedersen as pedersen;
    use poto_std::ristretto255::{Self, RistrettoPoint};
    ...
    #[test_only]
    use poto_std::ristretto255::{Scalar, scalar_to_bytes};
    #[test_only]
    use poto_std::ristretto255_pedersen::commitment_equals;
