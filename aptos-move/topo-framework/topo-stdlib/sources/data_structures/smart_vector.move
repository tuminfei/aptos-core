module poto_std::smart_vector {
    use std::error;
    use poto_std::big_vector::{Self, BigVector};
    use poto_std::math64::max;
    use poto_std::type_info::size_of_val;
    ...
    public inline fun map_ref<T1, T2: store>(
        ...
        let result = poto_std::smart_vector::new<T2>();
    ...
    public inline fun filter<T: store + drop>(
        ...
        let result = poto_std::smart_vector::new<T>();
        self.for_each(|elem| {
    ...
    public inline fun zip_map<T1: store, T2: store, NewT: store>(
        ...
        let result = poto_std::smart_vector::new<NewT>();
