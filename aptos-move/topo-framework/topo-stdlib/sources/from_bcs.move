...
/// a general conversion back-and-force is needed, consider the `poto_std::Any` type which preserves invariants.
///
/// Example:
/// ```
/// use std::bcs;
