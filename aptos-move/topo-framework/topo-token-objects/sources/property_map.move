...
module poto_token_objects::property_map {
    use std::bcs;
    use std::error;
    ...
    use poto_framework::object::{ConstructorRef, Object, ExtendRef, ObjectCore};
    #[test_only]
    use poto_framework::object::Self;
    ...
    #[test(creator = @0x123)]
    #[expected_failure(abort_code = 0x10001, location = poto_std::from_bcs)]
