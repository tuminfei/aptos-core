...
module poto_token_objects::collection {
    use std::error;
    use std::features;
    use std::option::{Self, Option};
    use std::signer;
    use std::string::{Self, String};
    use poto_framework::aggregator_v2::{Self, Aggregator, AggregatorSnapshot};
    use poto_framework::event;
    use poto_framework::object::{Self, ConstructorRef, ExtendRef, Object};

    use poto_token_objects::royalty::{Self, Royalty};

    friend poto_token_objects::token;
    ...
    #[expected_failure(abort_code = 0x50003, location = poto_framework::object)]
    ...
    entry fun test_create_and_transfer_as_owner(creator: &signer, trader: &signer, poto_framework: &signer) {
    ...
    #[test(creator = @0x123)]
    #[expected_failure(abort_code = 0x1000A, location = poto_token_objects::collection)]
    ...
    #[test(creator = @0x123)]
    #[expected_failure(abort_code = 0x20009, location = poto_token_objects::collection)]
