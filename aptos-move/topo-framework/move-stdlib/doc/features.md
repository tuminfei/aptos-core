...
-  [Function `poto_stdlib_chain_id_enabled`](#0x1_features_aptos_stdlib_chain_id_enabled)
...
-  [Function `get_primary_topo_fungible_store_at_user_address_feature`](#0x1_features_get_primary_topo_fungible_store_at_user_address_feature)
-  [Function `primary_topo_fungible_store_at_user_address_enabled`](#0x1_features_primary_topo_fungible_store_at_user_address_enabled)
...
-  [Function `get_new_accounts_default_to_fa_topo_store_feature`](#0x1_features_get_new_accounts_default_to_fa_topo_store_feature)
-  [Function `new_accounts_default_to_fa_topo_store_enabled`](#0x1_features_new_accounts_default_to_fa_topo_store_enabled)
-  [Function `get_operations_default_to_fa_topo_store_feature`](#0x1_features_get_operations_default_to_fa_topo_store_feature)
-  [Function `operations_default_to_fa_topo_store_enabled`](#0x1_features_operations_default_to_fa_topo_store_enabled)
...
<a id="0x1_features_TOPOOS_STD_CHAIN_ID_NATIVES"></a>

Whether the new <code>poto_stdlib::type_info::chain_id()</code> native for fetching the chain ID is enabled.
This is needed because of the introduction of a new native function.
Lifetime: transient


<pre><code><b>const</b> <a href="features.md#0x1_features_TOPOOS_STD_CHAIN_ID_NATIVES">TOPOOS_STD_CHAIN_ID_NATIVES</a>: u64 = 4;
</code></pre>



<a id="0x1_features_TOPOOS_UNIQUE_IDENTIFIERS"></a>

Whether enable MOVE functions to call create_auid method to create AUIDs.
Lifetime: transient


<pre><code><b>const</b> <a href="features.md#0x1_features_TOPOOS_UNIQUE_IDENTIFIERS">TOPOOS_UNIQUE_IDENTIFIERS</a>: u64 = 23;
</code></pre>
...
Deprecated by <code>poto_framework::jwk_consensus_config::JWKConsensusConfig</code>.
...
Whether poto_framwork enables the behavior of module event migration.
...
Whether the new <code>poto_stdlib::multi_ed25519::public_key_validate_internal_v2()</code> native is enabled.
This is needed because of the introduction of a new native function.
Lifetime: transient
...
<a id="0x1_features_NEW_ACCOUNTS_DEFAULT_TO_FA_TOPO_STORE"></a>

Lifetime: transient


<pre><code><b>const</b> <a href="features.md#0x1_features_NEW_ACCOUNTS_DEFAULT_TO_FA_TOPO_STORE">NEW_ACCOUNTS_DEFAULT_TO_FA_TOPO_STORE</a>: u64 = 64;
</code></pre>
...
<a id="0x1_features_OPERATIONS_DEFAULT_TO_FA_TOPO_STORE"></a>

Lifetime: transient


<pre><code><b>const</b> <a href="features.md#0x1_features_OPERATIONS_DEFAULT_TO_FA_TOPO_STORE">OPERATIONS_DEFAULT_TO_FA_TOPO_STORE</a>: u64 = 65;
</code></pre>
...
Whether enable paritial governance voting on poto_governance.
Lifetime: transient
...
<a id="0x1_features_PRIMARY_TOPO_FUNGIBLE_STORE_AT_USER_ADDRESS"></a>



<pre><code><b>const</b> <a href="features.md#0x1_features_PRIMARY_TOPO_FUNGIBLE_STORE_AT_USER_ADDRESS">PRIMARY_TOPO_FUNGIBLE_STORE_AT_USER_ADDRESS</a>: u64 = 61;
</code></pre>
...
Deprecated by <code>poto_framework::randomness_config::RandomnessConfig</code>.
...
<pre><code><b>public</b> <b>fun</b> <a href="features.md#0x1_features_get_aptos_stdlib_chain_id_feature">get_aptos_stdlib_chain_id_feature</a>(): u64 {
    <a href="features.md#0x1_features_TOPOOS_STD_CHAIN_ID_NATIVES">TOPOOS_STD_CHAIN_ID_NATIVES</a>
}
</code></pre>
...
## Function `poto_stdlib_chain_id_enabled`



<pre><code><b>public</b> <b>fun</b> <a href="features.md#0x1_features_aptos_stdlib_chain_id_enabled">poto_stdlib_chain_id_enabled</a>(): bool
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="features.md#0x1_features_aptos_stdlib_chain_id_enabled">poto_stdlib_chain_id_enabled</a>(): bool {
    <a href="features.md#0x1_features_is_enabled">is_enabled</a>(<a href="features.md#0x1_features_TOPOOS_STD_CHAIN_ID_NATIVES">TOPOOS_STD_CHAIN_ID_NATIVES</a>)
}
</code></pre>
...
<a id="0x1_features_get_primary_topo_fungible_store_at_user_address_feature"></a>

## Function `get_primary_topo_fungible_store_at_user_address_feature`



<pre><code>#[deprecated]
<b>public</b> <b>fun</b> <a href="features.md#0x1_features_get_primary_topo_fungible_store_at_user_address_feature">get_primary_topo_fungible_store_at_user_address_feature</a>(): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="features.md#0x1_features_get_primary_topo_fungible_store_at_user_address_feature">get_primary_topo_fungible_store_at_user_address_feature</a>(): u64 {
    <b>abort</b> <a href="error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="features.md#0x1_features_EINVALID_FEATURE">EINVALID_FEATURE</a>)
}
</code></pre>
...
<a id="0x1_features_primary_topo_fungible_store_at_user_address_enabled"></a>

## Function `primary_topo_fungible_store_at_user_address_enabled`



<pre><code>#[deprecated]
<b>public</b> <b>fun</b> <a href="features.md#0x1_features_primary_topo_fungible_store_at_user_address_enabled">primary_topo_fungible_store_at_user_address_enabled</a>(): bool
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="features.md#0x1_features_primary_topo_fungible_store_at_user_address_enabled">primary_topo_fungible_store_at_user_address_enabled</a>(): bool {
    <b>true</b>
}
</code></pre>
...
<a id="0x1_features_get_new_accounts_default_to_fa_topo_store_feature"></a>

## Function `get_new_accounts_default_to_fa_topo_store_feature`



<pre><code><b>public</b> <b>fun</b> <a href="features.md#0x1_features_get_new_accounts_default_to_fa_topo_store_feature">get_new_accounts_default_to_fa_topo_store_feature</a>(): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="features.md#0x1_features_get_new_accounts_default_to_fa_topo_store_feature">get_new_accounts_default_to_fa_topo_store_feature</a>(): u64 {
    <a href="features.md#0x1_features_NEW_ACCOUNTS_DEFAULT_TO_FA_TOPO_STORE">NEW_ACCOUNTS_DEFAULT_TO_FA_TOPO_STORE</a>
}
</code></pre>
...
<a id="0x1_features_new_accounts_default_to_fa_topo_store_enabled"></a>

## Function `new_accounts_default_to_fa_topo_store_enabled`



<pre><code><b>public</b> <b>fun</b> <a href="features.md#0x1_features_new_accounts_default_to_fa_topo_store_enabled">new_accounts_default_to_fa_topo_store_enabled</a>(): bool
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="features.md#0x1_features_new_accounts_default_to_fa_topo_store_enabled">new_accounts_default_to_fa_topo_store_enabled</a>(): bool {
    <a href="features.md#0x1_features_is_enabled">is_enabled</a>(<a href="features.md#0x1_features_NEW_ACCOUNTS_DEFAULT_TO_FA_TOPO_STORE">NEW_ACCOUNTS_DEFAULT_TO_FA_TOPO_STORE</a>)
}
</code></pre>
...
<a id="0x1_features_get_operations_default_to_fa_topo_store_feature"></a>

## Function `get_operations_default_to_fa_topo_store_feature`



<pre><code>#[deprecated]
<b>public</b> <b>fun</b> <a href="features.md#0x1_features_get_operations_default_to_fa_topo_store_feature">get_operations_default_to_fa_topo_store_feature</a>(): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="features.md#0x1_features_get_operations_default_to_fa_topo_store_feature">get_operations_default_to_fa_topo_store_feature</a>(): u64 {
    <b>abort</b> <a href="error.md#0x1_error_invalid_argument">error::invalid_argument</a>(<a href="features.md#0x1_features_EINVALID_FEATURE">EINVALID_FEATURE</a>)
}
</code></pre>
...
<a id="0x1_features_operations_default_to_fa_topo_store_enabled"></a>

## Function `operations_default_to_fa_topo_store_enabled`



<pre><code>#[deprecated]
<b>public</b> <b>fun</b> <a href="features.md#0x1_features_operations_default_to_fa_topo_store_enabled">operations_default_to_fa_topo_store_enabled</a>(): bool
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="features.md#0x1_features_operations_default_to_fa_topo_store_enabled">operations_default_to_fa_topo_store_enabled</a>(): bool {
    <b>true</b>
}
</code></pre>
...
<pre><code>#[deprecated]
<b>public</b> <b>fun</b> <a href="features.md#0x1_features_is_monotonically_increasing_counter_enabled">is_monotonically_increasing_counter_enabled</a>(): bool
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="features.md#0x1_features_is_enabled">is_enabled</a>(feature: u64): bool {
...
<a id="0x1_features_spec_new_accounts_default_to_fa_topo_store_enabled"></a>


<pre><code><b>fun</b> <a href="features.md#0x1_features_spec_new_accounts_default_to_fa_topo_store_enabled">spec_new_accounts_default_to_fa_topo_store_enabled</a>(): bool {
   <a href="features.md#0x1_features_spec_is_enabled">spec_is_enabled</a>(<a href="features.md#0x1_features_NEW_ACCOUNTS_DEFAULT_TO_FA_TOPO_STORE">NEW_ACCOUNTS_DEFAULT_TO_FA_TOPO_STORE</a>)
}
</code></pre>
