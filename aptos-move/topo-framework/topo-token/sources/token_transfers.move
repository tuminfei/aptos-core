...
module poto_token::token_transfers {
    use std::signer;
    use std::string::String;
    use std::error;
    use poto_std::table::{Self, Table};
    use poto_token::token::{Self, Token, TokenId};
    ...
    public fun test_nft(creator: signer, owner: signer) acquires PendingClaims {
        ...
        poto_framework::account::create_account_for_test(owner_addr);
    ...
    public fun test_editions(
        ...
        poto_framework::account::create_account_for_test(owner0_addr);
        let owner1_addr = signer::address_of(&owner1);
        poto_framework::account::create_account_for_test(owner1_addr);
    ...
    public fun create_token(creator: &signer, amount: u64): TokenId {
        ...
        poto_framework::account::create_account_for_test(signer::address_of(creator));
