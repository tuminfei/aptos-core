...
- Exception: For the <code>deserialize_address</code> function, the function-based approach from <code>poto_std::from_bcs</code> is used
...
This function utilizes the <code>to_address</code> function from the <code>poto_std::from_bcs</code> module,
