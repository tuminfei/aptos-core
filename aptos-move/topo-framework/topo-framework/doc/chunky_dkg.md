...
<dt>
<code>dealer_validator_set: <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<a href="validator_consensus_info.md#0x1_validator_consensus_info_ValidatorConsensusInfo">validator_consensus_info::ValidatorConsensusInfo</a>&gt;</code>
</dt>
<dd>

</dd>
<dt>
<code>target_validator_set: <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<a href="validator_consensus_info.md#0x1_validator_consensus_info_ValidatorConsensusInfo">validator_consensus_info::ValidatorConsensusInfo</a>&gt;</code>
</dt>
<dd>
...
<dt>
<code>aggregated_subtranscript: <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;</code>
</dt>
<dd>
...
<dl>
<dt>
<code>last_completed: <a href="../../topo-stdlib/../move-stdlib/doc/option.md#0x1_option_Option">option::Option</a>&lt;<a href="chunky_dkg.md#0x1_chunky_dkg_ChunkyDKGSessionState">chunky_dkg::ChunkyDKGSessionState</a>&gt;</code>
</dt>
<dd>

</dd>
<dt>
<code>in_progress: <a href="../../topo-stdlib/../move-stdlib/doc/option.md#0x1_option_Option">option::Option</a>&lt;<a href="chunky_dkg.md#0x1_chunky_dkg_ChunkyDKGSessionState">chunky_dkg::ChunkyDKGSessionState</a>&gt;</code>
</dt>
<dd>
...
<pre><code><b>public</b> <b>fun</b> <a href="chunky_dkg.md#0x1_chunky_dkg_initialize">initialize</a>(poto_framework: &<a href="../../topo-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="chunky_dkg.md#0x1_chunky_dkg_initialize">initialize</a>(poto_framework: &<a href="../../topo-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>) {
    ...
    <b>if</b> (!<b>exists</b>&lt;<a href="chunky_dkg.md#0x1_chunky_dkg_ChunkyDKGState">ChunkyDKGState</a>&gt;(@poto_framework)) {
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="chunky_dkg.md#0x1_chunky_dkg_start">start</a>(dealer_epoch: u64, <a href="chunky_dkg_config.md#0x1_chunky_dkg_config">chunky_dkg_config</a>: <a href="chunky_dkg_config.md#0x1_chunky_dkg_config_ChunkyDKGConfig">chunky_dkg_config::ChunkyDKGConfig</a>, dealer_validator_set: <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<a href="validator_consensus_info.md#0x1_validator_consensus_info_ValidatorConsensusInfo">validator_consensus_info::ValidatorConsensusInfo</a>&gt;, target_validator_set: <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<a href="validator_consensus_info.md#0x1_validator_consensus_info_ValidatorConsensusInfo">validator_consensus_info::ValidatorConsensusInfo</a>&gt;)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="chunky_dkg.md#0x1_chunky_dkg_start">start</a>(
    ...
    dealer_validator_set: <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;ValidatorConsensusInfo&gt;,
    target_validator_set: <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;ValidatorConsensusInfo&gt;
) <b>acquires</b> <a href="chunky_dkg.md#0x1_chunky_dkg_ChunkyDKGState">ChunkyDKGState</a> {
    <b>let</b> chunky_dkg_state = <b>borrow_global_mut</b>&lt;<a href="chunky_dkg.md#0x1_chunky_dkg_ChunkyDKGState">ChunkyDKGState</a>&gt;(@poto_framework);
    ...
    chunky_dkg_state.in_progress = std::option::some(
        <a href="chunky_dkg.md#0x1_chunky_dkg_ChunkyDKGSessionState">ChunkyDKGSessionState</a> {
            ...
            start_time_us,
            aggregated_subtranscript: <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>[]
        }
    );
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="chunky_dkg.md#0x1_chunky_dkg_finish">finish</a>(aggregated_subtranscript: <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="chunky_dkg.md#0x1_chunky_dkg_finish">finish</a>(aggregated_subtranscript: <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;) <b>acquires</b> <a href="chunky_dkg.md#0x1_chunky_dkg_ChunkyDKGState">ChunkyDKGState</a> {
    <b>let</b> chunky_dkg_state = <b>borrow_global_mut</b>&lt;<a href="chunky_dkg.md#0x1_chunky_dkg_ChunkyDKGState">ChunkyDKGState</a>&gt;(@poto_framework);
    <b>assert</b>!(
        chunky_dkg_state.in_progress.is_some(),
        <a href="../../topo-stdlib/../move-stdlib/doc/error.md#0x1_error_invalid_state">error::invalid_state</a>(<a href="chunky_dkg.md#0x1_chunky_dkg_ECHUNKY_DKG_NOT_IN_PROGRESS">ECHUNKY_DKG_NOT_IN_PROGRESS</a>)
    );
    <b>let</b> session = chunky_dkg_state.in_progress.extract();
    session.aggregated_subtranscript = aggregated_subtranscript;
    chunky_dkg_state.last_completed = <a href="../../topo-stdlib/../move-stdlib/doc/option.md#0x1_option_some">option::some</a>(session);
    chunky_dkg_state.in_progress = <a href="../../topo-stdlib/../move-stdlib/doc/option.md#0x1_option_none">option::none</a>();
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="chunky_dkg.md#0x1_chunky_dkg_try_clear_incomplete_session">try_clear_incomplete_session</a>(fx: &<a href="../../topo-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="chunky_dkg.md#0x1_chunky_dkg_try_clear_incomplete_session">try_clear_incomplete_session</a>(fx: &<a href="../../topo-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>) <b>acquires</b> <a href="chunky_dkg.md#0x1_chunky_dkg_ChunkyDKGState">ChunkyDKGState</a> {
...
<pre><code><b>public</b> <b>fun</b> <a href="chunky_dkg.md#0x1_chunky_dkg_incomplete_session">incomplete_session</a>(): <a href="../../topo-stdlib/../move-stdlib/doc/option.md#0x1_option_Option">option::Option</a>&lt;<a href="chunky_dkg.md#0x1_chunky_dkg_ChunkyDKGSessionState">chunky_dkg::ChunkyDKGSessionState</a>&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="chunky_dkg.md#0x1_chunky_dkg_incomplete_session">incomplete_session</a>(): Option&lt;<a href="chunky_dkg.md#0x1_chunky_dkg_ChunkyDKGSessionState">ChunkyDKGSessionState</a>&gt; <b>acquires</b> <a href="chunky_dkg.md#0x1_chunky_dkg_ChunkyDKGState">ChunkyDKGState</a> {
    <b>if</b> (<b>exists</b>&lt;<a href="chunky_dkg.md#0x1_chunky_dkg_ChunkyDKGState">ChunkyDKGState</a>&gt;(@poto_framework)) {
        <b>borrow_global</b>&lt;<a href="chunky_dkg.md#0x1_chunky_dkg_ChunkyDKGState">ChunkyDKGState</a>&gt;(@poto_framework).in_progress
    } <b>else</b> {
...
<pre><code><b>let</b> poto_framework_addr = <a href="../../topo-stdlib/../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(poto_framework);
<b>aborts_if</b> poto_framework_addr != @poto_framework;
</code></pre>
...
<pre><code><b>aborts_if</b> !<b>exists</b>&lt;<a href="chunky_dkg.md#0x1_chunky_dkg_ChunkyDKGState">ChunkyDKGState</a>&gt;(@poto_framework);
...
<pre><code><b>requires</b> <b>exists</b>&lt;<a href="chunky_dkg.md#0x1_chunky_dkg_ChunkyDKGState">ChunkyDKGState</a>&gt;(@poto_framework);
<b>requires</b> <a href="../../topo-stdlib/../move-stdlib/doc/option.md#0x1_option_is_some">option::is_some</a>(<b>global</b>&lt;<a href="chunky_dkg.md#0x1_chunky_dkg_ChunkyDKGState">ChunkyDKGState</a>&gt;(@poto_framework).in_progress);
...
<pre><code><b>let</b> addr = <a href="../../topo-stdlib/../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(fx);
