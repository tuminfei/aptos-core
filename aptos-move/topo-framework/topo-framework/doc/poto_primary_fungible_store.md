...
<pre><code><b>public</b> entry <b>fun</b> <a href="apt_primary_fungible_store.md#0x1_aptos_primary_fungible_store_transfer">transfer</a>(sender: &<a href="../../topo-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>, recipient: <b>address</b>, amount: u64)
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="apt_primary_fungible_store.md#0x1_aptos_primary_fungible_store_transfer">transfer</a>(
    ...
    <b>let</b> sender_store = <a href="apt_primary_fungible_store.md#0x1_aptos_primary_fungible_store_ensure_primary_store_exists">ensure_primary_store_exists</a>(<a href="../../topo-stdlib/../move-stdlib/doc/signer.md#0x1_signer_address_of">signer::address_of</a>(sender));
