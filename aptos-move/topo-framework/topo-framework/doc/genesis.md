...
-  [Function `initialize_poto_coin`](#0x1_genesis_initialize_poto_coin)
-  [Function `initialize_core_resources_and_poto_coin`](#0x1_genesis_initialize_core_resources_and_poto_coin)
...
-  [Specification](#@Specification_1)
    ...
    -  [Function `initialize_poto_coin`](#@Specification_1_initialize_poto_coin)
...
<dt>
<code>vesting_schedule_numerator: <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u64&gt;</code>
</dt>
<dd>
...
<dt>
<code>proof_of_possession: <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;</code>
</dt>
<dd>
...
<dt>
<code>full_node_network_addresses: <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;</code>
</dt>
<dd>
...
<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_initialize">initialize</a>(<a href="gas_schedule.md#0x1_gas_schedule">gas_schedule</a>: <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;, <a href="chain_id.md#0x1_chain_id">chain_id</a>: u8, initial_version: u64, <a href="consensus_config.md#0x1_consensus_config">consensus_config</a>: <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;, <a href="execution_config.md#0x1_execution_config">execution_config</a>: <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;, epoch_interval_microsecs: u64, minimum_stake: u64, maximum_stake: u64, recurring_lockup_duration_secs: u64, allow_validator_set_change: bool, rewards_rate: u64, rewards_rate_denominator: u64, voting_power_increase_limit: u64)
</code></pre>
...
<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_initialize">initialize</a>(
    <a href="gas_schedule.md#0x1_gas_schedule">gas_schedule</a>: <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;,
    <a href="chain_id.md#0x1_chain_id">chain_id</a>: u8,
    initial_version: u64,
    <a href="consensus_config.md#0x1_consensus_config">consensus_config</a>: <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;,
    <a href="execution_config.md#0x1_execution_config">execution_config</a>: <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;,
    ...
    <b>let</b> (poto_framework_account, poto_framework_signer_cap) = <a href="account.md#0x1_account_create_framework_reserved_account">account::create_framework_reserved_account</a>(@poto_framework);
    // Initialize <a href="account.md#0x1_account">account</a> configs on aptos framework <a href="account.md#0x1_account">account</a>.
    <a href="account.md#0x1_account_initialize">account::initialize</a>(&poto_framework_account);

    <a href="transaction_validation.md#0x1_transaction_validation_initialize">transaction_validation::initialize</a>(
        &poto_framework_account,
        b"script_prologue",
        b"module_prologue",
    ...
    <a href="poto_governance.md#0x1_poto_governance_store_signer_cap">poto_governance::store_signer_cap</a>(&poto_framework_account, @poto_framework, poto_framework_signer_cap);

    // put reserved framework reserved accounts under aptos governance
    <b>let</b> framework_reserved_addresses = <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<b>address</b>&gt;[@0x2, @0x3, @0x4, @0x5, @0x6, @0x7, @0x8, @0x9, @0xa];
    <b>while</b> (!framework_reserved_addresses.is_empty()) {
        ...
        <a href="poto_governance.md#0x1_poto_governance_store_signer_cap">poto_governance::store_signer_cap</a>(&poto_framework_account, <b>address</b>, framework_signer_cap);
    };

    <a href="consensus_config.md#0x1_consensus_config_initialize">consensus_config::initialize</a>(&poto_framework_account, <a href="consensus_config.md#0x1_consensus_config">consensus_config</a>);
    <a href="execution_config.md#0x1_execution_config_set">execution_config::set</a>(&poto_framework_account, <a href="execution_config.md#0x1_execution_config">execution_config</a>);
    <a href="version.md#0x1_version_initialize">version::initialize</a>(&poto_framework_account, initial_version);
    <a href="stake.md#0x1_stake_initialize">stake::initialize</a>(&poto_framework_account);
    <a href="stake.md#0x1_stake_initialize_pending_transaction_fee">stake::initialize_pending_transaction_fee</a>(&poto_framework_account);
    <a href="timestamp.md#0x1_timestamp_set_time_has_started">timestamp::set_time_has_started</a>(&poto_framework_account);
    ...
    <a href="storage_gas.md#0x1_storage_gas_initialize">storage_gas::initialize</a>(&poto_framework_account);
    <a href="gas_schedule.md#0x1_gas_schedule_initialize">gas_schedule::initialize</a>(&poto_framework_account, <a href="gas_schedule.md#0x1_gas_schedule">gas_schedule</a>);

    // Ensure we can create aggregators for supply, but not enable it for common <b>use</b> just yet.
    <a href="aggregator_factory.md#0x1_aggregator_factory_initialize_aggregator_factory">aggregator_factory::initialize_aggregator_factory</a>(&poto_framework_account);

    <a href="chain_id.md#0x1_chain_id_initialize">chain_id::initialize</a>(&poto_framework_account, <a href="chain_id.md#0x1_chain_id">chain_id</a>);
    <a href="reconfiguration.md#0x1_reconfiguration_initialize">reconfiguration::initialize</a>(&poto_framework_account);
    <a href="block.md#0x1_block_initialize">block::initialize</a>(&poto_framework_account, epoch_interval_microsecs);
    <a href="state_storage.md#0x1_state_storage_initialize">state_storage::initialize</a>(&poto_framework_account);
    <a href="nonce_validation.md#0x1_nonce_validation_initialize">nonce_validation::initialize</a>(&poto_framework_account);
}
</code></pre>
...
<a id="0x1_genesis_initialize_poto_coin"></a>

## Function `initialize_poto_coin`

Genesis step 2: Initialize Aptos coin.


<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_initialize_poto_coin">initialize_poto_coin</a>(poto_framework: &<a href="../../topo-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>)
</code></pre>
...
<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_initialize_poto_coin">initialize_poto_coin</a>(poto_framework: &<a href="../../topo-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>) {
    <b>let</b> (burn_cap, mint_cap) = <a href="poto_coin.md#0x1_poto_coin_initialize">poto_coin::initialize</a>(poto_framework);

    <a href="coin.md#0x1_coin_create_coin_conversion_map">coin::create_coin_conversion_map</a>(poto_framework);
    <a href="coin.md#0x1_coin_create_pairing">coin::create_pairing</a>&lt;TopoCoin&gt;(poto_framework);

    // Give <a href="stake.md#0x1_stake">stake</a> <b>module</b> MintCapability&lt;TopoCoin&gt; so it can mint rewards.
    <a href="stake.md#0x1_stake_store_poto_coin_mint_cap">stake::store_poto_coin_mint_cap</a>(poto_framework, mint_cap);
    ...
    <a href="transaction_fee.md#0x1_transaction_fee_store_poto_coin_burn_cap">transaction_fee::store_poto_coin_burn_cap</a>(poto_framework, burn_cap);
    ...
    <a href="transaction_fee.md#0x1_transaction_fee_store_poto_coin_mint_cap">transaction_fee::store_poto_coin_mint_cap</a>(poto_framework, mint_cap);
}
</code></pre>
...
<a id="0x1_genesis_initialize_core_resources_and_poto_coin"></a>

## Function `initialize_core_resources_and_poto_coin`

Only called for testnets and e2e tests.


<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_initialize_core_resources_and_poto_coin">initialize_core_resources_and_poto_coin</a>(poto_framework: &<a href="../../topo-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>, core_resources_auth_key: <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;)
</code></pre>
...
<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_initialize_core_resources_and_poto_coin">initialize_core_resources_and_poto_coin</a>(
    poto_framework: &<a href="../../topo-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>,
    core_resources_auth_key: <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;,
) {
    <b>let</b> (burn_cap, mint_cap) = <a href="poto_coin.md#0x1_poto_coin_initialize">poto_coin::initialize</a>(poto_framework);
    ...
    <a href="poto_account.md#0x1_poto_account_register_topo">poto_account::register_topo</a>(&core_resources); // registers TOPO store
    <a href="poto_coin.md#0x1_poto_coin_configure_accounts_for_test">poto_coin::configure_accounts_for_test</a>(poto_framework, &core_resources, mint_cap);
}
</code></pre>
...
<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_create_accounts">create_accounts</a>(poto_framework: &<a href="../../topo-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>, accounts: <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<a href="genesis.md#0x1_genesis_AccountMap">genesis::AccountMap</a>&gt;)
</code></pre>
...
<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_create_accounts">create_accounts</a>(poto_framework: &<a href="../../topo-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>, accounts: <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<a href="genesis.md#0x1_genesis_AccountMap">AccountMap</a>&gt;) {
    <b>let</b> unique_accounts = <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector_empty">vector::empty</a>();
    accounts.for_each_ref(|account_map| {
        <b>let</b> account_map: &<a href="genesis.md#0x1_genesis_AccountMap">AccountMap</a> = account_map;
        <b>assert</b>!(
            !<a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector_contains">vector::contains</a>(&unique_accounts, &account_map.account_address),
            <a href="../../topo-stdlib/../move-stdlib/doc/error.md#0x1_error_already_exists">error::already_exists</a>(<a href="genesis.md#0x1_genesis_EDUPLICATE_ACCOUNT">EDUPLICATE_ACCOUNT</a>),
        );
        <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector_push_back">vector::push_back</a>(&<b>mut</b> unique_accounts, account_map.account_address);
...
<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_create_account">create_account</a>(poto_framework: &<a href="../../topo-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>, account_address: <b>address</b>, balance: u64): <a href="../../topo-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>
</code></pre>
...
<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_create_account">create_account</a>(poto_framework: &<a href="../../topo-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>, account_address: <b>address</b>, balance: u64): <a href="../../topo-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a> {
    ...
    <b>if</b> (<a href="coin.md#0x1_coin_balance">coin::balance</a>&lt;TopoCoin&gt;(account_address) == 0) {
        ...
        <a href="poto_coin.md#0x1_poto_coin_mint">poto_coin::mint</a>(poto_framework, account_address, balance);
    };
...
<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_create_employee_validators">create_employee_validators</a>(employee_vesting_start: u64, employee_vesting_period_duration: u64, employees: <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<a href="genesis.md#0x1_genesis_EmployeeAccountMap">genesis::EmployeeAccountMap</a>&gt;)
</code></pre>
...
<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_create_employee_validators">create_employee_validators</a>(
    ...
    employees: <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<a href="genesis.md#0x1_genesis_EmployeeAccountMap">EmployeeAccountMap</a>&gt;,
) {
    <b>let</b> unique_accounts = <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector_empty">vector::empty</a>();
    ...
    employees.for_each_ref(|employee_group| {
        ...
        <b>let</b> num_employees_in_group = <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector_length">vector::length</a>(&employee_group.accounts);

        <b>let</b> buy_ins = <a href="../../topo-stdlib/doc/simple_map.md#0x1_simple_map_create">simple_map::create</a>();

        <b>while</b> (j &lt; num_employees_in_group) {
            <b>let</b> <a href="account.md#0x1_account">account</a> = <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector_borrow">vector::borrow</a>(&employee_group.accounts, j);
            <b>assert</b>!(
                !<a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector_contains">vector::contains</a>(&unique_accounts, <a href="account.md#0x1_account">account</a>),
                <a href="../../topo-stdlib/../move-stdlib/doc/error.md#0x1_error_already_exists">error::already_exists</a>(<a href="genesis.md#0x1_genesis_EDUPLICATE_ACCOUNT">EDUPLICATE_ACCOUNT</a>),
            );
            <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector_push_back">vector::push_back</a>(&<b>mut</b> unique_accounts, *<a href="account.md#0x1_account">account</a>);
            ...
            <a href="../../topo-stdlib/doc/simple_map.md#0x1_simple_map_add">simple_map::add</a>(&<b>mut</b> buy_ins, *<a href="account.md#0x1_account">account</a>, coins);

            j += 1;
        };

        <b>let</b> j = 0;
        <b>let</b> num_vesting_events = <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector_length">vector::length</a>(&employee_group.vesting_schedule_numerator);
        <b>let</b> schedule = <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector_empty">vector::empty</a>();

        <b>while</b> (j &lt; num_vesting_events) {
            <b>let</b> numerator = <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector_borrow">vector::borrow</a>(&employee_group.vesting_schedule_numerator, j);
            <b>let</b> <a href="event.md#0x1_event">event</a> = <a href="../../topo-stdlib/../move-stdlib/doc/fixed_point32.md#0x1_fixed_point32_create_from_rational">fixed_point32::create_from_rational</a>(*numerator, employee_group.vesting_schedule_denominator);
            <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector_push_back">vector::push_back</a>(&<b>mut</b> schedule, <a href="event.md#0x1_event">event</a>);
        ...
        <b>assert</b>!(
            ...
            <a href="../../topo-stdlib/../move-stdlib/doc/error.md#0x1_error_not_found">error::not_found</a>(<a href="genesis.md#0x1_genesis_EACCOUNT_DOES_NOT_EXIST">EACCOUNT_DOES_NOT_EXIST</a>),
        );
        <b>assert</b>!(
...
<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_create_initialize_validators_with_commission">create_initialize_validators_with_commission</a>(poto_framework: &<a href="../../topo-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>, use_staking_contract: bool, validators: <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<a href="genesis.md#0x1_genesis_ValidatorConfigurationWithCommission">genesis::ValidatorConfigurationWithCommission</a>&gt;)
</code></pre>
...
<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_create_initialize_validators_with_commission">create_initialize_validators_with_commission</a>(
    ...
    validators: <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<a href="genesis.md#0x1_genesis_ValidatorConfigurationWithCommission">ValidatorConfigurationWithCommission</a>&gt;,
) {
    validators.for_each_ref(|validator| {
        ...
        <a href="genesis.md#0x1_genesis_create_initialize_validator">create_initialize_validator</a>(poto_framework, validator, use_staking_contract);
    });
    ...
    // validators.
    <a href="poto_coin.md#0x1_poto_coin_destroy_mint_cap">poto_coin::destroy_mint_cap</a>(poto_framework);
...
<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_create_initialize_validators">create_initialize_validators</a>(poto_framework: &<a href="../../topo-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>, validators: <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<a href="genesis.md#0x1_genesis_ValidatorConfiguration">genesis::ValidatorConfiguration</a>&gt;)
</code></pre>
...
<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_create_initialize_validators">create_initialize_validators</a>(poto_framework: &<a href="../../topo-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>, validators: <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;<a href="genesis.md#0x1_genesis_ValidatorConfiguration">ValidatorConfiguration</a>&gt;) {
    <b>let</b> validators_with_commission = <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector_empty">vector::empty</a>();
    validators.for_each_reverse(|validator| {
        ...
        <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector_push_back">vector::push_back</a>(&<b>mut</b> validators_with_commission, validator_with_commission);
    });

    <a href="genesis.md#0x1_genesis_create_initialize_validators_with_commission">create_initialize_validators_with_commission</a>(poto_framework, <b>false</b>, validators_with_commission);
}
</code></pre>
...
<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_create_initialize_validator">create_initialize_validator</a>(poto_framework: &<a href="../../topo-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>, commission_config: &<a href="genesis.md#0x1_genesis_ValidatorConfigurationWithCommission">genesis::ValidatorConfigurationWithCommission</a>, use_staking_contract: bool)
</code></pre>
...
<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_create_initialize_validator">create_initialize_validator</a>(
    ...
    <b>let</b> owner = &<a href="genesis.md#0x1_genesis_create_account">create_account</a>(poto_framework, validator.owner_address, validator.stake_amount);
    <a href="genesis.md#0x1_genesis_create_account">create_account</a>(poto_framework, validator.operator_address, 0);
    <a href="genesis.md#0x1_genesis_create_account">create_account</a>(poto_framework, validator.voter_address, 0);
...
<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_set_genesis_end">set_genesis_end</a>(poto_framework: &<a href="../../topo-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>)
</code></pre>
...
<pre><code><b>fun</b> <a href="genesis.md#0x1_genesis_set_genesis_end">set_genesis_end</a>(poto_framework: &<a href="../../topo-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>) {
    <a href="chain_status.md#0x1_chain_status_set_genesis_end">chain_status::set_genesis_end</a>(poto_framework);
}
</code></pre>
...
<td>Formally verified via <a href="#high-level-req-3">initialize_poto_coin</a>.</td>
</tr>
...
<b>ensures</b> <b>exists</b>&lt;<a href="poto_governance.md#0x1_poto_governance_GovernanceResponsbility">poto_governance::GovernanceResponsbility</a>&gt;(@poto_framework);
<b>ensures</b> <b>exists</b>&lt;<a href="consensus_config.md#0x1_consensus_config_ConsensusConfig">consensus_config::ConsensusConfig</a>&gt;(@poto_framework);
<b>ensures</b> <b>exists</b>&lt;<a href="execution_config.md#0x1_execution_config_ExecutionConfig">execution_config::ExecutionConfig</a>&gt;(@poto_framework);
<b>ensures</b> <b>exists</b>&lt;<a href="version.md#0x1_version_Version">version::Version</a>&gt;(@poto_framework);
<b>ensures</b> <b>exists</b>&lt;<a href="stake.md#0x1_stake_ValidatorSet">stake::ValidatorSet</a>&gt;(@poto_framework);
<b>ensures</b> <b>exists</b>&lt;<a href="stake.md#0x1_stake_ValidatorPerformance">stake::ValidatorPerformance</a>&gt;(@poto_framework);
<b>ensures</b> <b>exists</b>&lt;<a href="storage_gas.md#0x1_storage_gas_StorageGasConfig">storage_gas::StorageGasConfig</a>&gt;(@poto_framework);
<b>ensures</b> <b>exists</b>&lt;<a href="storage_gas.md#0x1_storage_gas_StorageGas">storage_gas::StorageGas</a>&gt;(@poto_framework);
<b>ensures</b> <b>exists</b>&lt;<a href="gas_schedule.md#0x1_gas_schedule_GasScheduleV2">gas_schedule::GasScheduleV2</a>&gt;(@poto_framework);
<b>ensures</b> <b>exists</b>&lt;<a href="aggregator_factory.md#0x1_aggregator_factory_AggregatorFactory">aggregator_factory::AggregatorFactory</a>&gt;(@poto_framework);
<b>ensures</b> <b>exists</b>&lt;<a href="coin.md#0x1_coin_SupplyConfig">coin::SupplyConfig</a>&gt;(@poto_framework);
<b>ensures</b> <b>exists</b>&lt;<a href="chain_id.md#0x1_chain_id_ChainId">chain_id::ChainId</a>&gt;(@poto_framework);
<b>ensures</b> <b>exists</b>&lt;<a href="reconfiguration.md#0x1_reconfiguration_Configuration">reconfiguration::Configuration</a>&gt;(@poto_framework);
<b>ensures</b> <b>exists</b>&lt;<a href="block.md#0x1_block_BlockResource">block::BlockResource</a>&gt;(@poto_framework);
<b>ensures</b> <b>exists</b>&lt;<a href="state_storage.md#0x1_state_storage_StateStorageUsage">state_storage::StateStorageUsage</a>&gt;(@poto_framework);
<b>ensures</b> <b>exists</b>&lt;<a href="timestamp.md#0x1_timestamp_CurrentTimeMicroseconds">timestamp::CurrentTimeMicroseconds</a>&gt;(@poto_framework);
<b>ensures</b> <b>exists</b>&lt;<a href="account.md#0x1_account_Account">account::Account</a>&gt;(@poto_framework);
<b>ensures</b> <b>exists</b>&lt;<a href="version.md#0x1_version_SetVersionCapability">version::SetVersionCapability</a>&gt;(@poto_framework);
<b>ensures</b> <b>exists</b>&lt;<a href="staking_config.md#0x1_staking_config_StakingConfig">staking_config::StakingConfig</a>&gt;(@poto_framework);
</code></pre>



<a id="@Specification_1_initialize_poto_coin"></a>
...
<b>requires</b> !<b>exists</b>&lt;<a href="stake.md#0x1_stake_TopoCoinCapabilities">stake::TopoCoinCapabilities</a>&gt;(@poto_framework);
<b>ensures</b> <b>exists</b>&lt;<a href="stake.md#0x1_stake_TopoCoinCapabilities">stake::TopoCoinCapabilities</a>&gt;(@poto_framework);
<b>requires</b> <b>exists</b>&lt;<a href="transaction_fee.md#0x1_transaction_fee_TopoCoinCapabilities">transaction_fee::TopoCoinCapabilities</a>&gt;(@poto_framework);
<b>ensures</b> <b>exists</b>&lt;<a href="transaction_fee.md#0x1_transaction_fee_TopoCoinCapabilities">transaction_fee::TopoCoinCapabilities</a>&gt;(@poto_framework);
</code></pre>
...
<b>include</b> <a href="poto_coin.md#0x1_poto_coin_ExistsTopoCoin">poto_coin::ExistsTopoCoin</a>;
</code></pre>
...
<b>requires</b> len(<b>global</b>&lt;<a href="stake.md#0x1_stake_ValidatorSet">stake::ValidatorSet</a>&gt;(@poto_framework).active_validators) &gt;= 1;
// This enforces <a id="high-level-req-5" href="#high-level-req">high-level requirement 5</a>:
<b>let</b> addr = std::signer::address_of(poto_framework);
<b>aborts_if</b> addr != @poto_framework;
<b>aborts_if</b> <b>exists</b>&lt;<a href="chain_status.md#0x1_chain_status_GenesisEndMarker">chain_status::GenesisEndMarker</a>&gt;(@poto_framework);
<b>ensures</b> <b>global</b>&lt;<a href="chain_status.md#0x1_chain_status_GenesisEndMarker">chain_status::GenesisEndMarker</a>&gt;(@poto_framework) == <a href="chain_status.md#0x1_chain_status_GenesisEndMarker">chain_status::GenesisEndMarker</a> {};
</code></pre>
...
<pre><code><b>schema</b> <a href="genesis.md#0x1_genesis_InitalizeRequires">InitalizeRequires</a> {
    <a href="execution_config.md#0x1_execution_config">execution_config</a>: <a href="../../topo-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;;
    <b>requires</b> !<b>exists</b>&lt;<a href="account.md#0x1_account_Account">account::Account</a>&gt;(@poto_framework);
    ...
    <b>requires</b> <b>exists</b>&lt;<a href="coin.md#0x1_coin_CoinInfo">coin::CoinInfo</a>&lt;TopoCoin&gt;&gt;(@poto_framework);
    <b>include</b> <a href="genesis.md#0x1_genesis_CompareTimeRequires">CompareTimeRequires</a>;
}
</code></pre>
...
<pre><code><b>schema</b> <a href="genesis.md#0x1_genesis_CompareTimeRequires">CompareTimeRequires</a> {
    <b>let</b> staking_rewards_config = <b>global</b>&lt;<a href="staking_config.md#0x1_staking_config_StakingRewardsConfig">staking_config::StakingRewardsConfig</a>&gt;(@poto_framework);
