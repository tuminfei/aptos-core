...
-  [Function `store_poto_coin_burn_cap`](#0x1_transaction_fee_store_poto_coin_burn_cap)
-  [Function `store_poto_coin_mint_cap`](#0x1_transaction_fee_store_poto_coin_mint_cap)
...
-  [Specification](#@Specification_1)
    ...
    -  [Function `store_poto_coin_burn_cap`](#@Specification_1_store_poto_coin_burn_cap)
    -  [Function `store_poto_coin_mint_cap`](#@Specification_1_store_poto_coin_mint_cap)
...
<pre><code><b>use</b> <a href="poto_account.md#0x1_poto_account">0x1::poto_account</a>;
...
<dl>
<dt>
<code>burn_cap: <a href="coin.md#0x1_coin_BurnCapability">coin::BurnCapability</a>&lt;<a href="poto_coin.md#0x1_poto_coin_TopoCoin">poto_coin::TopoCoin</a>&gt;</code>
</dt>
<dd>
...
<dl>
<dt>
<code>amount: <a href="coin.md#0x1_coin_AggregatableCoin">coin::AggregatableCoin</a>&lt;<a href="poto_coin.md#0x1_poto_coin_TopoCoin">poto_coin::TopoCoin</a>&gt;</code>
</dt>
<dd>

</dd>
<dt>
<code>proposer: <a href="../../topo-stdlib/../move-stdlib/doc/option.md#0x1_option_Option">option::Option</a>&lt;<b>address</b>&gt;</code>
</dt>
<dd>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="transaction_fee.md#0x1_transaction_fee_burn_fee">burn_fee</a>(
    ...
    <b>let</b> burn_ref =
        &<b>borrow_global</b>&lt;<a href="transaction_fee.md#0x1_transaction_fee_AptosFABurnCapabilities">AptosFABurnCapabilities</a>&gt;(@poto_framework).burn_ref;
    <a href="poto_account.md#0x1_poto_account_burn_from_fungible_store_for_gas">poto_account::burn_from_fungible_store_for_gas</a>(burn_ref, <a href="account.md#0x1_account">account</a>, fee);
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="transaction_fee.md#0x1_transaction_fee_mint_and_refund">mint_and_refund</a>(
    ...
    <b>let</b> mint_cap = &<b>borrow_global</b>&lt;<a href="transaction_fee.md#0x1_transaction_fee_TopoCoinMintCapability">TopoCoinMintCapability</a>&gt;(@poto_framework).mint_cap;
...
<a id="0x1_transaction_fee_store_poto_coin_burn_cap"></a>

## Function `store_poto_coin_burn_cap`

Only called during genesis.


<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="transaction_fee.md#0x1_transaction_fee_store_poto_coin_burn_cap">store_poto_coin_burn_cap</a>(poto_framework: &<a href="../../topo-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>, burn_cap: <a href="coin.md#0x1_coin_BurnCapability">coin::BurnCapability</a>&lt;<a href="poto_coin.md#0x1_poto_coin_TopoCoin">poto_coin::TopoCoin</a>&gt;)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="transaction_fee.md#0x1_transaction_fee_store_poto_coin_burn_cap">store_poto_coin_burn_cap</a>(
    poto_framework: &<a href="../../topo-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>, burn_cap: BurnCapability&lt;TopoCoin&gt;
) {
    ...
    <b>move_to</b>(poto_framework, <a href="transaction_fee.md#0x1_transaction_fee_AptosFABurnCapabilities">AptosFABurnCapabilities</a> { burn_ref });
}
</code></pre>
...
<a id="0x1_transaction_fee_store_poto_coin_mint_cap"></a>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="transaction_fee.md#0x1_transaction_fee_store_poto_coin_mint_cap">store_poto_coin_mint_cap</a>(poto_framework: &<a href="../../topo-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>, mint_cap: <a href="coin.md#0x1_coin_MintCapability">coin::MintCapability</a>&lt;<a href="poto_coin.md#0x1_poto_coin_TopoCoin">poto_coin::TopoCoin</a>&gt;)
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="transaction_fee.md#0x1_transaction_fee_store_poto_coin_mint_cap">store_poto_coin_mint_cap</a>(
    poto_framework: &<a href="../../topo-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>, mint_cap: MintCapability&lt;TopoCoin&gt;
) {
    <a href="system_addresses.md#0x1_system_addresses_assert_aptos_framework">system_addresses::assert_aptos_framework</a>(poto_framework);
    <b>move_to</b>(poto_framework, <a href="transaction_fee.md#0x1_transaction_fee_TopoCoinMintCapability">TopoCoinMintCapability</a> { mint_cap })
}
</code></pre>
...
<pre><code>#[deprecated]
<b>public</b> <b>fun</b> <a href="transaction_fee.md#0x1_transaction_fee_initialize_fee_collection_and_distribution">initialize_fee_collection_and_distribution</a>(_aptos_framework: &<a href="../../topo-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>, _burn_percentage: u8)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="transaction_fee.md#0x1_transaction_fee_initialize_fee_collection_and_distribution">initialize_fee_collection_and_distribution</a>(
    _aptos_framework: &<a href="../../topo-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>, _burn_percentage: u8
) {
    <b>abort</b> <a href="../../topo-stdlib/../move-stdlib/doc/error.md#0x1_error_not_implemented">error::not_implemented</a>(<a href="transaction_fee.md#0x1_transaction_fee_ENO_LONGER_SUPPORTED">ENO_LONGER_SUPPORTED</a>)
}
</code></pre>
...
<pre><code>#[deprecated]
<b>public</b> <b>fun</b> <a href="transaction_fee.md#0x1_transaction_fee_upgrade_burn_percentage">upgrade_burn_percentage</a>(_aptos_framework: &<a href="../../topo-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>, _new_burn_percentage: u8)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="transaction_fee.md#0x1_transaction_fee_upgrade_burn_percentage">upgrade_burn_percentage</a>(
    _aptos_framework: &<a href="../../topo-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>, _new_burn_percentage: u8
) {
    <b>abort</b> <a href="../../topo-stdlib/../move-stdlib/doc/error.md#0x1_error_not_implemented">error::not_implemented</a>(<a href="transaction_fee.md#0x1_transaction_fee_ENO_LONGER_SUPPORTED">ENO_LONGER_SUPPORTED</a>)
}
</code></pre>
...
<pre><code>#[deprecated]
<b>public</b> <b>fun</b> <a href="transaction_fee.md#0x1_transaction_fee_initialize_storage_refund">initialize_storage_refund</a>(_: &<a href="../../topo-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="transaction_fee.md#0x1_transaction_fee_initialize_storage_refund">initialize_storage_refund</a>(_: &<a href="../../topo-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>) {
    <b>abort</b> <a href="../../topo-stdlib/../move-stdlib/doc/error.md#0x1_error_not_implemented">error::not_implemented</a>(<a href="transaction_fee.md#0x1_transaction_fee_ENO_LONGER_SUPPORTED">ENO_LONGER_SUPPORTED</a>)
}
</code></pre>
...
<pre><code>#[deprecated]
<b>public</b> entry <b>fun</b> <a href="transaction_fee.md#0x1_transaction_fee_convert_to_aptos_fa_burn_ref">convert_to_aptos_fa_burn_ref</a>(_aptos_framework: &<a href="../../topo-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>)
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="transaction_fee.md#0x1_transaction_fee_convert_to_aptos_fa_burn_ref">convert_to_aptos_fa_burn_ref</a>(
    _aptos_framework: &<a href="../../topo-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>
) {
    <b>abort</b> <a href="../../topo-stdlib/../move-stdlib/doc/error.md#0x1_error_not_implemented">error::not_implemented</a>(<a href="transaction_fee.md#0x1_transaction_fee_ENO_LONGER_SUPPORTED">ENO_LONGER_SUPPORTED</a>)
}
</code></pre>
...
<td>Low</td>
<td>The functions: upgrade_burn_percentage, register_proposer_for_fee_collection, and process_collected_fees all ensure that the CollectedFeesPerBlock resource exists under poto_framework by calling the is_fees_collection_enabled method, which returns a boolean value confirming if the resource exists or not.</td>
...
<pre><code><b>pragma</b> verify = <b>false</b>;
<b>aborts_if</b> !<b>exists</b>&lt;<a href="transaction_fee.md#0x1_transaction_fee_TopoCoinCapabilities">TopoCoinCapabilities</a>&gt;(@poto_framework);
...
<b>aborts_if</b> amount != 0 && !(<b>exists</b>&lt;CoinInfo&lt;TopoCoin&gt;&gt;(poto_addr)
    && <b>exists</b>&lt;CoinStore&lt;TopoCoin&gt;&gt;(account_addr));
<b>aborts_if</b> coin_store.<a href="coin.md#0x1_coin">coin</a>.value &lt; amount;
<b>let</b> maybe_supply = <b>global</b>&lt;CoinInfo&lt;TopoCoin&gt;&gt;(poto_addr).supply;
...
<b>let</b> <b>post</b> post_maybe_supply = <b>global</b>&lt;CoinInfo&lt;TopoCoin&gt;&gt;(poto_addr).supply;
...
<b>aborts_if</b> <a href="../../topo-stdlib/../move-stdlib/doc/option.md#0x1_option_is_some">option::is_some</a>(maybe_supply) && value &lt; amount;
...
<pre><code><b>pragma</b> verify = <b>false</b>;
<b>let</b> poto_addr = <a href="../../topo-stdlib/doc/type_info.md#0x1_type_info_type_of">type_info::type_of</a>&lt;TopoCoin&gt;().account_address;
<b>aborts_if</b> (refund != 0) && !<b>exists</b>&lt;CoinInfo&lt;TopoCoin&gt;&gt;(poto_addr);
...
<b>aborts_if</b> !<b>exists</b>&lt;<a href="transaction_fee.md#0x1_transaction_fee_TopoCoinMintCapability">TopoCoinMintCapability</a>&gt;(@poto_framework);
...
<a id="@Specification_1_store_poto_coin_burn_cap"></a>
...
<a id="@Specification_1_store_poto_coin_mint_cap"></a>
