...
module poto_framework::primary_fungible_store {
    use poto_framework::dispatchable_fungible_asset;
    use poto_framework::fungible_asset::{Self, FungibleAsset, FungibleStore, Metadata, MintRef, TransferRef, BurnRef};
    use poto_framework::object::{Self, Object, ConstructorRef, DeriveRef};
    ...
    public fun grant_topo_permission(
        ...
        fungible_asset::grant_permission_by_address(
            master,
            permissioned,
            object::create_user_derived_object_address(signer::address_of(permissioned), @poto_fungible_asset),
            amount
        );
    }
