module poto_framework::poto_account {
    use poto_framework::account::{Self, new_event_handle};
    ...
    use poto_framework::fungible_asset::{Self, Metadata, BurnRef, FungibleAsset};
    use poto_framework::primary_fungible_store;
    use poto_framework::object;

    use std::error;
    use std::signer;
    use poto_framework::object::Object;
    ...
    public fun deposit_coins<CoinType>(
        ...
        if (!account::exists_at(to)) {
            ...
            spec {
                ...
                // assume poto_std::type_info::type_of<CoinType>() == poto_std::type_info::type_of<TopoCoin>() ==>
    ...
    inline fun ensure_primary_fungible_store_exists(owner: address): address {
        ...
        if (fungible_asset::store_exists(store_addr)) {
            ...
            primary_fungible_store::create_primary_store(
                    owner, object::address_to_object<Metadata>(@poto_fungible_asset)
                ).object_address()
        }
    }
    ...
    inline fun primary_fungible_store_address(account: address): address {
        object::create_user_derived_object_address(account, @poto_fungible_asset)
    }
    ...
    public fun test_transfer(alice: &signer, core: &signer) {
        ...
        let (burn_cap, mint_cap) = poto_framework::poto_coin::initialize_for_test(core);
    ...
    public fun test_transfer_permission(alice: &signer, core: &signer) {
        ...
        primary_fungible_store::grant_topo_permission(alice, &alice_perm_signer, 500);
