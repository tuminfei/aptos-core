...
module poto_framework::code {
    ...
    friend poto_framework::object_code_deployment;
    ...
    fun initialize(poto_framework: &signer, package_owner: &signer, metadata: PackageMetadata)
