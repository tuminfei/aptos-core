...
module poto_framework::chain_status {
    ...
    public(friend) fun set_genesis_end(poto_framework: &signer) {
        system_addresses::assert_aptos_framework(poto_framework);
        move_to(poto_framework, GenesisEndMarker {});
    }

    #[view]
    /// Helper function to determine if Aptos is in genesis state.
    public fun is_genesis(): bool {
        !exists<GenesisEndMarker>(@poto_framework)
    }
