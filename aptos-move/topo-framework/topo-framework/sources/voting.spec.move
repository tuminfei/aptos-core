spec poto_framework::voting {
    ...
    // CurrentTimeMicroseconds existed under the @poto_framework.
    ...
    spec resolve_proposal_v2<ProposalType: store>(
        ...
        aborts_if len(next_execution_hash) == 0 && !exists<timestamp::CurrentTimeMicroseconds>(@poto_framework);
