...
module poto_framework::object {
    ...
    fun test_correct_auid() {
        let auid1 = poto_framework::transaction_context::generate_auid_address();
        let bytes = poto_framework::transaction_context::get_transaction_hash();
        bytes.push_back(1);
        bytes.push_back(0);
        bytes.push_back(0);
        bytes.push_back(0);
        ...
        let auid2 = poto_framework::from_bcs::to_address(std::hash::sha3_256(bytes));
