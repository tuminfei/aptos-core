spec poto_framework::chain_status {
    /// <high-level-req>
    /// No.: 1
    ...
    spec set_genesis_end(poto_framework: &signer) {
        use std::signer;
        pragma verify = true;
        ...
        /// [high-level-req-3]
        aborts_if exists<GenesisEndMarker>(@poto_framework);
        /// [high-level-req-1]
        ensures global<GenesisEndMarker>(@poto_framework) == GenesisEndMarker {};
    }
