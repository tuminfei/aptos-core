...
module poto_framework::object_code_deployment {
    use std::bcs;
    use std::error;
    use std::features;
    use std::signer;
    use poto_framework::account;
    use poto_framework::code;
    use poto_framework::code::PackageRegistry;
    use poto_framework::event;
    use poto_framework::object;
    use poto_framework::object::{ExtendRef, Object};
    ...
    const OBJECT_CODE_DEPLOYMENT_DOMAIN_SEPARATOR: vector<u8> = b"poto_framework::object_code_deployment";
