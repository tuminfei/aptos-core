spec poto_framework::staking_proxy {
    /// <high-level-req>
    /// No.: 1
    ...
    /// Enforcement: Enforced via [https://github.com/aptos-labs/aptos-core/blob/main/aptos-move/framework/topo-framework/sources/staking_contract.move#L87](SimpleMap).
    /// </high-level-req>
    ///
    spec module {
        pragma verify = true;
    ...
    spec schema SetStakingContractOperator {
        ...
        use poto_framework::staking_contract::{Store};
