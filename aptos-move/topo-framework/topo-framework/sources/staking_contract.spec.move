spec poto_framework::staking_contract {
    /// <high-level-req>
    /// No.: 1
    ...
    spec schema IncreaseLockupWithCapAbortsIf {
        ...
        let seconds = global<timestamp::CurrentTimeMicroseconds>(@poto_framework).microseconds
    ...
    spec schema PreconditionsInCreateContract {
        requires exists<stake::ValidatorPerformance>(@poto_framework);
        requires exists<stake::ValidatorSet>(@poto_framework);
        ...
        requires exists<poto_framework::timestamp::CurrentTimeMicroseconds>(
            @poto_framework
        );
    ...
    spec schema CreateStakePoolAbortsIf {
        ...
        let allowed = global<stake::AllowedValidators>(@poto_framework);
        aborts_if exists<stake::AllowedValidators>(@poto_framework)
