...
module poto_framework::optional_aggregator {
    use std::error;
    use std::option::{Self, Option};

    use poto_framework::aggregator_factory;
    use poto_framework::aggregator::{Self, Aggregator};
    ...
    #[test(account = @poto_framework)]
    #[expected_failure(abort_code = 0x020001, location = poto_framework::aggregator)]
    ...
    #[test(account = @poto_framework)]
    #[expected_failure(abort_code = 0x020002, location = poto_framework::aggregator)]
