module poto_framework::account {
    ...
    use poto_std::ed25519;
    use poto_std::from_bcs;
    use poto_std::multi_ed25519;
    use poto_std::single_key;
    use poto_std::multi_key;
    use poto_std::table::{Self, Table};
    use poto_std::type_info::{Self, TypeInfo};

    friend poto_framework::poto_account;
    friend poto_framework::coin;
    friend poto_framework::genesis;
    friend poto_framework::multisig_account;
    friend poto_framework::resource_account;
    friend poto_framework::transaction_validation;
    ...
    public(friend) fun initialize(poto_framework: &signer) {
        ...
        move_to(poto_framework, OriginatingAddress {
    ...
    public fun originating_address(auth_key: address): Option<address> acquires OriginatingAddress {
        let address_map_ref = &OriginatingAddress[@poto_framework].address_map;
    ...
    entry fun set_originating_address(_account: &signer) acquires Account, OriginatingAddress {
        ...
        let address_map_ref_mut =
            &mut OriginatingAddress[@poto_framework].address_map;
    ...
    fun update_auth_key_and_originating_address_table(
        ...
        let address_map = &mut OriginatingAddress[@poto_framework].address_map;
    ...
    fun test_create_signer_for_test() {
        assert!(signer::address_of(&create_signer_for_test(@poto_framework)) == @0x1, 0);
    ...
    #[test(alice = @0xa11ce)]
    #[expected_failure(abort_code = 65537, location = poto_framework::ed25519)]
    ...
    //
    #[test(bob = @0x345, framework = @poto_framework)]
    ...
    #[test(bob = @0x345, charlie = @0x567, framework = @poto_framework)]
    ...
    public entry fun test_valid_rotate_authentication_key_multi_ed25519_to_multi_ed25519(
        ...
        let address_map = &OriginatingAddress[@poto_framework].address_map;
