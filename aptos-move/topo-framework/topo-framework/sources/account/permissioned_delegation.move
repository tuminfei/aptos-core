module poto_framework::permissioned_delegation {
    use std::error;
    ...
    use poto_framework::bcs_stream::{Self, deserialize_u8};
    use poto_framework::permissioned_signer::{Self, is_permissioned_signer, StorablePermissionedHandle};
    use poto_framework::rate_limiter;
    use poto_framework::rate_limiter::RateLimiter;
    #[test_only]
    use std::bcs;
    #[test_only]
    use std::option;
    ...
    #[test_only]
    use poto_std::ed25519::{sign_arbitrary_bytes, generate_keys, validated_public_key_to_bytes, Signature,
    ...
    fun test_basics(account: signer, account_copy: signer) acquires RegisteredDelegations {
        let poto_framework = create_signer_for_test(@poto_framework);
