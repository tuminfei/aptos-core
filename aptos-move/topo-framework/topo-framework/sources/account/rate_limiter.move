module poto_framework::rate_limiter {
    ...
    fun test_initialize_bucket(poto_framework: &signer) {
    ...
    #[test(poto_framework = @0x1)]
    fun test_request_success(poto_framework: &signer) {
        timestamp::set_time_has_started_for_testing(poto_framework);
    ...
    #[test(poto_framework = @0x1)]
    fun test_request_failure(poto_framework: &signer) {
        timestamp::set_time_has_started_for_testing(poto_framework);
        let bucket = initialize(10, 30);
    ...
    #[test(poto_framework = @0x1)]
    fun test_refill(poto_framework: &signer) {
        timestamp::set_time_has_started_for_testing(poto_framework);
        let bucket = initialize(10, 60);
    ...
    #[test(poto_framework= @0x1)]
    fun test_fractional_accumulation(poto_framework: &signer) {
        timestamp::set_time_has_started_for_testing(poto_framework);
        let bucket = initialize(10, 60);
    ...
    #[test(poto_framework= @0x1)]
    fun test_multiple_refills(poto_framework: &signer) {
        timestamp::set_time_has_started_for_testing(poto_framework);
        let bucket = initialize(10, 60);
