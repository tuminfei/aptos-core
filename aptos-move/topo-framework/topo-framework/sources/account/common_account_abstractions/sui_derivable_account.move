...
module poto_framework::sui_derivable_account {

    use poto_framework::auth_data::AbstractionAuthData;
    use poto_framework::common_account_abstractions_utils::{construct_message, daa_authenticate};
    use poto_std::ed25519::{ Self, new_signature_from_bytes, new_validated_public_key_from_bytes, public_key_into_unvalidated };
    ...
    fun derive_account_address_from_public_key(signing_scheme: u8, public_key_bytes: vector<u8>): vector<u8> {
        ...
        let sui_account_address = poto_hash::blake2b_256(data_to_hash);
    ...
    fun authenticate_auth_data_internal(
        ...
        let hash = poto_hash::blake2b_256(bcs_bytes);
