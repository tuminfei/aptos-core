...
module poto_framework::ethereum_derivable_account {
    use poto_framework::auth_data::AbstractionAuthData;
    use poto_framework::common_account_abstractions_utils::{network_name, daa_authenticate};
    use poto_framework::base16::base16_utf8_to_vec_u8;
    use poto_std::secp256k1;
    ...
    fun authenticate_auth_data(
        ...
        let hashed_message = poto_hash::keccak256(message);
        ...
        let kexHash = poto_hash::keccak256(public_key_without_prefix);
    ...
    use std::string::utf8;
    #[test_only]
    use poto_framework::auth_data::{create_derivable_auth_data};
    #[test_only]
    ...
    fun test_construct_message(framework: &signer) {
        ...
        let ethereum_address = b"0xC7B576Ead6aFb962E2DEcB35814FB29723AEC98a";
        let domain = b"localhost:3001";
        let entry_function_name = b"0x1::poto_account::transfer";
