module poto_framework::common_account_abstractions_utils {
    use poto_framework::auth_data::AbstractionAuthData;
    use std::chain_id;
    use std::string_utils;
    use std::transaction_context::{Self, EntryFunctionPayload};

    friend poto_framework::ethereum_derivable_account;
    friend poto_framework::solana_derivable_account;
    friend poto_framework::sui_derivable_account;
