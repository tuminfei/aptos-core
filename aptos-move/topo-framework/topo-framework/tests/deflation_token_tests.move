...
module 0xcafe::deflation_token_tests {
    ...
    use poto_framework::function_info;
    use poto_framework::fungible_asset::{Self, Metadata, TestToken};
    ...
    #[test(creator = @0xcafe, aaron = @0xface)]
    #[expected_failure(abort_code = 0x70002, location = poto_framework::dispatchable_fungible_asset)]
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(abort_code = 0x1001C, location = poto_framework::fungible_asset)]
    ...
    #[test(creator = @0xcafe, aaron = @0xface)]
    #[expected_failure(abort_code = 0x8001D, location = poto_framework::fungible_asset)]
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(abort_code = 0x10019, location = poto_framework::fungible_asset)]
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(abort_code = 0x1001A, location = poto_framework::fungible_asset)]
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(abort_code = 0x1001B, location = poto_framework::fungible_asset)]
    ...
    #[test(creator = @0xcafe, aaron = @0xface)]
    #[expected_failure(major_status=1081, location = poto_framework::function_info)]
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(abort_code=2, location = poto_framework::function_info)]
    ...
    #[test(creator = @0xcafe)]
    #[expected_failure(abort_code=0x6001E, location = poto_framework::fungible_asset)]
    ...
    #[test(creator = @0xcafe, aaron = @0xface)]
    #[expected_failure(abort_code = 0x50008, location = poto_framework::fungible_asset)]
