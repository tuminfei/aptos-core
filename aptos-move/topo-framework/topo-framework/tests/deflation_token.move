...
module 0xcafe::deflation_token {
    use poto_framework::fungible_asset::{Self, BurnRef, FungibleAsset, TransferRef};
    use poto_framework::dispatchable_fungible_asset;
    use poto_framework::object::{ConstructorRef, Object};
    ...
    #[test_only]
    use poto_framework::fungible_asset::{Metadata, TestToken};

    #[test(creator = @0xcafe)]
    #[expected_failure(major_status=4037, location=poto_framework::dispatchable_fungible_asset)]
