#[test_only]
module poto_framework::big_ordered_map_test {
    use poto_framework::ordered_map;
    use poto_framework::ordered_map_test;
    use poto_framework::big_ordered_map::{new, new_from, new_with_config};
    use std::option;
    ...
    #[test]
    #[expected_failure(abort_code = 0x1000B, location = poto_framework::big_ordered_map)] /// EINVALID_CONFIG_PARAMETER
    ...
    #[test]
    #[expected_failure(abort_code = 0x10001, location = poto_framework::big_ordered_map)] /// EKEY_ALREADY_EXISTS
    ...
    #[test]
    #[expected_failure(abort_code = 0x10002, location = poto_std::ordered_map)] /// EKEY_NOT_FOUND
    ...
    #[test]
    #[expected_failure(abort_code = 0x10002, location = poto_std::big_ordered_map)] /// EKEY_NOT_FOUND
    ...
    #[test]
    #[expected_failure(abort_code = 0x10002, location = poto_framework::big_ordered_map)] /// EKEY_NOT_FOUND
    ...
    #[test]
    #[expected_failure(abort_code = 0x1000E, location = poto_framework::big_ordered_map)] /// EBORROW_MUT_REQUIRES_CONSTANT_VALUE_SIZE
    ...
    #[test]
    #[expected_failure(abort_code = 0x10003, location = poto_framework::big_ordered_map)] /// EITER_OUT_OF_BOUNDS
    ...
    #[test]
    #[expected_failure(abort_code = 0x1000C, location = poto_framework::big_ordered_map)] /// EMAP_NOT_EMPTY
    ...
    #[test]
    #[expected_failure(abort_code = 0x1000F, location = poto_framework::big_ordered_map)] /// EKEY_BYTES_TOO_LARGE
    ...
    #[test]
    #[expected_failure(abort_code = 0x1000D, location = poto_framework::big_ordered_map)] /// EARGUMENT_BYTES_TOO_LARGE
    ...
    fun test_large_data_set_helper(inner_max_degree: u16, leaf_max_degree: u16, reuse_slots: bool) {
        ...
        for (i in 0..len) {
            ...
            // poto_std::debug::print(&it);

            let it_next = it.iter_next(&map);
            let it_after = map.internal_lower_bound(&(*element + 1));

            // poto_std::debug::print(&it_next);
            // poto_std::debug::print(&it_after);
            // poto_std::debug::print(&std::string::utf8(b"bla"));
