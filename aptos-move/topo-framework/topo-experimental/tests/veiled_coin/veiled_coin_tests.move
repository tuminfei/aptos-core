...
module poto_experimental::veiled_coin_tests {
    #[test_only]
    use std::features;
    #[test_only]
    use std::signer;
    ...
    #[test_only]
    use poto_std::ristretto255_bulletproofs as bulletproofs;
    #[test_only]
    use poto_std::debug::print;
    #[test_only]
    use poto_std::ristretto255_elgamal as elgamal;
    #[test_only]
    use poto_std::ristretto255;
    #[test_only]
    use poto_std::ristretto255_pedersen as pedersen;
    ...
    #[test_only]
    use poto_experimental::veiled_coin;
    #[test_only]
    use poto_experimental::helpers::generate_elgamal_keypair;
    #[test_only]
    use poto_experimental::sigma_protos::{
    ...
    fun set_up_for_veiled_coin_test(
        ...
        assert!(signer::address_of(&poto_fx) != signer::address_of(sender), 1);
        assert!(signer::address_of(&poto_fx) != signer::address_of(recipient), 2);
        ...
        account::create_account_for_test(signer::address_of(&poto_fx)); // needed in `coin::create_fake_money`
        ...
        println(b"Created fake money inside @poto_framework");
    ...
    #[
        test(
            veiled_coin = @poto_experimental,
            poto_fx = @poto_framework,
            sender = @0xc0ffee,
            recipient = @0x1337
        )
    ]
    fun veil_test(
        ...
        print(&@poto_experimental);
        println(b"@poto_framework:");
        print(&@poto_framework);
    ...
    #[test(
        veiled_coin = @poto_experimental, poto_fx = @poto_framework, sender = @0x1337
    )]
    fun unveil_test(
        veiled_coin: signer, poto_fx: signer, sender: signer
    ) {
        ...
        set_up_for_veiled_coin_test(&veiled_coin, poto_fx, &sender, &sender, 500, 0);
