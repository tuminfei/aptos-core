#[test_only]
module poto_experimental::confidential_asset_tests {
    use std::features;
    use std::option;
    use std::signer;
    use std::string::utf8;
    ...
    public fun set_up_for_confidential_asset_test(
        ...
        chain_id::initialize_for_test(poto_fx, 4);
    ...
    #[
        test(
            confidential_asset = @poto_experimental,
    ...
    fun fail_register_if_token_disallowed(
        ...
        confidential_asset::enable_allow_list(&poto_fx);
    ...
    fun success_register_if_token_allowed(
        ...
        confidential_asset::enable_allow_list(&poto_fx);
        confidential_asset::enable_token(&poto_fx, token);
    ...
    fun fail_deposit_with_coins_if_insufficient_amount(
        confidential_asset: signer, poto_fx: signer, alice: signer
    ) {
        chain_id::initialize_for_test(&poto_fx, 4);
        confidential_asset::init_module_for_testing(&confidential_asset);
        coin::create_coin_conversion_map(&poto_fx);
        ...
        coin::create_pairing<MockCoin>(&poto_fx);
