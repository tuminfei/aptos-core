...
/// SDK: [`aptos-python-sdk`](https://github.com/aptos-labs/aptos-python-sdk/blob/main/poto_sdk/package_publisher.py).
///
...
module poto_experimental::large_packages {
    use std::error;
    use std::signer;
    use poto_std::smart_table::{Self, SmartTable};

    use poto_framework::code::{Self, PackageRegistry};
    use poto_framework::object::{Object};
    use poto_framework::object_code_deployment;
