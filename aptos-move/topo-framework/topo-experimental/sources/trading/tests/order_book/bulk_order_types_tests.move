#[test_only]
module poto_experimental::bulk_order_types_tests {
    use poto_experimental::bulk_order_utils::new_bulk_order_request_with_sanitization;
    use poto_trading::order_book_types::new_test_metadata;
    ...
    #[test]
    #[expected_failure(abort_code = poto_experimental::bulk_order_utils::E_BID_SIZE_ZERO)]
    ...
    #[test]
    #[expected_failure(abort_code = poto_experimental::bulk_order_utils::E_ASK_SIZE_ZERO)]
    ...
    #[test]
    #[expected_failure(
        abort_code = poto_experimental::bulk_order_utils::E_BID_LENGTH_MISMATCH
    )]
    ...
    #[test]
    #[expected_failure(
        abort_code = poto_experimental::bulk_order_utils::E_ASK_LENGTH_MISMATCH
    )]
