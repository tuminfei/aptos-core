#[test_only]
module poto_experimental::order_book_client_order_id {
    use std::option;
    use std::signer;
    use poto_framework::timestamp;
    use poto_trading::order_book_types::{
        good_till_cancelled,
        new_order_id_type,
        price_move_up_condition,
        new_time_based_trigger_condition
    };
    use poto_trading::single_order_types::new_single_order_request;
    use poto_experimental::order_book::set_up_test_with_id;
    ...
    public fun test_try_cancel_order_with_client_order_id_success(
        ...
        let cancel_result =
            order_book.try_cancel_single_order_with_client_order_id(
    ...
    public fun test_try_cancel_order_with_client_order_id_no_client_id(
        ...
        let cancel_result =
            order_book.try_cancel_single_order_with_client_order_id(
                user1_addr, std::string::utf8(b"12345")
            );
        assert!(cancel_result.is_none());
        order_book.destroy_order_book();
    }
    ...
    public fun test_try_cancel_order_with_client_order_id_fully_matched(
        ...
        let single_match = order_book.get_single_match_for_taker(1000, 100, false);
    ...
    public fun test_try_cancel_order_with_client_order_id_partially_matched(
        ...
        let remaining_size_after_cancel =
            order_book.get_single_remaining_size(maker_order_id);
    ...
    public fun test_try_cancel_order_with_client_order_id_multiple_partial_matches(
        ...
        // First partial match
        let single_match1 = order_book.get_single_match_for_taker(1000, 100, false);
        ...
        let can_cancel_after_first =
            order_book.try_cancel_single_order_with_client_order_id(
                user1_addr, std::string::utf8(b"12346")
    ...
    public fun test_try_cancel_order_with_client_order_id_sequential_full_matches(
        ...
        let client_order_ids = vector[
            std::string::utf8(b"1001"),
        ...
        let single_match1 = order_book.get_single_match_for_taker(1002, 100, false);
        ...
        let cancel_result_fully_matched =
            order_book.try_cancel_single_order_with_client_order_id(
                user1_addr, std::string::utf8(b"1003")
            ); // This order was fully matched
        assert!(cancel_result_fully_matched.is_none());

        // Try to cancel the remaining orders - should return true
        let cancel_result_1 =
            order_book.try_cancel_single_order_with_client_order_id(
                user1_addr, std::string::utf8(b"1001")
            );
        assert!(cancel_result_1.is_some());

        let cancel_result_2 =
            order_book.try_cancel_single_order_with_client_order_id(
                user1_addr, std::string::utf8(b"1002")
            );
        assert!(cancel_result_2.is_some());
        order_book.destroy_order_book();
    }
