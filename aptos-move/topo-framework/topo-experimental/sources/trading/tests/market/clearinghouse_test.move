#[test_only]
module poto_experimental::clearinghouse_test {
    #[test_only]
    friend poto_experimental::market_single_order_tests;
    #[test_only]
    friend poto_experimental::pre_cancellation_tests;
    #[test_only]
    friend poto_experimental::market_tests_common;
    #[test_only]
    friend poto_experimental::market_test_utils;
    #[test_only]
    friend poto_experimental::market_bulk_order_tests;
    #[test_only]
    friend poto_experimental::market_mixed_order_tests;
    #[test_only]
    friend poto_experimental::dead_mans_switch_operations_test;
    ...
    use poto_trading::order_book_types::OrderId;
