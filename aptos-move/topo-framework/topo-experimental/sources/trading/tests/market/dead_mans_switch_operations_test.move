#[test_only]
module poto_experimental::dead_mans_switch_operations_test {
    use std::option;
    use std::signer;
    use poto_framework::timestamp;
    use poto_framework::account;
    use poto_experimental::clearinghouse_test;
    use poto_experimental::market_types::{new_market, new_market_config, Market};
    use poto_experimental::order_placement;
    use poto_trading::order_book_types::{good_till_cancelled, new_order_id_type};
    use poto_experimental::dead_mans_switch_operations;
    ...
    fun place_test_order(
        ...
        size: u64,
        is_bid: bool
    ): poto_trading::order_book_types::OrderId {
        let result =
    ...
    #[
        expected_failure(
            abort_code = 0, location = poto_experimental::dead_mans_switch_operations
        )
    ]
