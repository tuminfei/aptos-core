#[test_only]
module poto_experimental::market_mixed_order_tests {
    use std::option;
    use std::signer;
    ...
    public fun test_bulk_and_single_orders_coexist(
        ...
        assert!(
            market.get_bulk_order_remaining_size(bulk_maker_addr, true)
                == 1000000 + 1500000
        );
        assert!(
            market.get_bulk_order_remaining_size(bulk_maker_addr, false)
                == 800000 + 1200000
        );
