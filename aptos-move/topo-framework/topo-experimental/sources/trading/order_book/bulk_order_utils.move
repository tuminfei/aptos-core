module poto_experimental::bulk_order_utils {
    use std::option::{Self, Option};
    use std::vector;
    use poto_std::timestamp;
    use poto_trading::bulk_order_types::{Self, BulkOrder, BulkOrderRequest};
    use poto_trading::order_book_types::{OrderId, IncreasingIdx};
    ...
    #[test_only]
    friend poto_experimental::bulk_order_types_tests;
