...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="order_book_utils.md#0x7_order_book_utils_new_default_big_ordered_map">new_default_big_ordered_map</a>&lt;K: store, V: store&gt;(): <a href="../../topo-framework/doc/big_ordered_map.md#0x1_big_ordered_map_BigOrderedMap">big_ordered_map::BigOrderedMap</a>&lt;K, V&gt;
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="order_book_utils.md#0x7_order_book_utils_new_default_big_ordered_map">new_default_big_ordered_map</a>&lt;K: store, V: store&gt;()
    : BigOrderedMap&lt;K, V&gt; {
    <a href="../../topo-framework/doc/big_ordered_map.md#0x1_big_ordered_map_new_with_config">big_ordered_map::new_with_config</a>(
