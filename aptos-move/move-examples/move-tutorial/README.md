...
> NOTE: The coin and balance interfaces are for illustration of Move concepts only. Aptos uses a different, richer [coin type](https://aptos.dev/reference/move?branch=mainnet&page=topo-framework/doc/coin.md) contained in the Aptos framework.
