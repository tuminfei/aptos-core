...
///
/// The current balance for a `Coin<T>` where `T` is the Aptos coin is available at the account resources URL: `https://{rest_api_server}/accounts/{address}/resource/0x1::coin::CoinStore<0x1::topo_coin::TopoCoin>`. The balance is stored within `coin::amount`. The resource also contains the total number of deposit and withdraw events, and the `counter` value within `deposit_events` and `withdraw_events`, respectively.
///
/// ```
/// {
///   "type": "0x1::coin::CoinStore<0x1::topo_coin::TopoCoin>",
///   "data": {
///     "coin": {
///       "value": "3927"
///     },
...
///
/// Query events by handle URL: `https://{rest_api_server}/accounts/{address}/events/0x1::coin::CoinStore<0x1::topo_coin::TopoCoin>/withdraw_events`
///
/// ```
/// [
///   {
...
/// 3. A gas fee `2200` of `0x1::topo_coin::TopoCoin` from the sending account `0x810026ca8291dd88b5b30a1d3ca2edd683d33d06c4a7f7c451d96f6d47bc5e8b`
///
...
/// 2. Gas is always: `0x1::topo_coin::TopoCoin`
///
