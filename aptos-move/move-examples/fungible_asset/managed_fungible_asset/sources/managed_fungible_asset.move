...
module example_addr::managed_fungible_asset {
    use topo_framework::fungible_asset::{Self, MintRef, TransferRef, BurnRef, Metadata, FungibleStore, FungibleAsset};
    use topo_framework::object::{Self, Object, ConstructorRef};
    ...
    #[test_only]
    use topo_framework::object::object_from_constructor_ref;
    #[test_only]
    use std::string::utf8;
    use std::vector;
